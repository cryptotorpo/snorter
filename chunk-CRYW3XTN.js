...
function p0(u, t, x, s) {
  if (typeof u.setBigUint64 == "function") return u.setBigUint64(t, x, s);
  let e = BigInt(32),
    a = BigInt(4294967295),
    c = Number((x >> e) & a),
    i = Number(x & a),
    f = s ? 4 : 0,
    b = s ? 0 : 4;
  u.setUint32(t + f, c, s), u.setUint32(t + b, i, s);
}
function o0(u, t, x) {
  return (u & t) ^ (~u & x);
}
...
var M,
  ...
  n0 = Z(() => {
    ...
    (M = class extends f0 {
      ...
      digestInto(t) {
        P(this), x0(t, this), (this.finished = !0);
        ...
        p0(s, e - 8, BigInt(this.length * 8), a), this.process(s, 0);
        let i = K(t),
          f = this.outputLen;
        if (f % 4)
  ...
  g0 = Z(() => {
    ...
    (H0 = Uint32Array.from([
      ...
      (R = class extends M {
        ...
        process(t, x) {
          for (let h = 0; h < 16; h++, x += 4) D[h] = t.getUint32(x, !1);
          for (let h = 16; h < 64; h++) {
            let o = D[h - 15],
              d = D[h - 2],
              H = A(o, 7) ^ A(o, 18) ^ (o >>> 3),
      ...
      (X = class extends M {
        ...
        process(t, x) {
          for (let r = 0; r < 16; r++, x += 4)
            (E[r] = t.getUint32(x)), (F[r] = t.getUint32((x += 4)));
          for (let r = 16; r < 80; r++) {
            let _ = E[r - 15] | 0,
              L = F[r - 15] | 0,
