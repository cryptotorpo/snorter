import { a as En, b as vt } from "./chunk-TLA6RWUK.js";
import { a as Mn, b as qr } from "./chunk-YTUIZ7QE.js";
...
function Sn(e, t = {}) {
  ...
  let o = e.replace("0x", "");
  if (o.length > r * 2)
    throw new Ue({ size: Math.ceil(o.length / 2), targetSize: r, type: "Hex" });
...
function j(e, t = {}) {
  ...
  let c = `0x${(n && o < 0 ? (1n << BigInt(r * 8)) + BigInt(o) : o).toString(
    16
  )}`;
  return r ? Yr(c, r) : c;
}
function Yr(e, t) {
  return Sn(e, { dir: "left", size: t });
}
      ...
      b(
        b(
          b(
            ...
            typeof e.gasLimit == "bigint" && { gasLimit: j(e.gasLimit) }
          ),
          typeof e.number == "bigint" && { number: j(e.number) }
        ),
        typeof e.prevRandao == "bigint" && { prevRandao: j(e.prevRandao) }
      ),
      typeof e.time == "bigint" && { time: j(e.time) }
    ),
    e.withdrawals && { withdrawals: e.withdrawals.map(Rn) }
  );
}
function ne(e) {
  ...
  constructor(t, n = {}) {
    let r =
        n.cause instanceof e
          ...
          : n.details,
      o = (n.cause instanceof e && n.cause.docsPath) || n.docsPath,
      s = It.getDocsUrl?.(A(b({}, n), { docsPath: o })),
      i = [
        t || "An error occurred.",
        "",
        ...(n.metaMessages ? [...n.metaMessages, ""] : []),
...
function ke(e, { includeName: t = !1 } = {}) {
  return e ? e.map((n) => Kr(n, { includeName: t })).join(t ? ", " : ",") : "";
}
  ...
  Ye = class extends u {
    constructor(t, n) {
      super("Found ambiguous types in overloaded ABI items.", {
        metaMessages: [
          `\`${t.type}\` in \`${P(t.abiItem)}\`, and`,
          `\`${n.type}\` in \`${P(n.abiItem)}\``,
          "",
...
function Wn(e, t) {
  if (typeof t == "number" && t > 0 && t > x(e) - 1)
    throw new Ee({ offset: t, position: "start", size: x(e) });
}
function qn(e, t, n) {
  if (typeof t == "number" && typeof n == "number" && x(e) !== n - t)
    throw new Ee({ offset: n, position: "end", size: x(e) });
}
function Mt(e, t, n, { strict: r } = {}) {
  Wn(e, t);
  let o = e.slice(t, n);
  return r && qn(o, t, n), o;
}
...
function k(e, { dir: t, size: n = 32 } = {}) {
  ...
  let r = e.replace("0x", "");
  if (r.length > n * 2)
    throw new Be({ size: Math.ceil(r.length / 2), targetSize: n, type: "hex" });
  return `0x${r[t === "right" ? "padEnd" : "padStart"](n * 2, "0")}`;
}
function eo(e, { dir: t, size: n = 32 } = {}) {
  if (n === null) return e;
  if (e.length > n)
    throw new Be({ size: e.length, targetSize: n, type: "bytes" });
...
function T(e, { size: t }) {
  if (x(e) > t) throw new Qe({ givenSize: x(e), maxSize: t });
}
function Et(e, t = {}) {
  let { signed: n } = t;
  t.size && T(e, { size: t.size });
  let r = BigInt(e);
  if (!n) return r;
  let o = (e.length - 2) / 2,
...
function Us(e, t = {}) {
  let n = ue(e);
  return (
    t.size && (T(n, { size: t.size }), (n = K(n, { dir: "right" }))),
    new TextDecoder().decode(n)
  );
}
var to = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function _n(e, t = {}) {
...
function Bt(e, t = {}) {
  ...
  return typeof t.size == "number"
    ? (T(n, { size: t.size }), q(n, { size: t.size }))
    : n;
}
function z(e, t = {}) {
  let n = "";
  for (let o = 0; o < e.length; o++) n += to[e[o]];
  let r = `0x${n}`;
  return typeof t.size == "number"
    ? (T(r, { size: t.size }), q(r, { dir: "right", size: t.size }))
    : r;
}
function y(e, t = {}) {
  let { signed: n, size: r } = t,
...
function ue(e, t = {}) {
  let n = e;
  t.size &&
    (T(n, { size: t.size }), (n = q(n, { dir: "right", size: t.size })));
  let r = n.slice(2);
  r.length % 2 && (r = `0${r}`);
  let o = r.length / 2,
    s = new Uint8Array(o);
  for (let i = 0, a = 0; i < o; i++) {
    let c = Yn(r.charCodeAt(a++)),
      p = Yn(r.charCodeAt(a++));
...
function jt(e, t = {}) {
  let n = ro.encode(e);
  return typeof t.size == "number"
    ? (T(n, { size: t.size }), q(n, { dir: "right", size: t.size }))
    : n;
}
qr();
function tt(e, t) {
  let n = t || "hex",
    r = Mn(B(e, { strict: !1 }) ? et(e) : e);
  return n === "bytes" ? r : _n(r);
}
var io = (e) => tt(et(e));
function Xn(e) {
  return io(e);
...
var Rt = new ce(8192);
function je(e, t) {
  if (Rt.has(`${e}.${t}`)) return Rt.get(`${e}.${t}`);
  ...
  let s = `0x${o.join("")}`;
  return Rt.set(`${e}.${t}`, s), s;
}
function Ti(e, t) {
  if (!w(e, { strict: !1 })) throw new I({ address: e });
  return je(e, t);
}
...
var uo = {
  ...
  assertPosition(e) {
    if (e < 0 || e > this.bytes.length - 1)
      throw new rt({ length: this.bytes.length, position: e });
  },
  decrementPosition(e) {
    if (e < 0) throw new Se({ offset: e });
...
function Qn(e, { recursiveReadLimit: t = 8192 } = {}) {
...
function er(e, t = {}) {
  typeof t.size < "u" && T(e, { size: t.size });
  let n = z(e, t);
  return Et(n, t);
}
function tr(e, t = {}) {
  let n = e;
  if (
    (typeof t.size < "u" && (T(n, { size: t.size }), (n = K(n))),
    n.length > 1 || n[0] > 1)
  )
    throw new Ke(n);
  return !!n[0];
...
function nr(e, t = {}) {
  ...
  return (
    typeof t.size < "u" &&
      (T(n, { size: t.size }), (n = K(n, { dir: "right" }))),
    new TextDecoder().decode(n)
  );
}
function L(e) {
...
function F(e, t) {
  if (e.length !== t.length)
    throw new qe({ expectedLength: e.length, givenLength: t.length });
  let n = po({ params: e, values: t }),
    r = Ot(n);
  return r.length === 0 ? "0x" : r;
}
function po({ params: e, values: t }) {
  let n = [];
  for (let r = 0; r < e.length; r++) n.push(Ct({ param: e[r], value: t[r] }));
  return n;
}
function Ct({ param: e, value: t }) {
  ...
  if (n) {
    let [r, o] = n;
    return mo(t, { length: r, param: A(b({}, e), { type: o }) });
  }
  if (e.type === "tuple") return xo(t, { param: e });
  if (e.type === "address") return fo(t);
  if (e.type === "bool") return yo(t);
  if (e.type.startsWith("uint") || e.type.startsWith("int")) {
    let r = e.type.startsWith("int"),
      [, , o = "256"] = rr.exec(e.type) ?? [];
    return bo(t, { signed: r, size: Number(o) });
  }
  if (e.type.startsWith("bytes")) return lo(t, { param: e });
  if (e.type === "string") return ho(t);
  throw new Xe(e.type, { docsPath: "/docs/contract/encodeAbiParameters" });
}
function Ot(e) {
  let t = 0;
  ...
  for (let s = 0; s < e.length; s++) {
    let { dynamic: i, encoded: a } = e[s];
    i ? (n.push(y(t + o, { size: 32 })), r.push(a), (o += x(a))) : n.push(a);
  }
  return L([...n, ...r]);
}
function fo(e) {
  if (!w(e)) throw new I({ address: e });
  return { dynamic: !1, encoded: k(e.toLowerCase()) };
}
function mo(e, { length: t, param: n }) {
  let r = t === null;
  if (!Array.isArray(e)) throw new ie(e);
  if (!r && e.length !== t)
    throw new Ve({
      expectedLength: t,
  ...
  let o = !1,
    s = [];
  for (let i = 0; i < e.length; i++) {
    let a = Ct({ param: n, value: e[i] });
    a.dynamic && (o = !0), s.push(a);
  }
  if (r || o) {
    let i = Ot(s);
    if (r) {
      let a = y(s.length, { size: 32 });
      return { dynamic: !0, encoded: s.length > 0 ? L([a, i]) : a };
    }
    if (o) return { dynamic: !0, encoded: i };
  }
  return { dynamic: !1, encoded: L(s.map(({ encoded: i }) => i)) };
}
function lo(e, { param: t }) {
  ...
  if (!n) {
    ...
    return (
      ...
      { dynamic: !0, encoded: L([k(y(r, { size: 32 })), o]) }
    );
  }
  if (r !== Number.parseInt(n))
    throw new We({ expectedSize: Number.parseInt(n), value: e });
...
function yo(e) {
  ...
  return { dynamic: !1, encoded: k(Bt(e)) };
}
...
function ho(e) {
  let t = zt(e),
    ...
    r = [];
  for (let o = 0; o < n; o++)
    r.push(k(R(t, o * 32, (o + 1) * 32), { dir: "right" }));
  return { dynamic: !0, encoded: L([k(y(x(t), { size: 32 })), ...r]) };
}
function xo(e, { param: t }) {
  ...
  for (let o = 0; o < t.components.length; o++) {
    let s = t.components[o],
      ...
      a = Ct({ param: s, value: e[i] });
    r.push(a), a.dynamic && (n = !0);
  }
  return { dynamic: n, encoded: n ? Ot(r) : L(r.map(({ encoded: o }) => o)) };
}
function st(e) {
  let t = e.match(/^(.*)\[(\d+)?\]$/);
...
function de(e, t) {
  let n = typeof t == "string" ? ue(t) : t,
    r = Qn(n);
  if (x(n) === 0 && e.length > 0) throw new re();
  if (x(t) && x(t) < 32)
    throw new Ge({
  ...
  for (let i = 0; i < e.length; ++i) {
    let a = e[i];
    r.setPosition(o);
    let [c, p] = pe(r, a, { staticPosition: 0 });
    (o += p), s.push(c);
  }
  return s;
}
function pe(e, t, { staticPosition: n }) {
  ...
  if (r) {
    let [o, s] = r;
    return wo(e, A(b({}, t), { type: s }), { length: o, staticPosition: n });
  }
  if (t.type === "tuple") return Po(e, t, { staticPosition: n });
  if (t.type === "address") return go(e);
  if (t.type === "bool") return vo(e);
  if (t.type.startsWith("bytes")) return $o(e, t, { staticPosition: n });
  if (t.type.startsWith("uint") || t.type.startsWith("int")) return Ao(e, t);
  if (t.type === "string") return To(e, { staticPosition: n });
  throw new Ze(t.type, { docsPath: "/docs/contract/decodeAbiParameters" });
}
var or = 32,
  Ft = 32;
function go(e) {
  let t = e.readBytes(32);
  return [je(z(Mt(t, -20))), 32];
}
function wo(e, t, { length: n, staticPosition: r }) {
  if (!n) {
    let i = O(e.readBytes(Ft)),
      ...
      c = a + or;
    e.setPosition(a);
    let p = O(e.readBytes(or)),
      f = Re(t),
      d = 0,
      l = [];
    for (let m = 0; m < p; ++m) {
      e.setPosition(c + (f ? m * 32 : d));
      let [h, g] = pe(e, t, { staticPosition: c });
      (d += g), l.push(h);
    }
  ...
  let o = 0,
    s = [];
  for (let i = 0; i < n; ++i) {
    let [a, c] = pe(e, t, { staticPosition: r + o });
    (o += c), s.push(a);
  }
  return [s, o];
}
function vo(e) {
  return [tr(e.readBytes(32), { size: 32 }), 32];
}
function $o(e, t, { staticPosition: n }) {
  ...
  if (!o) {
    ...
    let c = e.readBytes(a);
    return e.setPosition(n + 32), [z(c), 32];
  }
...
function Ao(e, t) {
  let n = t.type.startsWith("int"),
    ...
    o = e.readBytes(32);
  return [r > 48 ? er(o, { signed: n }) : O(o, { signed: n }), 32];
}
function Po(e, t, { staticPosition: n }) {
  ...
  if (Re(t)) {
    ...
    for (let c = 0; c < t.components.length; ++c) {
      ...
      e.setPosition(a + s);
      let [f, d] = pe(e, p, { staticPosition: a });
      (s += d), (o[r ? c : p?.name] = f);
    }
  ...
  for (let i = 0; i < t.components.length; ++i) {
    let a = t.components[i],
      [c, p] = pe(e, a, { staticPosition: n });
    (o[r ? i : a?.name] = c), (s += p);
  }
  return [o, s];
}
function To(e, { staticPosition: t }) {
...
function Re(e) {
  ...
  if (t === "tuple") return e.components?.some(Re);
  let n = st(e.type);
  return !!(n && Re(A(b({}, e), { type: n[1] })));
}
function it(e) {
  let { abi: t, data: n } = e,
    r = R(n, 0, 4);
  if (r === "0x") throw new re();
  let s = [...(t || []), He, Gn].find(
    (i) => i.type === "error" && r === C(P(i))
  );
  if (!s) throw new oe(r, { docsPath: "/docs/contract/decodeErrorResult" });
  return {
    abiItem: s,
    args:
  ...
  for (let a of s) {
    ...
    if (
      ...
      if (i && "inputs" in i && i.inputs) {
        let p = ir(a.inputs, i.inputs, n);
        if (p)
          throw new Ye({ abiItem: a, type: p[0] }, { abiItem: i, type: p[1] });
      }
      i = a;
    }
  }
  ...
  switch (r) {
    ...
    default:
      return r === "tuple" && "components" in t
        ...
        ? Array.isArray(e) &&
          e.every((o) =>
            Nt(o, A(b({}, t), { type: r.replace(/(\[[0-9]{0,}\])$/, "") }))
          )
        : !1;
  }
}
function ir(e, t, n) {
  for (let r in e) {
    ...
    if (
      ...
      return ir(o.components, s.components, n[r]);
    let i = [o.type, s.type];
    if (
...
var fr = class extends u {
    constructor(
      ...
      let m = Ce({
        ...
        to: d,
        value:
          typeof l < "u" && `${ut(l)} ${o?.nativeCurrency?.symbol || "ETH"}`,
        data: s,
        gas: i,
      ...
      if (n && n !== "0x")
        try {
          ...
          if (d === "Error") c = l[0];
            ...
            let m = f ? P(f, { includeName: !0 }) : void 0,
              h =
                f && l
                  ? Ut({
                      abiItem: f,
...
function wr(e) {
  let { abi: t, args: n, functionName: r, data: o } = e,
    s = t[0];
  if (r) {
    let a = N({ abi: t, args: n, name: r });
    if (!a) throw new S(r, { docsPath: Ht });
    s = a;
  }
  if (s.type !== "function") throw new S(void 0, { docsPath: Ht });
  if (!s.outputs) throw new se(s.name, { docsPath: Ht });
...
function Dt(e) {
  ...
  if (!o) throw new Le({ docsPath: kt });
  if (!("inputs" in o)) throw new Ie({ docsPath: kt });
  if (!o.inputs || o.inputs.length === 0) throw new Ie({ docsPath: kt });
  let s = F(o.inputs, n);
  return Q([r, s]);
}
...
function $r(e) {
  let { abi: t, args: n, functionName: r } = e,
    o = t[0];
  if (r) {
    let s = N({ abi: t, args: n, name: r });
    if (!s) throw new S(r, { docsPath: vr });
    o = s;
  }
  if (o.type !== "function") throw new S(void 0, { docsPath: vr });
  return { abi: [o], functionName: C(P(o)) };
}
function Ar(e) {
  let { args: t } = e,
    { abi: n, functionName: r } =
      e.abi.length === 1 && e.functionName?.startsWith("0x") ? e : $r(e),
    o = n[0],
    s = r,
    i = "inputs" in o && o.inputs ? F(o.inputs, t ?? []) : void 0;
  return Q([s, i ?? "0x"]);
}
function Pr({ blockNumber: e, chain: t, contract: n }) {
  let r = t?.contracts?.[n];
  if (!r) throw new Z({ chain: t, contract: { name: n } });
  ...
  v = class extends u {
    constructor(
      ...
      super(i, {
        ...
        (this.name = s || t.name),
        (this.code = t instanceof yt ? t.code : n ?? Io);
    }
  },
  $ = class extends v {
    constructor(t, n) {
...
function Mr(e, t) {
  ...
  return r instanceof u
    ? new G({ cause: e, message: r.details })
    : G.nodeMessage.test(n)
    ? new G({ cause: e, message: e.details })
    : J.nodeMessage.test(n)
    ? new J({ cause: e, maxFeePerGas: t?.maxFeePerGas })
    : fe.nodeMessage.test(n)
    ? new fe({ cause: e, maxFeePerGas: t?.maxFeePerGas })
    : me.nodeMessage.test(n)
    ? new me({ cause: e, nonce: t?.nonce })
    : le.nodeMessage.test(n)
    ? new le({ cause: e, nonce: t?.nonce })
    : ye.nodeMessage.test(n)
    ? new ye({ cause: e, nonce: t?.nonce })
    : be.nodeMessage.test(n)
    ? new be({ cause: e })
    : he.nodeMessage.test(n)
    ? new he({ cause: e, gas: t?.gas })
    : xe.nodeMessage.test(n)
    ? new xe({ cause: e, gas: t?.gas })
...
function Er(e, r) {
  ...
  return new ft(s, b({ docsPath: t }, n));
}
...
function zr(e) {
  ...
  return (
    typeof e.authorizationList < "u" &&
      (t.authorizationList = Eo(e.authorizationList)),
    ...
    typeof e.type < "u" && (t.type = Mo[e.type]),
  ...
  return e.map((t) =>
    b(
      b(
        ...
        typeof t.yParity < "u" ? { yParity: y(t.yParity) } : {}
      ),
      typeof t.v < "u" && typeof t.yParity > "u" ? { v: y(t.v) } : {}
    )
  );
}
function jr() {
...
var ln = new Map();
function Sr({ fn: e, id: t, shouldSplitBatch: n, wait: r = 0, sort: o }) {
  let s = () =>
  ...
  return {
    ...
    schedule(d) {
      return M(this, null, function* () {
        let { promise: l, resolve: m, reject: h } = jr();
        return (
          n?.([...a(), d]) && s(),
          c().length > 0
            ? (p({ args: d, resolve: m, reject: h }), l)
            : (p({ args: d, resolve: m, reject: h }), setTimeout(s, r), l)
        );
      });
    },
  };
...
function Rr(e) {
  if (!(!e || e.length === 0))
    return e.reduce((t, { slot: n, value: r }) => {
      if (n.length !== 66)
        throw new ze({ size: n.length, targetSize: 66, type: "hex" });
      if (r.length !== 66)
        throw new ze({ size: r.length, targetSize: 66, type: "hex" });
      return (t[n] = r), t;
    }, {});
}
function Bo(e) {
  ...
  if (
    ...
    r !== void 0 && (i.state = Rr(r)),
    o !== void 0)
  ) {
    if (i.state) throw new pt();
    i.stateDiff = Rr(o);
  }
  return i;
}
function Cr(e) {
  ...
  for (let n of e) {
    let r = n,
      { address: o } = r,
      s = H(r, ["address"]);
    if (!w(o, { strict: !1 })) throw new I({ address: o });
    if (t[o]) throw new ct({ address: o });
    t[o] = Bo(s);
  }
  return t;
}
...
function Fr(e) {
  let {
    ...
    i = t ? ne(t) : void 0;
  if (i && !w(i.address)) throw new I({ address: i.address });
  if (s && !w(s)) throw new I({ address: s });
  if (typeof n < "u" && (typeof r < "u" || typeof o < "u")) throw new dt();
  if (r && r > Or) throw new J({ maxFeePerGas: r });
  if (o && r && o > r)
    throw new _({ maxFeePerGas: r, maxPriorityFeePerGas: o });
}
function Ur(e, t) {
  return M(this, null, function* () {
    let Pn = t,
    ...
    let vn = f && d,
      ...
      Vr = vn
        ? So({ code: f, data: d })
        : $n
        ? Ro({ data: d, factory: l, factoryData: m, to: te })
        : d;
    try {
      Fr(t);
      let Ae = (typeof s == "bigint" ? y(s) : void 0) || i,
        Y = p ? Cn(p) : void 0,
        X = Cr(Lr),
        Tn = e.chain?.formatters?.transactionRequest?.format,
        wt = (Tn || zr)(
          A(b({}, Br(Gr, { format: Tn })), {
            from: wn?.address,
            accessList: a,
      ...
      if (o && zo({ request: wt }) && !X && !Y)
        try {
          return yield jo(e, A(b({}, wt), { blockNumber: s, blockTag: i }));
        } catch (W) {
          if (!(W instanceof Te) && !(W instanceof Z)) throw W;
        }
      let Wr = (() => {
          let W = [wt, Ae];
          return X && Y ? [...W, X, Y] : X ? [...W, X] : Y ? [...W, {}, Y] : W;
        })(),
        In = yield e.request({ method: "eth_call", params: Wr });
      return In === "0x" ? { data: void 0 } : { data: In };
    } catch (gt) {
      let Ae = Co(gt),
        { offchainLookup: Y, offchainLookupSignature: X } = yield import(
          "./chunk-XI4UEMC6.js"
        );
      if (e.ccipRead !== !1 && Ae?.slice(0, 10) === X && te)
        return { data: yield Y(e, { data: Ae, to: te }) };
      throw An && Ae?.slice(0, 10) === "0x101bb98d"
        ? new mt({ factory: l })
        : Er(gt, A(b({}, t), { account: wn, chain: e.chain }));
    }
  });
}
...
function jo(e, t) {
  return M(this, null, function* () {
    let { batchSize: n = 1024, wait: r = 0 } =
      ...
      p = a;
    if (!p) {
      if (!e.chain) throw new Te();
      p = Pr({ blockNumber: o, chain: e.chain, contract: "multicall3" });
    }
    let d = (typeof o == "bigint" ? y(o) : void 0) || s,
      { schedule: l } = Sr({
        ...
        shouldSplitBatch(g) {
          return (
            g.reduce((ve, { data: $e }) => ve + ($e.length - 2), 0) > n * 2
          );
        },
        fn: (g) =>
          M(this, null, function* () {
            let V = g.map((Fe) => ({
              ...
              ve = Ar({ abi: Pt, args: [V], functionName: "aggregate3" }),
              $e = yield e.request({
                method: "eth_call",
                params: [{ data: ve, to: p }, d],
              });
            return wr({
              abi: Pt,
              args: [V],
      ...
      [{ returnData: m, success: h }] = yield l({ data: i, to: c });
    if (!h) throw new lt({ data: m });
...
function Nr(e, t) {
  if (!w(e, { strict: !1 })) throw new I({ address: e });
  if (!w(t, { strict: !1 })) throw new I({ address: t });
...
function Hr(e) {
  ...
  if (!o) throw new _e(r, { docsPath: "/docs/contract/decodeFunctionData" });
  return {
    functionName: o.name,
    args:
...
function bn(e) {
  let { abi: t, errorName: n, args: r } = e,
    o = t[0];
  if (n) {
    let c = N({ abi: t, args: r, name: n });
    if (!c) throw new Me(n, { docsPath: yn });
    o = c;
  }
  if (o.type !== "error") throw new Me(void 0, { docsPath: yn });
  let s = P(o),
    i = C(s),
    a = "0x";
  if (r && r.length > 0) {
    if (!o.inputs) throw new Je(o.name, { docsPath: yn });
    a = F(o.inputs, r);
  }
  return Q([i, a]);
}
...
function kr(e) {
  let { abi: t, functionName: n, result: r } = e,
    o = t[0];
  if (n) {
    let i = N({ abi: t, name: n });
    if (!i) throw new S(n, { docsPath: hn });
    o = i;
  }
  if (o.type !== "function") throw new S(void 0, { docsPath: hn });
  if (!o.outputs) throw new se(o.name, { docsPath: hn });
  let s = (() => {
    ...
    return (
      yield Promise.all(
        r.map((i, a) =>
          M(this, null, function* () {
            try {
              (s[a] = i.urls.includes(xn)
                ? yield gn({ data: i.data, ccipRequest: n })
                : yield n(i)),
                (o[a] = !1);
            } catch (c) {
              (o[a] = !0), (s[a] = Oo(c));
      ...
      kr({ abi: Ne, functionName: "query", result: [o, s] })
    );
  });
}
function Oo(e) {
  return e.name === "HttpRequestError" && e.status
    ? bn({ abi: Ne, errorName: "HttpError", args: [e.status, e.shortMessage] })
    : bn({
        abi: [He],
        errorName: "Error",
...
function uf(s, i) {
  return M(
    ...
    function* (e, { blockNumber: t, blockTag: n, data: r, to: o }) {
      let { args: a } = it({ data: r, abi: [Fo] }),
        [c, p, f, d, l] = a,
        { ccipRead: m } = e,
        h = m && typeof m?.request == "function" ? m.request : Uo;
      try {
        if (!Nr(o, c)) throw new xt({ sender: c, to: o });
        let g = p.includes(xn)
            ? yield gn({ data: f, ccipRequest: h })
            : yield h({ data: f, sender: c, urls: p }),
          { data: V } = yield Ur(e, {
            blockNumber: t,
            blockTag: n,
            data: L([d, F([{ type: "bytes" }, { type: "bytes" }], [g, l])]),
            to: o,
          });
        return V;
      } catch (g) {
    ...
    for (let s = 0; s < n.length; s++) {
      ...
      try {
        let f = yield fetch(
            ...
            { body: JSON.stringify(c), headers: p, method: a }
          ),
          d;
        if (
        ...
        if (!B(d)) {
          o = new ht({ result: d, url: i });
          continue;
        }
        return d;
      } catch (f) {
        o = new Oe({ body: c, details: f.message, url: i });
      }
    }
    throw o;
  });
