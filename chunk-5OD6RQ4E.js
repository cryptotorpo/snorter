...
var Ar = Dt((Xt) => {
  ...
  for (Lt = 0, mi = Ir.length; Lt < mi; ++Lt)
    (Bt[Lt] = Ir[Lt]), (Mt[Ir.charCodeAt(Lt)] = Lt);
  var Lt, mi;
  Mt[45] = 62;
  Mt[95] = 63;
  function yi(i) {
  ...
  function ee(i) {
    ...
    for (B = 0; B < M; B += 4)
      (t =
        (Mt[i.charCodeAt(B)] << 18) |
        (Mt[i.charCodeAt(B + 1)] << 12) |
        (Mt[i.charCodeAt(B + 2)] << 6) |
        Mt[i.charCodeAt(B + 3)]),
        (s[a++] = (t >> 16) & 255),
        (s[a++] = (t >> 8) & 255),
        (s[a++] = t & 255);
    return (
      o === 2 &&
        ((t = (Mt[i.charCodeAt(B)] << 2) | (Mt[i.charCodeAt(B + 1)] >> 4)),
        (s[a++] = t & 255)),
      o === 1 &&
        ((t =
          (Mt[i.charCodeAt(B)] << 10) |
          (Mt[i.charCodeAt(B + 1)] << 4) |
          (Mt[i.charCodeAt(B + 2)] >> 2)),
        (s[a++] = (t >> 8) & 255),
        (s[a++] = t & 255)),
      s
    );
  ...
  function he(i) {
    for (
      var t, r = i.length, n = r % 3, o = [], s = 16383, a = 0, M = r - n;
      a < M;
      a += s
    )
    ...
    return (
      n === 1
        ? ((t = i[r - 1]), o.push(Bt[t >> 2] + Bt[(t << 4) & 63] + "=="))
        : n === 2 &&
          ((t = (i[r - 2] << 8) + i[r - 1]),
...
var _r = Dt((Fr) => {
  ...
  Fr.read = function (i, t, r, n, o) {
    var s,
      ...
      gt = i[t + v];
    for (
      v += Ut, s = gt & ((1 << -E) - 1), gt >>= -E, E += M;
      E > 0;
      s = s * 256 + i[t + v], v += Ut, E -= 8
    );
    for (
      a = s & ((1 << -E) - 1), s >>= -E, E += n;
      E > 0;
      a = a * 256 + i[t + v], v += Ut, E -= 8
    );
    if (s === 0) s = 1 - I;
    else {
      if (s === B) return a ? NaN : (gt ? -1 : 1) * (1 / 0);
      (a = a + Math.pow(2, n)), (s = s - I);
    }
  ...
  Fr.write = function (i, t, r, n, o, s) {
    var a,
      ...
      E = (1 << I) - 1,
      v = E >> 1,
      Ut = o === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0,
      gt = n ? 0 : s - 1,
      Wt = n ? 1 : -1,
      ir = t < 0 || (t === 0 && 1 / t < 0) ? 1 : 0;
    for (
      t = Math.abs(t),
        isNaN(t) || t === 1 / 0
          ? ((M = isNaN(t) ? 1 : 0), (a = E))
          : ((a = Math.floor(Math.log(t) / Math.LN2)),
            t * (B = Math.pow(2, -a)) < 1 && (a--, (B *= 2)),
            a + v >= 1 ? (t += Ut / B) : (t += Ut * Math.pow(2, 1 - v)),
            t * B >= 2 && (a++, (B /= 2)),
            a + v >= E
              ? ((M = 0), (a = E))
              : a + v >= 1
              ? ((M = (t * B - 1) * Math.pow(2, o)), (a = a + v))
              : ((M = t * Math.pow(2, v - 1) * Math.pow(2, o)), (a = 0)));
      o >= 8;
      i[r + gt] = M & 255, gt += Wt, M /= 256, o -= 8
    );
    for (
      a = (a << o) | M, I += o;
      I > 0;
      i[r + gt] = a & 255, gt += Wt, a /= 256, I -= 8
    );
    i[r + gt - Wt] |= ir * 128;
  };
});
var Li = Dt((Ot) => {
  ...
  g.poolSize = 8192;
  function vi(i, t, r) {
    if (typeof i == "string") return se(i, t);
    if (ArrayBuffer.isView(i)) return le(i);
    if (i == null)
      throw new TypeError(
    ...
    if (
      Et(i, ArrayBuffer) ||
      (i && Et(i.buffer, ArrayBuffer)) ||
      (typeof SharedArrayBuffer < "u" &&
        (Et(i, SharedArrayBuffer) || (i && Et(i.buffer, SharedArrayBuffer))))
    )
      return Rr(i, t, r);
    if (typeof i == "number")
      throw new TypeError(
    ...
    if (n != null && n !== i) return g.from(n, t, r);
    let o = ae(i);
    if (o) return o;
    if (
      typeof Symbol < "u" &&
  ...
  function se(i, t) {
    if (((typeof t != "string" || t === "") && (t = "utf8"), !g.isEncoding(t)))
  ...
  function br(i) {
    let t = i.length < 0 ? 0 : Lr(i.length) | 0,
      r = Ft(t);
    for (let n = 0; n < t; n += 1) r[n] = i[n] & 255;
    return r;
  }
  function le(i) {
    if (Et(i, Uint8Array)) {
  ...
  function ae(i) {
    ...
    if (i.type === "Buffer" && Array.isArray(i.data)) return br(i.data);
  }
  function Lr(i) {
    if (i >= Jt)
      throw new RangeError(
  ...
  g.compare = function (t, r) {
    if (
      (Et(t, Uint8Array) && (t = g.from(t, t.offset, t.byteLength)),
  ...
  g.concat = function (t, r) {
    ...
    for (n = 0; n < t.length; ++n) {
      ...
      if (Et(a, Uint8Array))
        s + a.length > o.length
          ? (g.isBuffer(a) || (a = g.from(a)), a.copy(o, s))
          : Uint8Array.prototype.set.call(o, a, s);
      else if (g.isBuffer(a)) a.copy(o, s);
  ...
  function Ei(i, t) {
    if (g.isBuffer(i)) return i.length;
    if (ArrayBuffer.isView(i) || Et(i, ArrayBuffer)) return i.byteLength;
    if (typeof i != "string")
      throw new TypeError(
  ...
  g.prototype.swap16 = function () {
    ...
    for (let r = 0; r < t; r += 2) kt(this, r, r + 1);
    return this;
  };
  g.prototype.swap32 = function () {
    ...
    for (let r = 0; r < t; r += 4) kt(this, r, r + 3), kt(this, r + 1, r + 2);
    return this;
  };
  ...
  function Ii(i, t, r, n, o) {
    ...
    if ((typeof t == "string" && (t = g.from(t, n)), g.isBuffer(t)))
    ...
    if (typeof t == "number")
      return (
        ...
        typeof Uint8Array.prototype.indexOf == "function"
          ? o
            ? Uint8Array.prototype.indexOf.call(i, t, r)
            : Uint8Array.prototype.lastIndexOf.call(i, t, r)
          : gi(i, [t], r, n, o)
      );
    ...
    if (o) {
      ...
      for (I = r; I < a; I++)
        if (B(i, I) === B(t, E === -1 ? 0 : I - E)) {
          if ((E === -1 && (E = I), I - E + 1 === M)) return E * s;
        } else E !== -1 && (I -= I - E), (E = -1);
    } else
      for (r + M > a && (r = a - M), I = r; I >= 0; I--) {
        let E = !0;
        for (let v = 0; v < M; v++)
          if (B(i, I + v) !== B(t, v)) {
            E = !1;
  ...
  g.prototype.write = function (t, r, n, o) {
    if (r === void 0) (o = "utf8"), (n = this.length), (r = 0);
  ...
  function xe(i, t, r) {
    return t === 0 && r === i.length
      ? Ur.fromByteArray(i)
      : Ur.fromByteArray(i.slice(t, r));
  }
  function Ai(i, t, r) {
  ...
  function Me(i) {
    let t = i.length;
    if (t <= xi) return String.fromCharCode.apply(String, i);
    let r = "",
      n = 0;
    for (; n < t; )
  ...
  function ve(i, t, r) {
    let n = "";
    r = Math.min(i.length, r);
    for (let o = t; o < r; ++o) n += String.fromCharCode(i[o] & 127);
    return n;
  }
  function Be(i, t, r) {
    let n = "";
    r = Math.min(i.length, r);
    for (let o = t; o < r; ++o) n += String.fromCharCode(i[o]);
    return n;
  }
  function Ee(i, t, r) {
    let n = i.length;
  ...
  g.prototype.readUintLE = g.prototype.readUIntLE = function (t, r, n) {
    (t = t >>> 0), (r = r >>> 0), n || dt(t, r, this.length);
    let o = this[t],
      s = 1,
      a = 0;
    for (; ++a < r && (s *= 256); ) o += this[t + a] * s;
    return o;
  };
  ...
  g.prototype.readFloatLE = function (t, r) {
    return (
      (t = t >>> 0), r || dt(t, 4, this.length), Pt.read(this, t, !0, 23, 4)
    );
  };
  g.prototype.readFloatBE = function (t, r) {
    return (
      (t = t >>> 0), r || dt(t, 4, this.length), Pt.read(this, t, !1, 23, 4)
    );
  };
  g.prototype.readDoubleLE = function (t, r) {
    return (
      (t = t >>> 0), r || dt(t, 8, this.length), Pt.read(this, t, !0, 52, 8)
    );
  };
  g.prototype.readDoubleBE = function (t, r) {
    return (
      (t = t >>> 0), r || dt(t, 8, this.length), Pt.read(this, t, !1, 52, 8)
    );
  };
  function yt(i, t, r, n, o, s) {
    ...
    if (r + n > i.length) throw new RangeError("Index out of range");
  }
  ...
  g.prototype.fill = function (t, r, n, o) {
    ...
    let s;
    if (typeof t == "number") for (s = r; s < n; ++s) this[s] = t;
    else {
      ...
      for (s = 0; s < n - r; ++s) this[s + r] = a[s % M];
    }
    return this;
  };
  var $t = {};
  ...
  function Mi(i) {
    let t = "",
      r = i.length,
      n = i[0] === "-" ? 1 : 0;
    for (; r >= n + 4; r -= 3) t = `_${i.slice(r - 3, r)}${t}`;
  ...
  function Ti(i, t, r, n, o, s) {
    if (i > r || i < t) {
      let a = typeof t == "bigint" ? "n" : "",
        M;
      throw (
        (s > 3
          ? t === 0 || t === BigInt(0)
            ? (M = `>= 0${a} and < 2${a} ** ${(s + 1) * 8}${a}`)
            : (M = `>= -(2${a} ** ${(s + 1) * 8 - 1}${a}) and < 2 ** ${
                (s + 1) * 8 - 1
              }${a}`)
          : (M = `>= ${t}${a} and <= ${r}${a}`),
  ...
  function qt(i, t) {
    if (typeof i != "number") throw new $t.ERR_INVALID_ARG_TYPE(t, "number", i);
  }
  function Ht(i, t, r) {
    throw Math.floor(i) !== i
      ? (qt(i, r), new $t.ERR_OUT_OF_RANGE(r || "offset", "an integer", i))
      : t < 0
  ...
  function Tr(i, t) {
    ...
    let r,
      ...
      s = [];
    for (let a = 0; a < n; ++a) {
      if (((r = i.charCodeAt(a)), r > 55295 && r < 57344)) {
        if (!o) {
          if (r > 56319) {
  ...
  function Ue(i) {
    let t = [];
    for (let r = 0; r < i.length; ++r) t.push(i.charCodeAt(r) & 255);
    return t;
  }
  function be(i, t) {
    let r,
    ...
    for (let a = 0; a < i.length && !((t -= 2) < 0); ++a)
      (r = i.charCodeAt(a)), (n = r >> 8), (o = r % 256), s.push(o), s.push(n);
    return s;
  }
  function Si(i) {
  ...
  var Re = (function () {
    ...
    for (let r = 0; r < 16; ++r) {
      let n = r * 16;
      for (let o = 0; o < 16; ++o) t[n + o] = i[r] + i[o];
    }
    return t;
  })();
  function Rt(i) {
...
var Se = Dt((ki, Nr) => {
  ...
  (function (i, t) {
    "use strict";
    function r(m, e) {
      if (!m) throw new Error(e || "Assertion failed");
    }
    function n(m, e) {
      m.super_ = e;
      var f = function () {};
    ...
    (o.isBN = function (e) {
      ...
      (o.prototype._init = function (e, f, u) {
        if (typeof e == "number") return this._initNumber(e, f, u);
        if (typeof e == "object") return this._initArray(e, f, u);
        f === "hex" && (f = 16),
          r(f === (f | 0) && f >= 2 && f <= 36),
          (e = e.toString().replace(/\s+/g, ""));
        var l = 0;
        e[0] === "-" && (l++, (this.negative = 1)),
          l < e.length &&
            (f === 16
              ? this._parseHex(e, l, u)
              : (this._parseBase(e, f, l),
      ...
      (o.prototype._initArray = function (e, f, u) {
        if ((r(typeof e.length == "number"), e.length <= 0))
    ...
    (o.prototype._parseBase = function (e, f, u) {
      ...
      for (var l = 0, c = 1; c <= 67108863; c *= f) l++;
      l--, (c = (c / f) | 0);
      for (
        var y = e.length - u,
          w = y % l,
      ...
      if (w !== 0) {
        var A = 1;
        for (h = B(e, d, e.length, f), d = 0; d < w; d++) A *= f;
        this.imuln(A),
          this.words[0] + h < 67108864 ? (this.words[0] += h) : this._iaddn(h);
      }
      this._strip();
      ...
      (o.prototype.copy = function (e) {
        ...
        for (var f = 0; f < this.length; f++) e.words[f] = this.words[f];
    ...
    (o.prototype.toString = function (e, f) {
      ...
      s &&
        (o.prototype.toBuffer = function (e, f) {
    ...
    (o.prototype.toArrayLike = function (e, f, u) {
      ...
      var y = Wt(e, c),
        w = f === "le" ? "LE" : "BE";
      return this["_toArrayLike" + w](y, l), y;
    }),
      (o.prototype._toArrayLikeLE = function (e, f) {
        for (var u = 0, l = 0, c = 0, y = 0; c < this.length; c++) {
          ...
          (e[u++] = w & 255),
            ...
            y === 6
              ? (u < e.length && (e[u++] = (w >> 24) & 255), (l = 0), (y = 0))
              : ((l = w >>> 24), (y += 2));
        }
        if (u < e.length) for (e[u++] = l; u < e.length; ) e[u++] = 0;
      }),
      (o.prototype._toArrayLikeBE = function (e, f) {
        for (var u = e.length - 1, l = 0, c = 0, y = 0; c < this.length; c++) {
          ...
          (e[u--] = w & 255),
            ...
            u >= 0 && (e[u--] = (w >> 16) & 255),
            y === 6
              ? (u >= 0 && (e[u--] = (w >> 24) & 255), (l = 0), (y = 0))
              : ((l = w >>> 24), (y += 2));
        }
        if (u >= 0) for (e[u--] = l; u >= 0; ) e[u--] = 0;
      }),
      Math.clz32
    ...
    (o.prototype.zeroBits = function () {
      ...
      (o.prototype.iuxor = function (e) {
        var f, u;
        this.length > e.length ? ((f = this), (u = e)) : ((f = e), (u = this));
        for (var l = 0; l < u.length; l++)
          this.words[l] = f.words[l] ^ u.words[l];
        if (this !== f) for (; l < f.length; l++) this.words[l] = f.words[l];
        return (this.length = f.length), this._strip();
      }),
      ...
      (o.prototype.inotn = function (e) {
        ...
        for (var l = 0; l < f; l++) this.words[l] = ~this.words[l] & 67108863;
        return (
          u > 0 && (this.words[l] = ~this.words[l] & (67108863 >> (26 - u))),
          this._strip()
        );
      }),
      ...
      (o.prototype.iadd = function (e) {
        ...
        var u, l;
        this.length > e.length ? ((u = this), (l = e)) : ((u = e), (l = this));
        ...
        if (((this.length = u.length), c !== 0))
          ...
          for (; y < u.length; y++) this.words[y] = u.words[y];
        return this;
      }),
      (o.prototype.add = function (e) {
        var f;
        return e.negative !== 0 && this.negative === 0
          ? ((e.negative = 0), (f = this.sub(e)), (e.negative ^= 1), f)
          : e.negative === 0 && this.negative !== 0
          ? ((this.negative = 0), (f = e.sub(this)), (this.negative = 1), f)
      ...
      (o.prototype.isub = function (e) {
        if (e.negative !== 0) {
          e.negative = 0;
          var f = this.iadd(e);
          return (e.negative = 1), f._normSign();
    ...
    function Wr(m, e, f) {
      ...
      return p !== 0 ? (f.words[h] = p | 0) : f.length--, f._strip();
    }
    ...
    Math.imul || (Hr = Wr);
    function Kr(m, e, f) {
      (f.negative = e.negative ^ m.negative), (f.length = m.length + e.length);
      for (var u = 0, l = 0, c = 0; c < f.length - 1; c++) {
        var y = l;
        l = 0;
        for (
          var w = u & 67108863,
            p = Math.min(c, e.length - 1),
            h = Math.max(0, c - m.length + 1);
          h <= p;
          h++
        ) {
          var d = c - h,
      ...
      return u !== 0 ? (f.words[c] = u) : f.length--, f._strip();
    }
    function Vr(m, e, f) {
      return Kr(m, e, f);
    }
    ...
    (vt.prototype.makeRBT = function (e) {
      for (
        var f = new Array(e), u = o.prototype._countBits(e) - 1, l = 0;
        l < e;
        l++
      )
      ...
      (vt.prototype.transform = function (e, f, u, l, c, y) {
        ...
        for (var w = 1; w < c; w <<= 1)
          for (
            var p = w << 1,
              h = Math.cos((2 * Math.PI) / p),
              d = Math.sin((2 * Math.PI) / p),
              A = 0;
            A < c;
            A += p
          )
      ...
      (vt.prototype.normalize13b = function (e, f) {
        for (var u = 0, l = 0; l < f / 2; l++) {
          var c =
            Math.round(e[2 * l + 1] / f) * 8192 + Math.round(e[2 * l] / f) + u;
          (e[l] = c & 67108863),
      ...
      (vt.prototype.convert13b = function (e, f, u, l) {
        for (var c = 0, y = 0; y < f; y++)
          (c = c + (e[y] | 0)),
            ...
            (u[2 * y + 1] = c & 8191),
            (c = c >>> 13);
        for (y = 2 * f; y < l; ++y) u[y] = 0;
        r(c === 0), r((c & -8192) === 0);
      }),
      (vt.prototype.stub = function (e) {
        for (var f = new Array(e), u = 0; u < e; u++) f[u] = 0;
        return f;
      }),
      (vt.prototype.mulp = function (e, f, u) {
        ...
        for (var U = 0; U < l; U++) {
          ...
          (h[U] = p[U] * F[U] + h[U] * A[U]), (p[U] = b);
        }
        return (
          this.conjugate(p, h, l),
      ...
      (o.prototype.mul = function (e) {
        var f = new o(null);
        return (f.words = new Array(this.length + e.length)), this.mulTo(e, f);
      }),
      (o.prototype.mulf = function (e) {
        var f = new o(null);
        return (f.words = new Array(this.length + e.length)), Vr(this, e, f);
      }),
      ...
      (o.prototype.imuln = function (e) {
        var f = e < 0;
        f && (e = -e), r(typeof e == "number"), r(e < 67108864);
        ...
        return (
          u !== 0 && ((this.words[l] = u), this.length++),
      ...
      (o.prototype.pow = function (e) {
        ...
        for (var u = this, l = 0; l < f.length && f[l] === 0; l++, u = u.sqr());
        if (++l < f.length)
          for (var c = u.sqr(); l < f.length; l++, c = c.sqr())
            f[l] !== 0 && (u = u.mul(c));
        return u;
      }),
      (o.prototype.iushln = function (e) {
        ...
        if (u !== 0) {
          ...
          for (c = 0; c < u; c++) this.words[c] = 0;
          this.length += u;
        }
        return this._strip();
      }),
      (o.prototype.ishln = function (e) {
        return r(this.negative === 0), this.iushln(e);
      }),
      (o.prototype.iushrn = function (e, f, u) {
        ...
        var c = e % 26,
          ...
          p = u;
        if (((l -= y), (l = Math.max(0, l)), p)) {
          for (var h = 0; h < y; h++) p.words[h] = this.words[h];
          p.length = y;
        }
        if (y !== 0)
          if (this.length > y)
      ...
      (o.prototype.ishrn = function (e, f, u) {
        return r(this.negative === 0), this.iushrn(e, f, u);
      }),
      ...
      (o.prototype.imaskn = function (e) {
        ...
        if (
          ...
          return this;
        if (
          (f !== 0 && u++, (this.length = Math.min(u, this.length)), f !== 0)
        ) {
      ...
      (o.prototype.isubn = function (e) {
        if ((r(typeof e == "number"), r(e < 67108864), e < 0))
          return this.iaddn(-e);
        if (this.negative !== 0)
      ...
      (o.prototype._ishlnsubmul = function (e, f, u) {
        ...
        for (r(w === -1), w = 0, c = 0; c < this.length; c++)
          (y = -(this.words[c] | 0) + w),
            (w = y >> 26),
      ...
      (o.prototype._wordDiv = function (e, f) {
        ...
        (u = 26 - w),
          u !== 0 &&
            ((c = c.ushln(u)), l.iushln(u), (y = c.words[c.length - 1] | 0));
        ...
        if (f !== "mod") {
          ...
          for (var d = 0; d < h.length; d++) h.words[d] = 0;
        }
        var A = l.clone()._ishlnsubmul(c, 1, p);
        A.negative === 0 && ((l = A), h && (h.words[p] = 1));
        for (var F = p - 1; F >= 0; F--) {
          var _ =
            (l.words[c.length + F] | 0) * 67108864 +
            (l.words[c.length + F - 1] | 0);
          for (
            _ = Math.min((_ / y) | 0, 67108863), l._ishlnsubmul(c, _, F);
            l.negative !== 0;
      ...
      (o.prototype.divmod = function (e, f, u) {
        ...
        return this.negative !== 0 && e.negative === 0
          ? ((y = this.neg().divmod(e, f)),
            f !== "mod" && (l = y.div.neg()),
            f !== "div" &&
              ((c = y.mod.neg()), u && c.negative !== 0 && c.iadd(e)),
            { div: l, mod: c })
          : this.negative === 0 && e.negative !== 0
          ? ((y = this.divmod(e.neg(), f)),
            f !== "mod" && (l = y.div.neg()),
            { div: l, mod: y.mod })
          : this.negative & e.negative
          ? ((y = this.neg().divmod(e.neg(), f)),
            f !== "div" &&
              ((c = y.mod.neg()), u && c.negative !== 0 && c.isub(e)),
            { div: y.div, mod: c })
      ...
      (o.prototype.egcd = function (e) {
        r(e.negative === 0), r(!e.isZero());
        var f = this,
          u = e.clone();
        f.negative !== 0 ? (f = f.umod(e)) : (f = f.clone());
        for (
          var l = new o(1), c = new o(0), y = new o(0), w = new o(1), p = 0;
          f.isEven() && u.isEven();

        )
          f.iushrn(1), u.iushrn(1), ++p;
        for (var h = u.clone(), d = f.clone(); !f.isZero(); ) {
          for (var A = 0, F = 1; !(f.words[0] & F) && A < 26; ++A, F <<= 1);
          if (A > 0)
            for (f.iushrn(A); A-- > 0; )
              (l.isOdd() || c.isOdd()) && (l.iadd(h), c.isub(d)),
                l.iushrn(1),
                c.iushrn(1);
          for (var _ = 0, U = 1; !(u.words[0] & U) && _ < 26; ++_, U <<= 1);
          if (_ > 0)
            for (u.iushrn(_); _-- > 0; )
              (y.isOdd() || w.isOdd()) && (y.iadd(h), w.isub(d)),
                y.iushrn(1),
                w.iushrn(1);
          f.cmp(u) >= 0
            ? (f.isub(u), l.isub(y), c.isub(w))
            : (u.isub(f), y.isub(l), w.isub(c));
        }
        return { a: y, b: w, gcd: u.iushln(p) };
      }),
      (o.prototype._invmp = function (e) {
        ...
        f.negative !== 0 ? (f = f.umod(e)) : (f = f.clone());
        for (
          var l = new o(1), c = new o(0), y = u.clone();
          f.cmpn(1) > 0 && u.cmpn(1) > 0;

        ) {
          for (var w = 0, p = 1; !(f.words[0] & p) && w < 26; ++w, p <<= 1);
          if (w > 0)
            for (f.iushrn(w); w-- > 0; ) l.isOdd() && l.iadd(y), l.iushrn(1);
          for (var h = 0, d = 1; !(u.words[0] & d) && h < 26; ++h, d <<= 1);
          if (h > 0)
            for (u.iushrn(h); h-- > 0; ) c.isOdd() && c.iadd(y), c.iushrn(1);
          f.cmp(u) >= 0 ? (f.isub(u), l.isub(c)) : (u.isub(f), c.isub(l));
        }
        var A;
        return (
          f.cmpn(1) === 0 ? (A = l) : (A = c), A.cmpn(0) < 0 && A.iadd(e), A
        );
      }),
      (o.prototype.gcd = function (e) {
        ...
        for (var l = 0; f.isEven() && u.isEven(); l++) f.iushrn(1), u.iushrn(1);
        do {
      ...
      (o.prototype.bincn = function (e) {
        ...
        for (var c = l, y = u; c !== 0 && y < this.length; y++) {
          ...
          (w += c), (c = w >>> 26), (w &= 67108863), (this.words[y] = w);
        }
      ...
      (o.prototype.cmpn = function (e) {
        ...
        if (this.length > 1) u = 1;
          ...
          f && (e = -e), r(e <= 67108863, "Number is too big");
    ...
    n(Vt, xt),
      (Vt.prototype.split = function (e, f) {
        for (var u = 4194303, l = Math.min(e.length, 9), c = 0; c < l; c++)
          f.words[c] = e.words[c];
        if (((f.length = l), e.length <= 9)) {
          (e.words[0] = 0), (e.length = 1);
          return;
        }
        var y = e.words[9];
        for (f.words[f.length++] = y & u, c = 10; c < e.length; c++) {
          var w = e.words[c] | 0;
          (e.words[c - 10] = ((w & u) << 4) | (y >>> 22)), (y = w);
        }
        (y >>>= 22),
          (e.words[c - 10] = y),
      ...
      (nr.prototype.imulK = function (e) {
        for (var f = 0, u = 0; u < e.length; u++) {
          var l = (e.words[u] | 0) * 19 + f,
            c = l & 67108863;
          (l >>>= 26), (e.words[u] = c), (f = l);
        }
        return f !== 0 && (e.words[e.length++] = f), e;
      }),
      (o._prime = function (e) {
        if (er[e]) return er[e];
        var f;
        if (e === "k256") f = new Vt();
        else if (e === "p224") f = new Xr();
        else if (e === "p192") f = new Jr();
        else if (e === "p25519") f = new nr();
    ...
    (L.prototype._verify1 = function (e) {
      ...
      (L.prototype.imod = function (e) {
        return this.prime
          ...
          : (I(e, e.umod(this.m)._forceRed(this)), e);
      }),
      ...
      (L.prototype.shl = function (e, f) {
        return this._verify1(e), this.imod(e.ushln(f));
      }),
      (L.prototype.imul = function (e, f) {
        return this._verify2(e, f), this.imod(e.imul(f));
      }),
      (L.prototype.mul = function (e, f) {
        return this._verify2(e, f), this.imod(e.mul(f));
      }),
      ...
      (L.prototype.sqrt = function (e) {
        ...
        for (
          var d = this.pow(h, l),
            A = this.pow(e, l.addn(1).iushrn(1)),
            F = this.pow(e, l),
            _ = c;
          F.cmp(y) !== 0;

        ) {
          for (var U = F, b = 0; U.cmp(y) !== 0; b++) U = U.redSqr();
          r(b < _);
          var R = this.pow(d, new o(1).iushln(_ - b - 1));
          (A = A.redMul(R)), (d = R.redSqr()), (F = F.redMul(d)), (_ = b);
        }
        return A;
      }),
      (L.prototype.invm = function (e) {
        ...
        return f.negative !== 0
          ? ((f.negative = 0), this.imod(f).redNeg())
          : this.imod(f);
      }),
      (L.prototype.pow = function (e, f) {
        if (f.isZero()) return new o(1).toRed(this);
        if (f.cmpn(1) === 0) return e.clone();
        var u = 4,
          l = new Array(1 << u);
        (l[0] = new o(1).toRed(this)), (l[1] = e);
        for (var c = 2; c < l.length; c++) l[c] = this.mul(l[c - 1], e);
        var y = l[0],
          w = 0,
          p = 0,
          h = f.bitLength() % 26;
        for (h === 0 && (h = 26), c = f.length - 1; c >= 0; c--) {
          for (var d = f.words[c], A = h - 1; A >= 0; A--) {
            var F = (d >> A) & 1;
            if ((y !== l[0] && (y = this.sqr(y)), F === 0 && w === 0)) {
              p = 0;
              continue;
            }
            (w <<= 1),
    ...
    n(St, L),
      ...
      (St.prototype.imul = function (e, f) {
        ...
        return (
          c.cmp(this.m) >= 0
            ? (y = c.isub(this.m))
            : c.cmpn(0) < 0 && (y = c.iadd(this.m)),
          y._forceRed(this)
        );
      }),
      (St.prototype.mul = function (e, f) {
        if (e.isZero() || f.isZero()) return new o(0)._forceRed(this);
        var u = e.mul(f),
          l = u.maskn(this.shift).mul(this.minv).imaskn(this.shift).mul(this.m),
          c = u.isub(l).iushrn(this.shift),
          y = c;
...
var Ji = Dt((Yt) => {
  ...
  function _t(i) {
    ...
    let t = new Uint8Array(i);
    return Object.setPrototypeOf(t, x.prototype), t;
  }
  function x(i, t, r) {
    if (typeof i == "number") {
      if (typeof t == "string")
  ...
  function Pi(i, t, r) {
    ...
    if (ArrayBuffer.isView(i)) return Ne(i);
    if (i == null)
      throw new TypeError(
        "The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " +
          typeof i
    ...
    if (
      It(i, ArrayBuffer) ||
      (i && It(i.buffer, ArrayBuffer)) ||
      (typeof SharedArrayBuffer < "u" &&
        (It(i, SharedArrayBuffer) || (i && It(i.buffer, SharedArrayBuffer))))
    )
      return Pr(i, t, r);
    if (typeof i == "number")
      throw new TypeError(
    ...
    let n = i.valueOf && i.valueOf();
    if (n != null && n !== i) return x.from(n, t, r);
    let o = De(i);
    if (o) return o;
    if (
      typeof Symbol < "u" &&
  ...
  function De(i) {
    ...
    if (i.type === "Buffer" && Array.isArray(i.data)) return $r(i.data);
  }
  function Zr(i) {
    if (i >= jt)
      throw new RangeError(
  ...
  x.compare = function (t, r) {
    if (
      (It(t, Uint8Array) && (t = x.from(t, t.offset, t.byteLength)),
  ...
  x.concat = function (t, r) {
    if (!Array.isArray(t))
      throw new TypeError('"list" argument must be an Array of Buffers');
    if (t.length === 0) return x.alloc(0);
    let n;
    if (r === void 0) for (r = 0, n = 0; n < t.length; ++n) r += t[n].length;
    ...
    for (n = 0; n < t.length; ++n) {
      ...
      if (It(a, Uint8Array))
        s + a.length > o.length
          ? (x.isBuffer(a) || (a = x.from(a)), a.copy(o, s))
          : Uint8Array.prototype.set.call(o, a, s);
      else if (x.isBuffer(a)) a.copy(o, s);
      else throw new TypeError('"list" argument must be an Array of Buffers');
      s += a.length;
    }
    return o;
  ...
  function Oi(i, t) {
    if (x.isBuffer(i)) return i.length;
    if (ArrayBuffer.isView(i) || It(i, ArrayBuffer)) return i.byteLength;
    if (typeof i != "string")
      throw new TypeError(
        'The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type ' +
          typeof i
  ...
  x.prototype.swap16 = function () {
    ...
    if (t % 2 !== 0)
      throw new RangeError("Buffer size must be a multiple of 16-bits");
    for (let r = 0; r < t; r += 2) Ct(this, r, r + 1);
    return this;
  };
  x.prototype.swap32 = function () {
    ...
    if (t % 4 !== 0)
      throw new RangeError("Buffer size must be a multiple of 32-bits");
    for (let r = 0; r < t; r += 4) Ct(this, r, r + 3), Ct(this, r + 1, r + 2);
    return this;
  };
  ...
  x.prototype.equals = function (t) {
    if (!x.isBuffer(t)) throw new TypeError("Argument must be a Buffer");
  ...
  function Zi(i, t, r, n, o) {
    ...
    if ((typeof t == "string" && (t = x.from(t, n)), x.isBuffer(t)))
  ...
  function We(i) {
    let t = i.length;
    if (t <= Di) return String.fromCharCode.apply(String, i);
    let r = "",
      n = 0;
    for (; n < t; )
  ...
  x.prototype.readUintLE = x.prototype.readUIntLE = function (t, r, n) {
    (t = t >>> 0), (r = r >>> 0), n || mt(t, r, this.length);
    let o = this[t],
      s = 1,
      a = 0;
    for (; ++a < r && (s *= 256); ) o += this[t + a] * s;
  ...
  x.prototype.readUint8 = x.prototype.readUInt8 = function (t, r) {
    return (t = t >>> 0), r || mt(t, 1, this.length), this[t];
  };
  x.prototype.readUint16LE = x.prototype.readUInt16LE = function (t, r) {
    return (
      (t = t >>> 0), r || mt(t, 2, this.length), this[t] | (this[t + 1] << 8)
    );
  };
  x.prototype.readUint16BE = x.prototype.readUInt16BE = function (t, r) {
    return (
      (t = t >>> 0), r || mt(t, 2, this.length), (this[t] << 8) | this[t + 1]
    );
  };
  ...
  x.prototype.readFloatLE = function (t, r) {
    return (
      (t = t >>> 0), r || mt(t, 4, this.length), Gt.read(this, t, !0, 23, 4)
    );
  };
  x.prototype.readFloatBE = function (t, r) {
    return (
      (t = t >>> 0), r || mt(t, 4, this.length), Gt.read(this, t, !1, 23, 4)
    );
  };
  x.prototype.readDoubleLE = function (t, r) {
    return (
      (t = t >>> 0), r || mt(t, 8, this.length), Gt.read(this, t, !0, 52, 8)
    );
  };
  x.prototype.readDoubleBE = function (t, r) {
    return (
      (t = t >>> 0), r || mt(t, 8, this.length), Gt.read(this, t, !1, 52, 8)
    );
  };
  ...
  x.prototype.copy = function (t, r, n, o) {
    if (!x.isBuffer(t)) throw new TypeError("argument should be a Buffer");
    if (
      (n || (n = 0),
      !o && o !== 0 && (o = this.length),
      r >= t.length && (r = t.length),
  ...
  function zt(i, t) {
    if (typeof i != "number") throw new Zt.ERR_INVALID_ARG_TYPE(t, "number", i);
  }
  function Kt(i, t, r) {
    throw Math.floor(i) !== i
      ? (zt(i, r), new Zt.ERR_OUT_OF_RANGE(r || "offset", "an integer", i))
      : t < 0
      ? new Zt.ERR_BUFFER_OUT_OF_BOUNDS()
      : new Zt.ERR_OUT_OF_RANGE(
          r || "offset",
          `>= ${r ? 1 : 0} and <= ${t}`,
          i
        );
  ...
  function je(i) {
    if (((i = i.split("=")[0]), (i = i.trim().replace(Qe, "")), i.length < 2))
      return "";
    for (; i.length % 4 !== 0; ) i = i + "=";
    return i;
  }
...
var on = Dt((Yr, ji) => {
  ...
  At.from && At.alloc && At.allocUnsafe && At.allocUnsafeSlow
    ? (ji.exports = rr)
    : (Qi(rr, Yr), (Yr.Buffer = Nt));
  function Nt(i, t, r) {
    return At(i, t, r);
  }
