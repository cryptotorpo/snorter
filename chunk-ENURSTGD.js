import {
  ...
  y as ze,
  z as or,
} from "./chunk-QDILLPH4.js";
import { a as pr, b as _r } from "./chunk-VQJZCEAB.js";
import { a as d, b as v, d as Ke, l as g } from "./chunk-JOVT4LBN.js";
...
function fr(e) {
    ...
    i = (s, a) => {
      for (let m of s) {
        ...
        if (u && (typeof l == "number" || typeof l == "bigint")) {
          let [E, y, w] = u;
          De(l, { signed: y === "int", size: Number.parseInt(w) / 8 });
        }
        if (p === "address" && typeof l == "string" && !er(l))
          throw new Ye({ address: l });
        let f = p.match(rr);
        if (f) {
          let [E, y] = f;
          if (y && U(l) !== Number.parseInt(y))
            throw new Xe({ expectedSize: Number.parseInt(y), givenSize: U(l) });
        }
        let c = n[p];
        c && (Or(p), i(c, l));
      }
  ...
  if (n.EIP712Domain && r) {
    if (typeof r != "object") throw new Ee({ domain: r });
    i(n.EIP712Domain, r);
  }
  if (o !== "EIP712Domain")
    if (n[o]) i(n[o], t);
    else throw new Ie({ primaryType: o, types: n });
}
...
function Vr(e) {
  let { domain: r = {}, message: t, primaryType: o } = e,
    n = d({ EIP712Domain: dr({ domain: r }) }, e.types);
  fr({ domain: r, message: t, primaryType: o, types: n });
  let i = ["0x1901"];
  return (
    r && i.push(lr({ domain: r, types: n })),
    o !== "EIP712Domain" && i.push(_e({ data: t, primaryType: o, types: n })),
    P(X(i))
  );
}
function lr({ domain: e, types: r }) {
  return _e({ data: e, primaryType: "EIP712Domain", types: r });
}
function _e({ data: e, primaryType: r, types: t }) {
  let o = xr({ data: e, primaryType: r, types: t });
  return P(o);
}
function xr({ data: e, primaryType: r, types: t }) {
  let o = [{ type: "bytes32" }],
    n = [jr({ primaryType: r, types: t })];
  for (let i of t[r]) {
    let [s, a] = yr({ types: t, name: i.name, type: i.type, value: e[i.name] });
    o.push(s), n.push(a);
  }
  return ze(o, n);
}
function jr({ primaryType: e, types: r }) {
  let t = F(Wr({ primaryType: e, types: r }));
  return P(t);
}
function Wr({ primaryType: e, types: r }) {
  let t = "",
    o = hr({ primaryType: e, types: r });
  o.delete(e);
...
function hr({ primaryType: e, types: r }, t = new Set()) {
  ...
  t.add(n);
  for (let i of r[n]) hr({ primaryType: i.type, types: r }, t);
  return t;
}
function yr({ types: e, name: r, type: t, value: o }) {
  if (e[t] !== void 0)
    return [{ type: "bytes32" }, P(xr({ data: o, primaryType: t, types: e }))];
  if (t === "bytes")
    return (
      (o = `0x${(o.length % 2 ? "0" : "") + o.slice(2)}`),
      [{ type: "bytes32" }, P(o)]
    );
  if (t === "string") return [{ type: "bytes32" }, P(F(o))];
  if (t.lastIndexOf("]") === t.length - 1) {
    let n = t.slice(0, t.lastIndexOf("[")),
      i = o.map((s) => yr({ name: r, type: n, types: e, value: s }));
    return [
      { type: "bytes32" },
      P(
        ze(
...
var gr = `Solana Signed Message:
`;
function br(e) {
  let r =
      typeof e == "string" ? q(e) : typeof e.raw == "string" ? e.raw : B(e.raw),
    t = q(`${gr}${U(r)}`);
  return X([t, r]);
}
function Kr(e, r) {
...
function Vt(
  ...
  let a =
    ...
    f =
      e instanceof Ze
        ? new $e({ functionName: i })
        : [Jr, k.code].includes(m) && (h || p || l || u)
        ? new Le({
            abi: r,
...
function wr(t) {
  return g(this, arguments, function* ({ hash: e, signature: r }) {
    let o = K(e) ? e : F(e),
      { secp256k1: n } = yield import("./chunk-YOLBBPHM.js");
    return `0x${(() => {
...
function no(t) {
  return g(this, arguments, function* ({ hash: e, signature: r }) {
    return Er(yield wr({ hash: e, signature: r }));
  });
}
function uo(e, r = "hex") {
  let t = Tr(e),
...
var Br = class extends b {
  constructor(
    ...
    let f = cr({
      from: t?.address,
      to: l,
      value: typeof u < "u" && `${He(u)} ${n?.nativeCurrency?.symbol || "ETH"}`,
      data: i,
      gas: s,
...
var Pr = class extends b {
  ...
  Sr = class extends b {
    constructor({ maxPriorityFeePerGas: r }) {
      super(
        `\`maxFeePerGas\` cannot be less than the \`maxPriorityFeePerGas\` (${_(
          r
        )} gwei).`,
...
function Ur(e) {
  let r = v(d({}, e), {
    ...
    type: e.type ? Oe[e.type] : void 0,
    typeHex: e.type ? e.type : void 0,
    value: e.value ? BigInt(e.value) : void 0,
    v: e.v ? BigInt(e.v) : void 0,
  });
  return (
    e.authorizationList && (r.authorizationList = Yr(e.authorizationList)),
    (r.yParity = (() => {
...
function jo(e) {
  let { commitments: r, version: t } = e,
    ...
    n = [];
  for (let i of r) n.push(Nr({ commitment: i, to: o, version: t }));
  return n;
}
...
function zr(e) {
  let r = e.to ?? (typeof e.data == "string" ? "hex" : "bytes"),
    ...
    o = U(t);
  if (!o) throw new ve();
  if (o > 761855) throw new Te({ maxSize: 761855, size: o });
  let n = [],
    i = !0,
    s = 0;
  for (; i; ) {
...
function mn(e) {
  let { data: r, kzg: t, to: o } = e,
    n = e.blobs ?? zr({ data: r, to: o }),
    i = e.commitments ?? Ar({ blobs: n, kzg: t, to: o }),
    s = e.proofs ?? Fr({ blobs: n, commitments: i, kzg: t, to: o }),
    a = [];
...
function wn({ chain: e, currentChainId: r }) {
  if (!e) throw new ir();
  if (r !== e.id) throw new nr({ chain: e, currentChainId: r });
}
function Ve(
  e,
  ...
  return new Promise((n, i) => {
    let s = (...m) =>
      g(this, [...m], function* ({ count: a = 0 } = {}) {
        let h = (l) =>
          g(this, [l], function* ({ error: p }) {
            let u = typeof r == "function" ? r({ count: a, error: p }) : r;
            u && (yield Be(u)), s({ count: a + 1 });
          });
        try {
          let p = yield e();
          n(p);
        } catch (p) {
          if (a < t && (yield o({ count: a, error: p })))
            return h({ error: p });
          i(p);
        }
      });
...
var ot = { "0x0": "reverted", "0x1": "success" };
function Un(e) {
  let r = v(d({}, e), {
    blockNumber: e.blockNumber ? BigInt(e.blockNumber) : null,
    ...
    type: e.type ? Oe[e.type] || e.type : null,
  });
  return (
...
function nt(e) {
  let {
    ...
    l = e.cacheTime ?? p,
    u = e.account ? or(e.account) : void 0,
    {
      config: f,
      request: c,
      value: E,
    } = e.transport({ chain: t, pollingInterval: p }),
    y = d(d({}, f), E),
    w = d(
      {
        account: u,
  ...
  function x(I) {
    return (D) => {
      let C = D(I);
      for (let S in w) delete C[S];
      let T = d(d({}, I), C);
      return Object.assign(T, { extend: x(T) });
    };
  }
  return Object.assign(w, { extend: x(w) });
}
var Re = new Qe(8192);
  ...
  return (n, ...i) =>
    g(this, [n, ...i], function* (t, o = {}) {
      ...
      if (a?.exclude?.includes(l))
        throw new V(new Error("method not supported"), { method: l });
                ...
                try {
                  ...
                  switch (c.code) {
                    ...
                    case re.code:
                      throw new re(c);
                    case te.code:
                      throw new te(c, { method: t.method });
                    case oe.code:
                      throw new oe(c);
                    case k.code:
                      throw new k(c);
                    ...
                    case 5e3:
                      throw new G(c);
                    default:
                      throw f instanceof b ? f : new ke(c);
                  }
                }
              }),
            {
              delay: ({ count: f, error: c }) => {
                if (c && c instanceof M) {
                  ...
                  if (E?.match(/\d/)) return Number.parseInt(E) * 1e3;
                }
                return ~~(1 << f) * m;
              },
              retryCount: h,
...
function it(e) {
  return "code" in e && typeof e.code == "number"
    ? e.code === -1 || e.code === J.code || e.code === k.code
...
function j(
  ...
  return {
    ...
    request: kr(o, { methods: r, retryCount: n, retryDelay: i, uid: h }),
    value: m,
  };
}
function st(e, r = {}) {
...
function at(e, r = {}) {
  ...
  return (u) => {
    var f = u,
      ...
      l = Ke(f, ["chain", "pollingInterval", "timeout"]);
    let c = e,
      E = () => {},
      y = j(
        {
            ...
            return g(this, arguments, function* ({ method: x, params: I }) {
              let C,
                T = (S = 0) =>
                  g(this, null, function* () {
                    let L = c[S](
                      v(d({}, l), { chain: m, retryCount: 0, timeout: p })
                    );
                    try {
                      let R = yield L.request({ method: x, params: I });
                      return (
                        E({
                          method: x,
                          params: I,
                      ...
                      if (
                        ...
                        i(R) ||
                          S === c.length - 1 ||
                          ((C ??= c.slice(S + 1).some((Fe) => {
                            let { include: $, exclude: W } =
        ...
        {
          onResponse: (x) => (E = x),
          transports: c.map((x) => x({ chain: m, retryCount: 0 })),
        }
      );
    if (n) {
...
function ct({
  ...
  let { stability: m = 0.7, latency: h = 0.3 } = a,
    p = [],
    l = () =>
      g(this, null, function* () {
        let u = yield Promise.all(
          s.map((E) =>
            g(this, null, function* () {
              let y = E({ chain: e, retryCount: 0, timeout: i }),
                w = Date.now(),
                x,
                I;
              try {
              ...
              return { latency: x - w, success: I };
            })
          )
        );
        p.push(u), p.length > n && p.shift();
        let f = Math.max(
            ...p.map((E) => Math.max(...E.map(({ latency: y }) => y)))
          ),
          c = s
            .map((E, y) => {
    ...
    request(o) {
      return g(this, null, function* () {
        let {
            ...
            onResponse: s = r.onResponse,
            timeout: a = r.timeout ?? 1e4,
          } = o,
        ...
        try {
          let u = yield je(
            (E) =>
              g(this, [E], function* ({ signal: c }) {
                let y = v(d({}, m), {
                    body: Array.isArray(n)
                      ? H(
                          n.map((D) =>
                            d({ jsonrpc: "2.0", id: D.id ?? We.take() }, D)
                          )
                        )
                      : H(d({ jsonrpc: "2.0", id: n.id ?? We.take() }, n)),
                    headers: d({ "Content-Type": "application/json" }, h),
                    method: p || "POST",
                    signal: l || (a > 0 ? c : null),
                  }),
                  w = new Request(e, y),
                  x = (yield i?.(w, y)) ?? v(d({}, y), { url: e });
          ...
          throw u instanceof M || u instanceof Me
            ? u
            : new M({ body: n, cause: u, url: e });
        }
      });
    },
  };
...
function pt(e, r = {}) {
  ...
  return ({ chain: l, retryCount: u, timeout: f }) => {
    ...
    if (!x) throw new Ue();
    let I = Lr(x, { fetchOptions: o, onRequest: a, onResponse: m, timeout: w });
    return j(
      {
        key: n,
        methods: i,
          ...
          return g(this, arguments, function* ({ method: C, params: T }) {
            let L = { method: C, params: T },
              { schedule: R } = ur({
                ...
                fn: (N) => I.request({ body: N }),
                sort: (N, qr) => N.id - qr.id,
              }),
              Fe = (N) =>
                g(this, null, function* () {
                  return t ? R(N) : [yield I.request({ body: N })];
                }),
              [{ error: $, result: W }] = yield Fe(L);
            if (p) return { error: $, result: W };
            if ($) throw new Q({ body: L, error: $, url: x });
            return W;
          });
        },
        retryCount: y,
...
function vi(e) {
  return d({ formatters: void 0, fees: void 0, serializers: void 0 }, e);
}
...
function $r(e, r) {
  if (!/^(-?)([0-9]*)\.?([0-9]*)$/.test(e)) throw new Ae({ value: e });
  let [t, o = "0"] = e.split("."),
    n = t.startsWith("-");
