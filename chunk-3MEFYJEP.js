...
var Vc = Fc((rn, qc) => {
  ...
  var wi =
    ...
    Ei = (function () {
      function e() {
        (this.fetch = !1), (this.DOMException = wi.DOMException);
      }
      return (e.prototype = wi), new e();
    })();
  (function (e) {
    var t = (function (n) {
      var r =
      ...
      function g(P) {
        var L = new FileReader(),
          M = f(L);
        return L.readAsArrayBuffer(P), M;
      }
      function m(P) {
        var L = new FileReader(),
          M = f(L),
          ...
          D = T ? T[1] : "utf-8";
        return L.readAsText(P, D), M;
      }
      function v(P) {
        for (
          var L = new Uint8Array(P), M = new Array(L.length), T = 0;
          T < L.length;
          T++
        )
        ...
        return (
          ...
          (this._initBody = function (P) {
            (this.bodyUsed = this.bodyUsed),
              ...
              P
                ? typeof P == "string"
                  ? (this._bodyText = P)
                  : i.blob && Blob.prototype.isPrototypeOf(P)
                  ? (this._bodyBlob = P)
                  : i.formData && FormData.prototype.isPrototypeOf(P)
                  ? (this._bodyFormData = P)
                  : i.searchParams && URLSearchParams.prototype.isPrototypeOf(P)
                  ? (this._bodyText = P.toString())
                  : i.arrayBuffer && i.blob && o(P)
                  ? ((this._bodyArrayBuffer = p(P.buffer)),
                    (this._bodyInit = new Blob([this._bodyArrayBuffer])))
                  : i.arrayBuffer &&
                    (ArrayBuffer.prototype.isPrototypeOf(P) || a(P))
                  ? (this._bodyArrayBuffer = p(P))
          ...
          (this.arrayBuffer = function () {
            if (this._bodyArrayBuffer) {
              ...
              if (i.blob) return this.blob().then(g);
      ...
      function I(P, L) {
        ...
        if (P instanceof I) {
          ...
          (this.url = P.url),
            ...
            !M && P._bodyInit != null && ((M = P._bodyInit), (P.bodyUsed = !0));
        ...
        if (
          ...
          if (T.test(this.url))
            ...
            var D = /\?/;
            this.url +=
              (D.test(this.url) ? "&" : "?") + "_=" + new Date().getTime();
          }
        }
      }
...
`) === 0
      ...
      S.call(z.prototype),
        ...
        (z.error = function () {
          var P = new z(null, { status: 200, statusText: "" });
          return (P.ok = !1), (P.status = 0), (P.type = "error"), P;
        });
      var G = [301, 302, 303, 307, 308];
      (z.redirect = function (P, L) {
        if (G.indexOf(L) === -1) throw new RangeError("Invalid status code");
        return new z(null, { status: L, headers: { location: P } });
      }),
      ...
      function U(P, L) {
        return new Promise(function (M, T) {
          ...
          (j.onload = function () {
            ...
            D.url.indexOf("file://") === 0 && (j.status < 200 || j.status > 599)
              ? (A.status = 200)
              : (A.status = j.status),
              (A.url =
                "responseURL" in j
          ...
          if (
            (j.open(D.method, _(D.url), !0),
            D.credentials === "include"
              ? (j.withCredentials = !0)
              : D.credentials === "omit" && (j.withCredentials = !1),
            "responseType" in j &&
              (i.blob
                ? (j.responseType = "blob")
                : i.arrayBuffer && (j.responseType = "arraybuffer")),
            L &&
              typeof L.headers == "object" &&
              !(
                L.headers instanceof d ||
                (r.Headers && L.headers instanceof r.Headers)
              ))
          ) {
            var C = [];
            Object.getOwnPropertyNames(L.headers).forEach(function (A) {
              C.push(c(A)), j.setRequestHeader(A, l(L.headers[A]));
            }),
          ...
          D.signal &&
            (D.signal.addEventListener("abort", b),
      ...
      return (
        (U.polyfill = !0),
        r.fetch ||
          ((r.fetch = U), (r.Headers = d), (r.Request = I), (r.Response = z)),
        (n.Headers = d),
        (n.Request = I),
        (n.Response = z),
        (n.fetch = U),
...
var Yc = Fc((Wc, Gc) => {
  ...
  (function (e) {
    var t = Object.hasOwnProperty,
      ...
      l = o
        ? s && typeof Reflect.ownKeys == "function"
          ? Reflect.ownKeys
          : function (b) {
              var _ = Object.getOwnPropertyNames(b);
              return _.push.apply(_, Object.getOwnPropertySymbols(b)), _;
            }
        : Object.keys;
    function u() {
    ...
    function h(b, _) {
      ...
      if (
        (this.verboseMemoryLeak && (C += " Event name: " + _ + "."),
      ...
      } else console.error(C), console.trace && console.trace();
    }
    var f = function (b, _, C) {
      ...
      switch (A) {
        ...
        case 3:
          return [b, _, C];
        default:
          for (var R = new Array(A); A--; ) R[A] = arguments[A];
          return R;
      }
    };
    function g(b, _) {
    ...
    function m(b, _, C) {
      ...
      var A, R;
      if (
        ((C.on || C.off) && ((A = C.on), (R = C.off)),
        _.addEventListener
          ? ((A = _.addEventListener), (R = _.removeEventListener))
          : _.addListener
          ? ((A = _.addListener), (R = _.removeListener))
          : _.on && ((A = _.on), (R = _.off)),
        !A && !R)
      )
    ...
    Object.assign(m.prototype, {
      subscribe: function (b, _, C) {
        ...
        if (y[b]) throw Error("Event '" + b + "' is already listening");
        this._listenersCount++,
          w._newListener && w._removeListener && !A._onNewListener
            ? ((this._onNewListener = function (k) {
                k === _ && y[b] === null && ((y[b] = x), A._on.call(R, b, x));
              }),
              ...
              (this._onRemoveListener = function (k) {
                k === _ &&
                  !w.hasListeners(k) &&
                  y[b] &&
                  ((y[b] = null), A._off.call(R, b, x));
              }),
              (y[b] = null),
              w.on("removeListener", this._onRemoveListener))
            : ((y[b] = x), A._on.call(R, b, x));
      },
      unsubscribe: function (b) {
        ...
        function O() {
          _._onNewListener &&
            (A.off("newListener", _._onNewListener),
        ...
        if (b) {
          if (((R = C[b]), !R)) return;
          y.call(x, b, R), delete C[b], --this._listenersCount || O();
        } else {
          for (w = l(C), k = w.length; k-- > 0; )
            (b = w[k]), y.call(x, b, C[b]);
    ...
    function v(b, _, C, A) {
      ...
      if (!b) return R;
      if (typeof b != "object") throw TypeError("options must be an object");
      var w = Object.keys(b),
        y = w.length,
        x,
        k,
      ...
      function $(H) {
        throw Error(
          'Invalid "' + x + '" option value' + (H ? ". Reason: " + H : "")
        );
      }
      for (var K = 0; K < y; K++) {
        if (((x = w[K]), !A && !t.call(_, x)))
          throw Error('Unknown "' + x + '" option');
        (k = b[x]), k !== e && ((O = C[x]), (R[x] = O ? O(k, $) : k));
      }
      return R;
    }
    function p(b, _) {
      return (
        (typeof b != "function" || !b.hasOwnProperty("prototype")) &&
          _("value must be a constructor"),
        b
      );
    }
    function S(b) {
      ...
      return C === 1
        ...
        : function (w, y) {
            for (var x = typeof w, k = C; k-- > 0; ) if (x === b[k]) return w;
            y(_);
          };
    }
    var E = S(["function"]),
      ...
      var A,
        ...
        x = new b(function (k, O, $) {
          (C = v(
              ...
              timeout: function (X, ee) {
                return (
                  ...
                  (typeof X != "number" || X < 0 || !Number.isFinite(X)) &&
                    ee("timeout must be a positive number"),
                  X
                );
              },
            }
            ...
            (A =
              !C.overload &&
              typeof b.prototype.cancel == "function" &&
              typeof $ == "function");
          function K() {
            R && (R = null), w && (clearTimeout(w), (w = 0));
          }
          var H = function (X) {
              K(), k(X);
            },
          ...
          A
            ...
            C.timeout > 0 &&
              (w = setTimeout(function () {
                var X = Error("timeout");
                (X.code = "ETIMEDOUT"), (w = 0), x.cancel(X), O(X);
              }, C.timeout));
        });
      return (
        A ||
    ...
    function q(b, _, C, A, R) {
      ...
      if (A === 0) {
        ...
        if (w === "string") {
          ...
          if ((x = _.indexOf($)) !== -1) {
            y = new Array(5);
            do (y[k++] = _.slice(O, x)), (O = x + K);
            while ((x = _.indexOf($, O)) !== -1);
            (y[k++] = _.slice(O)), (_ = y), (R = k);
          } else (_ = [_]), (R = 1);
        } else w === "object" ? (R = _.length) : ((_ = [_]), (R = 1));
      }
      var H = null,
        V,
        X,
      ...
      if (A === R)
        C._listeners &&
          (typeof C._listeners == "function"
            ? (b && b.push(C._listeners), (H = [C]))
            : (b && b.push.apply(b, C._listeners), (H = [C])));
      else if (ce === "*") {
        for (ne = l(C), x = ne.length; x-- > 0; )
          (V = ne[x]),
            V !== "_listeners" &&
              ((ae = q(b, _, C[V], A + 1, R)),
        ...
        for (
          ...
          (V = ne[x]),
            V !== "_listeners" &&
              ...
              ae && (H ? H.push.apply(H, ae) : (H = ae)));
        return H;
      } else C[ce] && (H = q(b, _, C[ce], A + 1, R));
      if (((X = C["*"]), X && q(b, _, X, A + 1, R), (ee = C["**"]), ee))
        if (A < R)
          for (
            ee._listeners && q(b, _, ee, R, R), ne = l(ee), x = ne.length;
            x-- > 0;
    ...
    function U(b) {
      for (var _ = l(b), C = _.length, A, R, w; C-- > 0; )
        (R = _[C]),
          (A = b[R]),
          A && ((w = !0), R !== "_listeners" && !U(A) && delete b[R]);
      return w;
    }
    function P(b, _, C) {
      (this.emitter = b), (this.event = _), (this.listener = C);
    }
    ...
    function L(b, _, C) {
      ...
      if (A || w || R) {
        var x = _,
          k = _._origin || _;
        if (w && !i) throw Error("process.nextTick is not supported");
    ...
    (M.EventEmitter2 = M),
      (M.prototype.listenTo = function (b, _, C) {
        if (typeof b != "object") throw TypeError("target musts be an object");
        var A = this;
        C = v(
          C,
          { on: e, off: e, reducers: e },
          { on: E, off: E, reducers: N }
        );
        function R(w) {
          if (typeof w != "object") throw TypeError("events must be an object");
          var y = C.reducers,
            x = F.call(A, b),
            k;
          x === -1 ? (k = new m(A, b, C)) : (k = A._observers[x]);
          for (
            var O = l(w), $ = O.length, K, H = typeof y == "function", V = 0;
            V < $;
            V++
          )
            (K = O[V]), k.subscribe(K, w[K] || K, H ? y : y && y[K]);
        }
        return (
          n(_) ? R(g(_)) : R(typeof _ == "string" ? g(_.split(/\s+/)) : _), this
        );
      }),
      (M.prototype.stopListeningTo = function (b, _) {
        ...
        for (; A-- > 0; )
          (R = C[A]), (!b || R._target === b) && (R.unsubscribe(_), (w = !0));
        return w;
      }),
      ...
      (M.prototype._many = function (b, _, C, A, R) {
        ...
        function y() {
          return --_ === 0 && w.off(b, y), C.apply(this, arguments);
        }
        return (y._origin = C), this._on(b, y, A, R);
      }),
      (M.prototype.emit = function () {
        ...
        if (this._all && this._all.length)
          for (O = this._all.slice(), w = 0, R = O.length; w < R; w++)
            switch (((this.event = b), k)) {
              case 1:
                O[w].call(this, b);
                break;
              case 2:
        ...
        if (C) (O = []), q.call(this, O, _, this.listenerTree, 0, R);
        else if (((O = this._events[b]), typeof O == "function")) {
          switch (((this.event = b), k)) {
            case 1:
              O.call(this);
              break;
      ...
      (M.prototype.emitAsync = function () {
        ...
        var k = [],
          ...
          $;
        if (this._all)
          for (y = 0, w = this._all.length; y < w; y++)
            switch (((this.event = b), O)) {
              case 1:
        ...
        if (
          (_
            ? (($ = []), q.call(this, $, C, this.listenerTree, 0))
            : ($ = this._events[b]),
          typeof $ == "function")
        )
          switch (((this.event = b), O)) {
      ...
      (M.prototype._on = function (b, _, C, A) {
        if (typeof b == "function") return this._onAny(b, _), this;
      ...
      (M.prototype.off = function (b, _) {
        ...
        if (this.wildcard) {
          ...
          if (((A = q.call(this, null, R, this.listenerTree, 0)), !A))
            return this;
        } else {
          if (!this._events[b]) return this;
          (C = this._events[b]), A.push({ _listeners: C });
        }
        for (var w = 0; w < A.length; w++) {
          var y = A[w];
          if (((C = y._listeners), n(C))) {
            for (var x = -1, k = 0, O = C.length; k < O; k++)
              if (
                C[k] === _ ||
                (C[k].listener && C[k].listener === _) ||
                (C[k]._origin && C[k]._origin === _)
              ) {
                x = k;
                break;
              }
            ...
            return (
              this.wildcard
                ? y._listeners.splice(x, 1)
                : this._events[b].splice(x, 1),
              C.length === 0 &&
                (this.wildcard ? delete y._listeners : delete this._events[b]),
              this._removeListener && this.emit("removeListener", b, _),
              this
            );
          } else
            (C === _ ||
              (C.listener && C.listener === _) ||
              (C._origin && C._origin === _)) &&
              (this.wildcard ? delete y._listeners : delete this._events[b],
              this._removeListener && this.emit("removeListener", b, _));
        }
      ...
      (M.prototype.offAny = function (b) {
        ...
        if (b && this._all && this._all.length > 0) {
          for (A = this._all, _ = 0, C = A.length; _ < C; _++)
            if (b === A[_])
              return (
                A.splice(_, 1),
      ...
      (M.prototype.removeAllListeners = function (b) {
        if (b === e) return !this._events || u.call(this), this;
        if (this.wildcard) {
          var _ = q.call(this, null, b, this.listenerTree, 0),
            C,
            A;
          if (!_) return this;
          for (A = 0; A < _.length; A++) (C = _[A]), (C._listeners = null);
      ...
      (M.prototype.listeners = function (b) {
        ...
        if (b === e) {
          ...
          if (!_) return [];
          for (C = l(_), w = C.length, R = []; w-- > 0; )
            (A = _[C[w]]),
              typeof A == "function" ? R.push(A) : R.push.apply(R, A);
          return R;
        } else {
          if (this.wildcard) {
            if (((y = this.listenerTree), !y)) return [];
            var x = [],
              k = typeof b == "string" ? b.split(this.delimiter) : b.slice();
            return q.call(this, x, k, y, 0), x;
          }
          return _
            ? ((A = _[b]), A ? (typeof A == "function" ? [A] : A) : [])
            : [];
        }
      }),
      (M.prototype.eventNames = function (b) {
        ...
        return this.wildcard
          ? G.call(this, this.listenerTree, [], null, b)
          : _
          ? l(_)
          : [];
      }),
      ...
      (M.prototype.hasListeners = function (b) {
        if (this.wildcard) {
          ...
          return q.call(this, _, C, this.listenerTree, 0), _.length > 0;
        }
        var A = this._events,
          R = this._all;
      ...
      (M.prototype.waitFor = function (b, _) {
        ...
        return (
          A === "number"
            ? (_ = { timeout: _ })
            : A === "function" && (_ = { filter: _ }),
          (_ = v(
            _,
            { timeout: 0, filter: e, handleError: !1, Promise, overload: !1 },
            { filter: E, Promise: p }
          )),
          I(
            _.Promise,
            function (R, w, y) {
              function x() {
                ...
                if (!(k && !k.apply(C, arguments)))
                  if ((C.off(b, x), _.handleError)) {
                    var O = arguments[0];
                    O ? w(O) : R(f.apply(null, arguments).slice(1));
                  } else R(f.apply(null, arguments));
              }
              y(function () {
                C.off(b, x);
              }),
    ...
    function T(b, _, C) {
      C = v(C, { Promise, timeout: 0, overload: !1 }, { Promise: p });
      var A = C.Promise;
      return I(
        A,
        function (R, w, y) {
          ...
          if (typeof b.addEventListener == "function") {
            (x = function () {
              ...
              b.addEventListener(_, x, { once: !0 });
            return;
          }
          var k = function () {
              O && b.removeListener("error", O), R(f.apply(null, arguments));
            },
            O;
          _ !== "error" &&
            ((O = function ($) {
              b.removeListener(_, k), w($);
            }),
            b.once("error", O)),
            y(function () {
              O && b.removeListener("error", O), b.removeListener(_, k);
            }),
            b.once(_, k);
        },
        { timeout: C.timeout, overload: C.overload }
      );
    }
    var D = M.prototype;
    if (
      (Object.defineProperties(M, {
        ...
        once: { value: T, writable: !0, configurable: !0 },
      }),
      Object.defineProperties(D, {
        _maxListeners: { value: r, writable: !0, configurable: !0 },
    ...
    else if (typeof Wc == "object") Gc.exports = M;
    else {
...
var Gn = U0;
var $e = [];
for (Ci = 0; Ci < 256; ++Ci) $e.push((Ci + 256).toString(16).substr(1));
var Ci;
function H0(e) {
  ...
  if (!Gn(n)) throw TypeError("Stringified UUID is invalid");
  return n;
}
var Jc = H0;
function F0(e, t, n) {
...
var Mr = { type: "error", data: "parser error" };
var el =
  ...
  Tr = ({ type: e, data: t }, n, r) =>
    el && t instanceof Blob
      ? n
        ? r(t)
        : Xc(t, r)
      : tl && (t instanceof ArrayBuffer || nl(t))
      ? n
        ? r(t)
        : Xc(new Blob([t]), r)
      : r(_t[e] + (t || "")),
...
function rl(e, t) {
  ...
  if (tl && (e.data instanceof ArrayBuffer || nl(e.data))) return t(Qc(e.data));
  Tr(e, !1, (n) => {
    hs || (hs = new TextEncoder()), t(hs.encode(n));
  });
}
var il = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
  Rr = typeof Uint8Array > "u" ? [] : new Uint8Array(256);
for (let e = 0; e < il.length; e++) Rr[il.charCodeAt(e)] = e;
var ol = (e) => {
  let t = e.length * 0.75,
    n = e.length,
    r,
...
var z0 = typeof ArrayBuffer == "function",
  Or = (e, t) => {
    if (typeof e != "string") return { type: "message", data: sl(e, t) };
    let n = e.charAt(0);
    return n === "b"
      ? { type: "message", data: q0(e.substring(1), t) }
      : Ar[n]
      ? e.length > 1
    ...
    transform(s, a) {
      for (n.push(s); ; ) {
        if (r === 0) {
          ...
          if (Si(n) < i) break;
          let c = ki(n, i);
          a.enqueue(Or(o ? c : fs.decode(c), t)), (r = 0);
        }
        if (i === 0 || i > e) {
          a.enqueue(Mr);
          break;
...
function Ht(e, t) {
  t.useNativeTimers
    ? ((e.setTimeoutFn = W0.bind(Ge)), (e.clearTimeoutFn = G0.bind(Ge)))
    : ((e.setTimeoutFn = Ge.setTimeout.bind(Ge)),
...
function fl(e) {
  return typeof e == "string"
    ? Z0(e)
    : Math.ceil((e.byteLength || e.size) * Y0);
}
function Z0(e) {
  let t = 0,
    n = 0;
...
var Mi = class extends Error {
  ...
  Ft = class extends Ae {
    ...
    onError(t, n, r) {
      return super.emitReserved("error", new Mi(t, n, r)), this;
    }
    open() {
    ...
    class e extends Ae {
      ...
      _cleanup(n) {
        if (!(typeof this._xhr > "u" || this._xhr === null)) {
          if (((this._xhr.onreadystatechange = J0), n))
            try {
              this._xhr.abort();
            } catch {}
...
if (typeof document < "u") {
  if (typeof attachEvent == "function") attachEvent("onunload", vl);
...
var X0 = (function () {
  ...
  on = class extends ms {
    ...
    request(t = {}) {
      return (
        Object.assign(t, { xd: this.xd }, this.opts), new Ti(bl, this.uri(), t)
      );
    }
  };
function bl(e) {
  let t = e.xdomain;
  try {
    if (typeof XMLHttpRequest < "u" && (!t || yl)) return new XMLHttpRequest();
  } catch {}
  if (!t)
    try {
  ...
  ys = class extends Ft {
    ...
    uri() {
      let t = this.opts.secure ? "wss" : "ws",
        n = this.query || {};
      return (
        this.opts.timestampRequests && (n[this.opts.timestampParam] = Ai()),
...
var vs = { websocket: sn, webtransport: Yn, polling: on };
var Q0 =
...
var Oi = (() => {
    class e extends Ae {
      constructor(n, r) {
        ...
        } else r.host && (r.hostname = Zn(r.host).host);
        Ht(this, r),
          (this.secure =
            r.secure != null
              ? r.secure
          ...
          typeof this.opts.query == "string" &&
            (this.opts.query = ml(this.opts.query)),
          bs &&
      ...
      createTransport(n) {
        ...
        (r.EIO = ps), (r.transport = n), this.id && (r.sid = this.id);
        let i = Object.assign(
          {},
          this.opts,
          {
      ...
      _getWritablePackets() {
        ...
        for (let i = 0; i < this.writeBuffer.length; i++) {
          ...
          if ((o && (r += fl(o)), i > 0 && r > this._maxPayload))
      ...
      write(n, r, i) {
        return this._sendPacket("message", n, r, i), this;
      }
      send(n, r, i) {
        return this._sendPacket("message", n, r, i), this;
      }
...
var ip = typeof ArrayBuffer == "function",
  ...
  sp =
    typeof Blob == "function" ||
    (typeof Blob < "u" && _l.call(Blob) === "[object BlobConstructor]"),
  ap =
    typeof File == "function" ||
    (typeof File < "u" && _l.call(File) === "[object FileConstructor]");
function Ir(e) {
  return (
    (ip && (e instanceof ArrayBuffer || op(e))) ||
    (sp && e instanceof Blob) ||
    (ap && e instanceof File)
  );
}
function Pr(e, t) {
  if (!e || typeof e != "object") return !1;
  if (Array.isArray(e)) {
    for (let n = 0, r = e.length; n < r; n++) if (Pr(e[n])) return !0;
    return !1;
  }
  if (Ir(e)) return !0;
  ...
  for (let n in e)
    if (Object.prototype.hasOwnProperty.call(e, n) && Pr(e[n])) return !0;
  return !1;
}
function Cl(e) {
  let t = [],
...
function Sl(e, t) {
  return (e.data = Es(e.data, t)), delete e.attachments, e;
}
function Es(e, t) {
  if (!e) return e;
  if (e && e._placeholder === !0) {
    ...
    for (let n = 0; n < e.length; n++) e[n] = Es(e[n], t);
...
var cp = [
  ...
  _s = class {
    ...
    encode(t) {
      return (t.type === ve.EVENT || t.type === ve.ACK) && Pr(t)
        ? this.encodeAsBinary({
...
var Cs = class e extends Ae {
    ...
    add(t) {
      ...
      if (typeof t == "string") {
        ...
        r || n.type === ve.BINARY_ACK
          ? ((n.type = r ? ve.EVENT : ve.ACK),
    ...
    decodeString(t) {
      ...
      if (t.charAt(++n)) {
        ...
        if (e.isPayloadValid(r.type, o)) r.data = o;
      ...
      switch (t) {
        ...
        case ve.BINARY_EVENT:
          return (
            Array.isArray(n) &&
            (typeof n[0] == "number" ||
              (typeof n[0] == "string" && cp.indexOf(n[0]) === -1))
          );
        case ve.ACK:
        case ve.BINARY_ACK:
  ...
  Xn = class extends Ae {
    ...
    ack(t) {
      let n = this,
        r = !1;
      return function (...i) {
        r || ((r = !0), n.packet({ type: ve.ACK, id: t, data: i }));
      };
    }
    onack(t) {
    ...
    notifyOutgoingListeners(t) {
      if (this._anyOutgoingListeners && this._anyOutgoingListeners.length) {
        ...
        for (let r of n) r.apply(this, t.data);
      }
    }
  };
function Rn(e) {
  ...
  socket(t, n) {
    ...
    return (
      r
        ...
        : ((r = new Xn(this, t, n)), (this.nsps[t] = r)),
      r
    );
  }
  _destroy(t) {
    let n = Object.keys(this.nsps);
    for (let r of n) if (this.nsps[r].active) return;
    this._close();
  }
  _packet(t) {
...
function Br(e, t) {
  ...
  let n = El(e, t.path || "/socket.io"),
    r = n.source,
    i = n.id,
    o = n.path,
    s = Nr[i] && o in Nr[i].nsps,
    a = t.forceNew || t["force new connection"] || t.multiplex === !1 || s,
    c;
  return (
    a ? (c = new Qn(r, t)) : (Nr[i] || (Nr[i] = new Qn(r, t)), (c = Nr[i])),
    n.query && !t.query && (t.query = n.queryKey),
    c.socket(n.path, t)
  );
}
Object.assign(Br, { Manager: Qn, Socket: Xn, io: Br, connect: Br });
var up = Uc({});
function J(e, t, n, r) {
...
function Al(e) {
  ...
  rc || zd();
  for (
    var n = e.length, r = n % 3, i = "", o = [], s = 16383, a = 0, c = n - r;
    a < c;
    a += s
  )
...
function qd(e, t, n, r, i, o) {
  ...
  for (
    t = Math.abs(t),
      isNaN(t) || t === 1 / 0
        ...
        : ((s = Math.floor(Math.log(t) / Math.LN2)),
          ...
          (t += s + d >= 1 ? h / c : h * Math.pow(2, 1 - d)) * c >= 2 &&
            (s++, (c /= 2)),
          s + d >= u
            ? ((a = 0), (s = u))
            : s + d >= 1
    ...
    i >= 8;
    e[n + f] = 255 & a, f += g, a /= 256, i -= 8
  );
  for (
    s = (s << i) | a, l += i;
    l > 0;
    e[n + f] = 255 & s, f += g, s /= 256, l -= 8
  );
  e[n + f - g] |= 128 * m;
}
var fp = {}.toString,
...
Z.TYPED_ARRAY_SUPPORT =
  Xe.TYPED_ARRAY_SUPPORT === void 0 || Xe.TYPED_ARRAY_SUPPORT;
var pp = vo();
function vo() {
  return Z.TYPED_ARRAY_SUPPORT ? 2147483647 : 1073741823;
}
function Zt(e, t) {
  if (vo() < t) throw new RangeError("Invalid typed array length");
  return (
    Z.TYPED_ARRAY_SUPPORT
      ? ((e = new Uint8Array(t)).__proto__ = Z.prototype)
      : (e === null && (e = new Z(t)), (e.length = t)),
    e
  );
}
function Z(e, t, n) {
  if (!(Z.TYPED_ARRAY_SUPPORT || this instanceof Z)) return new Z(e, t, n);
  if (typeof e == "number") {
    if (typeof t == "string")
      throw new Error(
...
function Wd(e, t, n, r) {
  ...
  return typeof ArrayBuffer < "u" && t instanceof ArrayBuffer
        ...
        return (
          (o =
            s === void 0 && a === void 0
              ...
              : a === void 0
              ? new Uint8Array(o, s)
              : new Uint8Array(o, s, a)),
          Z.TYPED_ARRAY_SUPPORT
            ? ((i = o).__proto__ = Z.prototype)
            : (i = xs(i, o)),
          i
        );
      })(e, t, n, r)
    ...
    ? (function (i, o, s) {
        if (
          ((typeof s == "string" && s !== "") || (s = "utf8"), !Z.isEncoding(s))
        )
    ...
    : (function (i, o) {
        if (Lt(o)) {
          var s = 0 | ic(o.length);
          return (i = Zt(i, s)).length === 0 || o.copy(i, 0, 0, s), i;
        }
        if (o) {
          if (
            (typeof ArrayBuffer < "u" && o.buffer instanceof ArrayBuffer) ||
            "length" in o
          )
            return typeof o.length != "number" || (a = o.length) != a
              ? Zt(i, 0)
              : xs(i, o);
          if (o.type === "Buffer" && Vd(o.data)) return xs(i, o.data);
        }
        var a;
        throw new TypeError(
...
function da(e, t) {
  if ((Gd(t), (e = Zt(e, t < 0 ? 0 : 0 | ic(t))), !Z.TYPED_ARRAY_SUPPORT))
...
function Ml(e, t, n, r, i) {
  ...
  if ((typeof t == "string" && (t = Z.from(t, r)), Lt(t)))
    return t.length === 0 ? -1 : Tl(e, t, n, r, i);
  if (typeof t == "number")
    return (
      (t &= 255),
      Z.TYPED_ARRAY_SUPPORT && typeof Uint8Array.prototype.indexOf == "function"
        ? i
  ...
  return Xo(
    (function (i, o) {
      for (var s, a, c, l = [], u = 0; u < i.length && !((o -= 2) < 0); ++u)
        (a = (s = i.charCodeAt(u)) >> 8), (c = s % 256), l.push(c), l.push(a);
      return l;
    })(t, e.length - n),
    e,
    n,
...
function Jd(e, t, n) {
  ...
  return (function (h) {
    var f = h.length;
    if (f <= Rl) return String.fromCharCode.apply(String, h);
    for (var g = "", m = 0; m < f; )
...
(Z.poolSize = 8192),
  (Z._augment = function (e) {
    return (e.__proto__ = Z.prototype), e;
  }),
  ...
  (Z.compare = function (e, t) {
    if (!Lt(e) || !Lt(t)) throw new TypeError("Arguments must be Buffers");
    if (e === t) return 0;
  ...
  (Z.concat = function (e, t) {
    ...
    if (e.length === 0) return Z.alloc(0);
    var n;
  ...
  (Z.prototype.swap16 = function () {
    ...
    for (var t = 0; t < e; t += 2) On(this, t, t + 1);
    return this;
  }),
  (Z.prototype.swap32 = function () {
    ...
    for (var t = 0; t < e; t += 4) On(this, t, t + 3), On(this, t + 1, t + 2);
    return this;
  }),
  ...
  (Z.prototype.equals = function (e) {
    if (!Lt(e)) throw new TypeError("Argument must be a Buffer");
...
function Ol(e, t, n, r, i) {
  return i || Xd(e, 0, n, 4), qd(e, t, n, r, 23, 4), n + 4;
}
function Ll(e, t, n, r, i) {
  return i || Xd(e, 0, n, 8), qd(e, t, n, r, 52, 8), n + 8;
}
(Z.prototype.slice = function (e, t) {
  ...
  (Z.prototype.readFloatLE = function (e, t) {
    return t || Ie(e, 4, this.length), Pi(this, e, !0, 23, 4);
  }),
  (Z.prototype.readFloatBE = function (e, t) {
    return t || Ie(e, 4, this.length), Pi(this, e, !1, 23, 4);
  }),
  (Z.prototype.readDoubleLE = function (e, t) {
    return t || Ie(e, 8, this.length), Pi(this, e, !0, 52, 8);
  }),
  (Z.prototype.readDoubleBE = function (e, t) {
    return t || Ie(e, 8, this.length), Pi(this, e, !1, 52, 8);
  }),
...
function Qd(e) {
  return (function (t) {
    ...
    for (n = 0, r = 0; n < i; n += 4, r += 3)
      (o =
        (vt[t.charCodeAt(n)] << 18) |
        (vt[t.charCodeAt(n + 1)] << 12) |
        (vt[t.charCodeAt(n + 2)] << 6) |
        vt[t.charCodeAt(n + 3)]),
        (a[l++] = (o >> 16) & 255),
        (a[l++] = (o >> 8) & 255),
        (a[l++] = 255 & o);
    return (
      s === 2
        ? ((o = (vt[t.charCodeAt(n)] << 2) | (vt[t.charCodeAt(n + 1)] >> 4)),
          (a[l++] = 255 & o))
        : s === 1 &&
          ((o =
            (vt[t.charCodeAt(n)] << 10) |
            (vt[t.charCodeAt(n + 1)] << 4) |
            (vt[t.charCodeAt(n + 2)] >> 2)),
          (a[l++] = (o >> 8) & 255),
          (a[l++] = 255 & o)),
      a
    );
...
function oc(e, ...t) {
  if (!nh(e)) throw new Error("Uint8Array expected");
...
Object.defineProperty(ze, "__esModule", { value: !0 }),
  ...
  (ze.exists = ih),
  (ze.output = oh);
var Tp = { number: wo, bool: th, bytes: oc, hash: rh, exists: ih, output: oh };
(ze.default = Tp),
  (function (e) {
      ...
      (e.asyncLoop = function (d, h, f) {
        return we(this, null, function* () {
          ...
          for (let m = 0; m < d; m++) {
            f(m);
            let v = Date.now() - g;
            (v >= 0 && v < h) || (yield (0, e.nextTick)(), (g += v));
          }
        });
      }),
      (e.utf8ToBytes = c),
    ...
    let t = ze;
    if (
      ((e.u8 = (d) => new Uint8Array(d.buffer, d.byteOffset, d.byteLength)),
      (e.u16 = (d) =>
        new Uint16Array(d.buffer, d.byteOffset, Math.floor(d.byteLength / 2))),
      (e.u32 = (d) =>
    ...
    let n = Array.from({ length: 256 }, (d, h) =>
    ...
    let i = { _0: 48, _9: 57, _A: 65, _F: 70, _a: 97, _f: 102 };
    function o(d) {
    ...
    function s(d) {
      ...
      if (h % 2)
        throw new Error(
          "padded hex string expected, got unpadded hex of length " + h
        );
      let g = new Uint8Array(f);
      for (let m = 0, v = 0; m < f; m++, v += 2) {
    ...
    (e.nextTick = () => we(this, null, function* () {})), (e.Hash = class {});
    function l(d, h, f, g) {
      ...
      let m = BigInt(32),
        ...
        E = g ? 4 : 0,
        N = g ? 0 : 4;
      d.setUint32(h + E, p, g), d.setUint32(h + N, S, g);
    }
    function u(d) {
      return Uint8Array.from(d);
    }
    e.wrapCipher = (d, h) => (Object.assign(h, d), h);
  })(ht);
var ni = {},
  Ne = {};
Object.defineProperty(Ne, "__esModule", { value: !0 }),
  (Ne.AEAD_TAG_LENGTH =
    Ne.XCHACHA20_NONCE_LENGTH =
    Ne.CURVE25519_PUBLIC_KEY_SIZE =
    Ne.ETH_PUBLIC_KEY_SIZE =
    Ne.UNCOMPRESSED_PUBLIC_KEY_SIZE =
    Ne.COMPRESSED_PUBLIC_KEY_SIZE =
    Ne.SECRET_KEY_LENGTH =
      void 0),
      ...
      (e.ephemeralKeySize = function () {
        var r = {
          secp256k1: e.ECIES_CONFIG.isEphemeralKeyCompressed
            ? t.COMPRESSED_PUBLIC_KEY_SIZE
            : t.UNCOMPRESSED_PUBLIC_KEY_SIZE,
  ...
  (function (e) {
    Object.defineProperty(e, "__esModule", { value: !0 }),
      ...
      (e.managedNonce = function (l) {
        return (
          (0, n.number)(l.nonceLength),
          (u, ...d) => ({
            encrypt(h, ...f) {
              let { nonceLength: g } = l,
                m = i(g),
                v = l(u, m, ...d).encrypt(h, ...f),
                p = (0, r.concatBytes)(m, v);
              return v.fill(0), p;
            },
            decrypt(h, ...f) {
              let { nonceLength: g } = l,
    ...
    function o() {
      if (
        t.crypto &&
        typeof t.crypto.subtle == "object" &&
        t.crypto.subtle != null
      )
    ...
    let s = { CBC: "AES-CBC", CTR: "AES-CTR", GCM: "AES-GCM" };
    function a(l) {
      return (u, d, h) => {
        (0, n.bytes)(u), (0, n.bytes)(d);
        let f = { name: l, length: 8 * u.length },
          g = (function (m, v, p) {
            if (m === s.CBC) return { name: s.CBC, iv: v };
            if (m === s.CTR) return { name: s.CTR, counter: v, length: 64 };
            if (m === s.GCM)
              return p
                ? { name: s.GCM, iv: v, additionalData: p }
                : { name: s.GCM, iv: v };
            throw new Error("unknown aes block mode");
          })(l, d, h);
        return {
          encrypt: (m) => ((0, n.bytes)(m), e.utils.encrypt(u, f, g, m)),
          decrypt: (m) => ((0, n.bytes)(m), e.utils.decrypt(u, f, g, m)),
        };
      };
    }
...
function ac(e, ...t) {
  if (!lh(e)) throw new Error("Uint8Array expected");
  if (t.length > 0 && !t.includes(e.length))
    throw new Error(
      `Uint8Array expected of length ${t}, not of length=${e.length}`
    );
...
Object.defineProperty(lt, "__esModule", { value: !0 }),
  ...
  (lt.exists = dh),
  (lt.output = hh);
var Rp = { number: _o, bool: ch, bytes: ac, hash: uh, exists: dh, output: hh };
lt.default = Rp;
var nn = {},
  Di = {};
  ...
  (function (e) {
    Object.defineProperty(e, "__esModule", { value: !0 }),
      ...
      (e.byteSwap32 = function (l) {
        for (let u = 0; u < l.length; u++) l[u] = (0, e.byteSwap)(l[u]);
      }),
      ...
      (e.asyncLoop = function (l, u, d) {
        return we(this, null, function* () {
          ...
          for (let f = 0; f < l; f++) {
            d(f);
            let g = Date.now() - h;
            (g >= 0 && g < u) || (yield (0, e.nextTick)(), (h += g));
          }
        });
      }),
      (e.utf8ToBytes = s),
    ...
    (e.u8 = (l) => new Uint8Array(l.buffer, l.byteOffset, l.byteLength)),
      (e.u32 = (l) =>
        new Uint32Array(l.buffer, l.byteOffset, Math.floor(l.byteLength / 4))),
      (e.createView = (l) =>
      ...
      (e.byteSwap = (l) =>
        ...
        ((l >>> 8) & 65280) |
        ((l >>> 24) & 255)),
      (e.byteSwapIfBE = e.isLE ? (l) => l : (l) => (0, e.byteSwap)(l));
    let r = Array.from({ length: 256 }, (l, u) =>
...
Jt.HashMD = class extends Dr.Hash {
  ...
  digestInto(e) {
    (0, Ms.exists)(this), (0, Ms.output)(e, this), (this.finished = !0);
    ...
    (function (u, d, h, f) {
      ...
      let g = BigInt(32),
        ...
        S = f ? 4 : 0,
        E = f ? 0 : 4;
      u.setUint32(d + S, v, f), u.setUint32(d + E, p, f);
    })(n, r - 8, BigInt(8 * this.length), i),
      this.process(n, 0);
    let s = (0, Dr.createView)(e),
      a = this.outputLen;
...
function cc(e, t = !1) {
  return t
    ? { h: Number(e & $i), l: Number((e >> ha) & $i) }
    : { h: 0 | Number((e >> ha) & $i), l: 0 | Number(e & $i) };
}
function fh(e, t = !1) {
  ...
  Kn = class extends Lp.HashMD {
    ...
    process(t, n) {
      for (let E = 0; E < 16; E++, n += 4)
        (an[E] = t.getUint32(n)), (cn[E] = t.getUint32((n += 4)));
      for (let E = 16; E < 80; E++) {
        let N = 0 | an[E - 15],
          I = 0 | cn[E - 15],
          F =
            fe.default.rotrSH(N, I, 1) ^
            fe.default.rotrSH(N, I, 8) ^
            fe.default.shrSH(N, I, 7),
          q =
            fe.default.rotrSL(N, I, 1) ^
            fe.default.rotrSL(N, I, 8) ^
            fe.default.shrSL(N, I, 7),
          z = 0 | an[E - 2],
          G = 0 | cn[E - 2],
          U =
            fe.default.rotrSH(z, G, 19) ^
            fe.default.rotrBH(z, G, 61) ^
            fe.default.shrSH(z, G, 6),
          P =
            fe.default.rotrSL(z, G, 19) ^
            fe.default.rotrBL(z, G, 61) ^
            fe.default.shrSL(z, G, 6),
      ...
      for (let E = 0; E < 80; E++) {
        let N =
            fe.default.rotrSH(d, h, 14) ^
            fe.default.rotrSH(d, h, 18) ^
            fe.default.rotrBH(d, h, 41),
          I =
            fe.default.rotrSL(d, h, 14) ^
            fe.default.rotrSL(d, h, 18) ^
            fe.default.rotrBL(d, h, 41),
          F = (d & f) ^ (~d & m),
          q = (h & g) ^ (~h & v),
          ...
          U = 0 | z,
          P =
            fe.default.rotrSH(r, i, 28) ^
            fe.default.rotrBH(r, i, 34) ^
            fe.default.rotrBH(r, i, 39),
          L =
            fe.default.rotrSL(r, i, 28) ^
            fe.default.rotrBL(r, i, 34) ^
            fe.default.rotrBL(r, i, 39),
          M = (r & o) ^ (r & a) ^ (o & a),
          T = (i & s) ^ (i & c) ^ (s & c);
        (p = 0 | m),
          (S = 0 | v),
        ...
        (r = fe.default.add3H(D, G, P, M)), (i = 0 | D);
      }
      ({ h: r, l: i } = fe.default.add(0 | this.Ah, 0 | this.Al, 0 | r, 0 | i)),
        ({ h: o, l: s } = fe.default.add(
          0 | this.Bh,
          0 | this.Bl,
          0 | o,
          0 | s
        )),
        ({ h: a, l: c } = fe.default.add(
          0 | this.Ch,
          0 | this.Cl,
          0 | a,
          0 | c
        )),
        ({ h: l, l: u } = fe.default.add(
          0 | this.Dh,
          0 | this.Dl,
          0 | l,
          0 | u
        )),
        ({ h: d, l: h } = fe.default.add(
          0 | this.Eh,
          0 | this.El,
          0 | d,
          0 | h
        )),
        ({ h: f, l: g } = fe.default.add(
          0 | this.Fh,
          0 | this.Fl,
          0 | f,
          0 | g
        )),
        ({ h: m, l: v } = fe.default.add(
          0 | this.Gh,
          0 | this.Gl,
          0 | m,
          0 | v
        )),
        ({ h: p, l: S } = fe.default.add(
          0 | this.Hh,
          0 | this.Hl,
          0 | p,
          0 | S
...
(Be.SHA384 = ko),
  (Be.sha512 = (0, ji.wrapConstructor)(() => new Kn())),
  (Be.sha512_224 = (0, ji.wrapConstructor)(() => new Co())),
  (Be.sha512_256 = (0, ji.wrapConstructor)(() => new So())),
  (Be.sha384 = (0, ji.wrapConstructor)(() => new ko()));
var fa = {},
  sr = {},
  ke = {},
  pe = {};
Object.defineProperty(pe, "__esModule", { value: !0 }),
  ...
  (pe.bytesToNumberLE = function (e) {
    return Ao(e), Rs(Ts(Uint8Array.from(e).reverse()));
  }),
  ...
  (pe.ensureBytes = function (e, t, n) {
    ...
    if (typeof t == "string")
      ...
      if (!xo(t)) throw new Error(`${e} must be hex string or Uint8Array`);
      r = Uint8Array.from(t);
    }
    let i = r.length;
  ...
  (pe.validateObject = function (e, t, n = {}) {
    let r = (i, o, s) => {
      ...
      if (!((s && c === void 0) || a(c, e)))
        throw new Error(
          `Invalid param ${String(i)}=${c} (${typeof c}), expected ${o}`
        );
    };
    for (let [i, o] of Object.entries(t)) r(i, o, !1);
    for (let [i, o] of Object.entries(n)) r(i, o, !0);
    return e;
  }),
...
var Bp = Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
function Ts(e) {
  Ao(e);
  let t = "";
  for (let n = 0; n < e.length; n++) t += Bp[e[n]];
  return t;
}
function Il(e) {
  let t = e.toString(16);
...
(pe.notImplemented = () => {
  ...
  (ke.validateField = function (e) {
    let t = jp.reduce((n, r) => ((n[r] = "function"), n), {
      ORDER: "bigint",
      MASK: "bigint",
      BYTES: "isSafeInteger",
      BITS: "isSafeInteger",
    });
    return (0, st.validateObject)(e, t);
  }),
  (ke.FpPow = Fl),
  (ke.FpInvertBatch = zl),
  ...
  (ke.Field = function (e, t, n = !1, r = {}) {
    if (e <= De) throw new Error(`Expected Field ORDER > 0, got ${e}`);
    ...
    let s = Hl(e),
      a = Object.freeze({
        ...
        cmov: (c, l, u) => (u ? l : c),
        toBytes: (c) =>
          n ? (0, st.numberToBytesLE)(c, o) : (0, st.numberToBytesBE)(c, o),
        fromBytes: (c) => {
          if (c.length !== o)
            throw new Error(`Fp.fromBytes: expected ${o}, got ${c.length}`);
          return n ? (0, st.bytesToNumberLE)(c) : (0, st.bytesToNumberBE)(c);
        },
      });
  ...
  (ke.hashToPrivateScalar = function (e, t, n = !1) {
    e = (0, st.ensureBytes)("privateHash", e);
    let r = e.length,
    ...
    let o = n ? (0, st.bytesToNumberLE)(e) : (0, st.bytesToNumberBE)(e);
    return ct(o, t - Me) + Me;
  }),
  ...
  (ke.mapHashToField = function (e, t, n = !1) {
    ...
    let s =
      ct(n ? (0, st.bytesToNumberBE)(e) : (0, st.bytesToNumberLE)(e), t - Me) +
      Me;
    return n ? (0, st.numberToBytesLE)(s, i) : (0, st.numberToBytesBE)(s, i);
  });
var st = pe,
  De = BigInt(0),
  Me = BigInt(1),
...
function Ih(e, t, n) {
  if (n <= De || t < De) throw new Error("Expected power/modulo > 0");
  if (n === Me) return De;
  let r = Me;
  for (; t > De; ) t & Me && (r = (r * e) % n), (e = (e * e) % n), (t >>= Me);
  return r;
}
function Ki(e, t) {
  if (e === De || t <= De)
...
function Fl(e, t, n) {
  if (n < De) throw new Error("Expected power > 0");
  if (n === De) return e.ONE;
  if (n === Me) return t;
  let r = e.ONE,
    i = t;
  for (; n > De; ) n & Me && (r = e.mul(r, i)), (i = e.sqr(i)), (n >>= Me);
  return r;
}
function zl(e, t) {
  let n = new Array(t.length),
    r = t.reduce(
      (o, s, a) => (e.is0(s) ? o : ((n[a] = o), e.mul(o, s))),
      e.ONE
    ),
    i = e.inv(r);
  return (
    t.reduceRight(
      (o, s, a) => (e.is0(s) ? o : ((n[a] = e.mul(o, n[a])), e.mul(o, s))),
      i
    ),
    n
  );
...
Object.defineProperty(sr, "__esModule", { value: !0 }),
  (sr.wNAF = function (e, t) {
    let n = (o, s) => {
      ...
      i = (o) => (
        r(o), { windows: Math.ceil(t / o) + 1, windowSize: 2 ** (o - 1) }
      );
    return {
      constTimeNegate: n,
      unsafeLadder(o, s) {
        let a = e.ZERO,
          c = o;
        for (; s > Kp; ) s & Is && (a = a.add(c)), (c = c.double()), (s >>= Is);
        return a;
      },
      ...
      wNAFCached(o, s, a) {
        let c = Yl.get(o) || 1,
          l = Ns.get(o);
        return (
          l || ((l = this.precomputeWindow(o, c)), c !== 1 && Ns.set(o, a(l))),
          this.wNAF(c, l, s)
        );
      },
      setWindowSize(o, s) {
        r(s), Yl.set(o, s), Ns.delete(o);
      },
    };
  }),
  (sr.pippenger = function (e, t, n, r) {
    ...
    let i = (0, Gl.bitLen)(BigInt(n.length)),
  ...
  (sr.validateBasic = function (e) {
    return (
      ...
      Object.freeze(
        it(xe(xe({}, (0, Wl.nLength)(e.n, e.nBitLength)), e), { p: e.Fp.ORDER })
      )
    );
  });
var Wl = ke,
...
Object.defineProperty(fa, "__esModule", { value: !0 }),
  (fa.twistedEdwards = function (e) {
    let t = (function (M) {
      ...
      l = Ui << (BigInt(8 * a) - tt),
      u = n.create,
      d = (0, Zl.Field)(t.n, t.nBitLength),
      h =
        t.uvRatio ||
        ((M, T) => {
          try {
            return { isValid: !0, value: n.sqrt(M * n.inv(T)) };
          } catch {
      ...
      g =
        t.domain ||
        ((M, T, D) => {
          if (((0, at.abool)("phflag", D), T.length || D))
    ...
    function v(M) {
      if (!(M instanceof E)) throw new Error("ExtendedPoint expected");
    }
    let p = (0, at.memoized)((M, T) => {
        ...
        let C = u(D * T),
          A = u(j * T),
          R = u(b * T);
        if (_) return { x: Ct, y: tt };
        if (R !== tt) throw new Error("invZ was invalid");
        return { x: C, y: A };
      }),
      S = (0, at.memoized)((M) => {
        let { a: T, d: D } = t;
    ...
    class E {
      ...
      static fromAffine(T) {
        if (T instanceof E) throw new Error("extended point not allowed");
        let { x: D, y: j } = T || {};
        return m("x", D), m("y", j), new E(D, j, tt, u(D * j));
      }
      static normalizeZ(T) {
      ...
      static fromHex(T, D = !1) {
        let { d: j, a: b } = t,
          _ = n.BYTES;
        (T = (0, at.ensureBytes)("pointHex", T, _)), (0, at.abool)("zip215", D);
        let C = T.slice(),
          A = T[_ - 1];
        C[_ - 1] = -129 & A;
        ...
        if (!O) throw new Error("Point.fromHex: invalid y coordinate");
        let K = ($ & tt) === tt,
          H = (128 & A) != 0;
        if (!D && $ === Ct && H)
          throw new Error("Point.fromHex: x=0 and x_0=1");
        return H !== K && ($ = u(-$)), E.fromAffine({ x: $, y: R });
      }
      ...
      toRawBytes() {
        ...
        return (j[j.length - 1] |= T & tt ? 128 : 0), j;
      }
      toHex() {
    ...
    function G(M) {
      let T = a;
      M = (0, at.ensureBytes)("private key", M, T);
      let D = (0, at.ensureBytes)("hashed private key", o(M), 2 * T),
        j = f(D.slice(0, T)),
        b = D.slice(T, 2 * T),
        _ = z(j),
        C = N.multiply(_),
        A = C.toRawBytes();
      return { head: j, prefix: b, scalar: _, point: C, pointBytes: A };
    }
    function U(M = new Uint8Array(), ...T) {
      let D = et.concatBytes(...T);
      return z(o(g(D, (0, at.ensureBytes)("context", M), !!i)));
    }
    let P = Hp;
    return (
      N._setWindowSize(8),
      {
        ...
        sign: function (M, T, D = {}) {
          (M = (0, at.ensureBytes)("message", M)), i && (M = i(M));
          ...
          return (0, at.ensureBytes)("result", w, 2 * a);
        },
        verify: function (M, T, D, j = P) {
          let { context: b, zip215: _ } = j,
            C = n.BYTES;
          (M = (0, at.ensureBytes)("signature", M, 2 * C)),
            (T = (0, at.ensureBytes)("message", T)),
            _ !== void 0 && (0, at.abool)("zip215", _),
            i && (T = i(T));
          let A = et.bytesToNumberLE(M.slice(C, 2 * C)),
            R,
            w,
            y;
          try {
          ...
          if (!_ && R.isSmallOrder()) return !1;
          let x = U(b, w.toRawBytes(), R.toRawBytes(), T);
          return w
            .add(R.multiplyUnsafe(x))
            .subtract(y)
            .clearCofactor()
            .equals(E.ZERO);
        },
        ...
        utils: {
          ...
          precompute: (M = 8, T = E.BASE) => (
            T._setWindowSize(M), T.multiply(BigInt(3)), T
          ),
        },
      }
    );
...
Object.defineProperty(gn, "__esModule", { value: !0 }),
  ...
  (gn.isogenyMap = function (e, t) {
    ...
    return (r, i) => {
      let [o, s, a, c] = n.map((l) =>
        l.reduce((u, d) => e.add(e.mul(u, r), d))
      );
      return (r = e.div(o, s)), (i = e.mul(i, e.div(a, c))), { x: r, y: i };
    };
  }),
  (gn.createHasher = function (e, t, n) {
    ...
    return {
      hashToCurve(r, i) {
        let o = Ds(r, 2, xe(it(xe({}, n), { DST: n.DST }), i)),
      ...
      encodeToCurve(r, i) {
        let o = Ds(r, 1, xe(it(xe({}, n), { DST: n.encodeDST }), i)),
...
function Bh(e, t, n, r) {
  (0, Fe.abytes)(e),
    ...
    ri(n),
    t.length > 255 &&
      (t = r((0, Fe.concatBytes)((0, Fe.utf8ToBytes)("H2C-OVERSIZE-DST-"), t)));
  let { outputLen: i, blockLen: o } = r,
    s = Math.ceil(n / i);
  if (n > 65535 || s > 255)
    throw new Error("expand_message_xmd: invalid lenInBytes");
  let a = (0, Fe.concatBytes)(t, yn(t.length, 1)),
    c = yn(0, o),
    l = yn(n, 2),
    u = new Array(s),
    d = r((0, Fe.concatBytes)(c, e, l, yn(0, 1), a));
  u[0] = r((0, Fe.concatBytes)(d, yn(1, 1), a));
  for (let h = 1; h <= s; h++) {
    let f = [qp(d, u[h - 1]), yn(h + 1, 1), a];
    u[h] = r((0, Fe.concatBytes)(...f));
  }
  return (0, Fe.concatBytes)(...u).slice(0, n);
}
function Dh(e, t, n, r, i) {
  if (((0, Fe.abytes)(e), (0, Fe.abytes)(t), ri(n), t.length > 255)) {
    let o = Math.ceil((2 * r) / 8);
    t = i
      .create({ dkLen: o })
      .update((0, Fe.utf8ToBytes)("H2C-OVERSIZE-DST-"))
      .update(t)
      .digest();
  }
  ...
  return i
    ...
    .update(yn(n, 2))
    .update(t)
    .update(yn(t.length, 1))
    .digest();
}
function Ds(e, t, n) {
  (0, Fe.validateObject)(n, {
  ...
  (0, Fe.abytes)(e), ri(t);
  let l = typeof c == "string" ? (0, Fe.utf8ToBytes)(c) : c,
    u = r.toString(2).length,
    d = Math.ceil((u + i) / 8),
    h = t * o * d,
    f;
  if (a === "xmd") f = Bh(e, l, h, s);
  else if (a === "xof") f = Dh(e, l, h, i, s);
  else {
    if (a !== "_internal_pass")
...
Object.defineProperty(ya, "__esModule", { value: !0 }),
  (ya.montgomery = function (e) {
    let t = (function (m) {
      ...
      c = t.powPminus2 || ((m) => (0, Jl.pow)(m, n - BigInt(2), n));
    function l(m, v, p) {
      let S = r(m * (v - p));
    ...
    function d(m) {
      return (0, ln.numberToBytesLE)(r(m), o);
    }
    function h(m, v) {
      let p = (function (N) {
          let I = (0, ln.ensureBytes)("u coordinate", N, o);
          return s === 32 && (I[31] &= 127), (0, ln.bytesToNumberLE)(I);
        })(v),
        S = (function (N) {
          let I = (0, ln.ensureBytes)("scalar", N),
            F = I.length;
          if (F !== o && F !== s)
            throw new Error(`Expected ${o} or ${s} bytes, got ${F}`);
          return (0, ln.bytesToNumberLE)(a(I));
        })(m),
        E = (function (N, I) {
          (0, ln.aInRange)("u", N, er, n), (0, ln.aInRange)("scalar", I, er, n);
          let F = I,
            q = N,
            z,
            G = $s,
      ...
      if (E === er) throw new Error("Invalid private or public key received");
      return d(E);
    }
    let f = d(t.Gu);
    function g(m) {
...
(function (e) {
  ...
  function v(x) {
    let k = BigInt(10),
      ...
      H = c,
      V = (((x * x) % H) * x) % H,
      X = ((0, o.pow2)(V, h, H) * V) % H,
      ee = ((0, o.pow2)(X, d, H) * x) % H,
      re = ((0, o.pow2)(ee, g, H) * ee) % H,
      se = ((0, o.pow2)(re, k, H) * re) % H,
      ce = ((0, o.pow2)(se, O, H) * se) % H,
      ie = ((0, o.pow2)(ce, $, H) * ce) % H,
      ne = ((0, o.pow2)(ie, K, H) * ie) % H,
      ae = ((0, o.pow2)(ne, K, H) * ie) % H,
      ue = ((0, o.pow2)(ae, k, H) * re) % H;
    return { pow_p_5_8: ((0, o.pow2)(ue, h, H) * x) % H, b2: V };
  }
  function p(x) {
    return (x[0] &= 248), (x[31] &= 127), (x[31] |= 64), x;
  }
  function S(x, k) {
    let O = c,
      $ = (0, o.mod)(k * k * k, O),
      K = v(x * (0, o.mod)($ * $ * k, O)).pow_p_5_8,
      H = (0, o.mod)(x * $ * K, O),
      V = (0, o.mod)(k * H * H, O),
      X = H,
      ee = (0, o.mod)(H * l, O),
    ...
    return (
      re && (H = X),
      (se || ce) && (H = ee),
      (0, o.isNegativeLE)(H, O) && (H = (0, o.mod)(-H, O)),
      { isValid: re || se, value: H }
    );
  }
  e.ED25519_TORSION_SUBGROUP = [
  ...
  function I(x, k, O) {
    if (k.length > 255) throw new Error("Context is too big");
    return (0, n.concatBytes)(
      (0, n.utf8ToBytes)("SigEd25519 no Ed25519 collisions"),
      new Uint8Array([O ? 1 : 0, k.length]),
      k,
      x
    );
  }
  ...
  (e.ed25519 = (0, r.twistedEdwards)(N)),
    (e.ed25519ctx = (0, r.twistedEdwards)(it(xe({}, N), { domain: I }))),
    (e.ed25519ph = (0, r.twistedEdwards)(
      Object.assign({}, N, { domain: I, prehash: t.sha512 })
    )),
    (e.x25519 = (0, s.montgomery)({
      ...
      powPminus2: (x) => {
        let k = c,
          { pow_p_5_8: O, b2: $ } = v(x);
        return (0, o.mod)((0, o.pow2)(O, f, k) * $, k);
      },
      adjustScalarBytes: p,
      randomBytes: n.randomBytes,
    })),
  ...
  let q = (E.ORDER + f) / m,
    ...
    U = (0, o.FpSqrtEven)(E, E.neg(BigInt(486664)));
  function P(x) {
    let {
        xMn: k,
        xMd: O,
        ...
        let ye = E.add(ue, E.ONE),
          ...
          ge = E.mul(de, ye),
          be = E.mul(ue, ae);
        (be = E.mul(be, me)), (be = E.add(be, de)), (be = E.mul(be, me));
        let Pe = E.sqr(ge);
        (de = E.sqr(Pe)),
          (Pe = E.mul(Pe, ge)),
          (Pe = E.mul(Pe, be)),
        ...
        let L0 = E.mul(Sr, G),
          P0 = E.mul(be, ue);
        (de = E.sqr(Sr)), (de = E.mul(de, ge));
        let I0 = E.eql(de, P0),
          N0 = E.cmov(L0, Sr, I0);
        (de = E.sqr(Kc)), (de = E.mul(de, ge));
        let ls = E.eql(de, be),
          B0 = E.cmov(O0, me, ls),
          kr = E.cmov(N0, Kc, ls),
          D0 = E.isOdd(kr);
        return (
          (kr = E.cmov(kr, E.neg(kr), ls !== D0)),
          { xMn: B0, xMd: ye, yMn: kr, yMd: d }
        );
      })(x),
      H = E.mul(k, K);
    H = E.mul(H, U);
    ...
    return { x: E.mul(H, ce[0]), y: E.mul(X, ce[1]) };
  }
  let L = (0, i.createHasher)(e.ed25519.ExtendedPoint, (x) => P(x[0]), {
  ...
  function M(x) {
    if (!(x instanceof y)) throw new Error("RistrettoPoint expected");
  }
  (e.hashToCurve = L.hashToCurve), (e.encodeToCurve = L.encodeToCurve);
  let T = l,
    D = BigInt(
    ...
    R = (x) => e.ed25519.CURVE.Fp.create((0, a.bytesToNumberLE)(x) & A);
  function w(x) {
    let { d: k } = e.ed25519.CURVE,
      ...
      se = $(re * x);
    (0, o.isNegativeLE)(se, O) || (se = $(-se)), ee || (re = se), ee || (V = K);
    let ce = $(V * (K - d) * _ - X),
      ie = re * re,
      ne = $((re + re) * X),
      ae = $(ce * D),
  ...
  class y {
    ...
    static hashToCurve(k) {
      k = (0, a.ensureBytes)("ristrettoHash", k, 64);
      let O = w(R(k.slice(0, 32))),
        $ = w(R(k.slice(32, 64)));
      return new y(O.add($));
    }
    static fromHex(k) {
      k = (0, a.ensureBytes)("ristrettoHex", k, 32);
      let { a: O, d: $ } = e.ed25519.CURVE,
        ...
        X = R(k);
      if (
        !(0, a.equalBytes)((0, a.numberToBytesLE)(X, 32), k) ||
        (0, o.isNegativeLE)(X, K)
      )
        throw new Error(V);
      let ee = H(X * X),
        re = H(d + O * ee),
        ...
        me = H(ue * ye * ne),
        de = H((X + X) * ye);
      (0, o.isNegativeLE)(de, K) && (de = H(-de));
      let ge = H(re * me),
        be = H(de * ge);
      if (!ae || (0, o.isNegativeLE)(be, K) || ge === u) throw new Error(V);
      return new y(new e.ed25519.ExtendedPoint(de, ge, d, be));
    }
    toRawBytes() {
      let { ex: k, ey: O, ez: $, et: K } = this.ep,
        H = e.ed25519.CURVE.Fp.ORDER,
        ...
        ne = V(ce * ie * K),
        ae;
      if ((0, o.isNegativeLE)(K * ne, H)) {
        let ye = V(O * T),
          me = V(k * T);
        (k = ye), (O = me), (ae = V(ce * j));
      } else ae = ie;
      (0, o.isNegativeLE)(k * ne, H) && (O = V(-O));
      let ue = V(($ - O) * ae);
      return (
        (0, o.isNegativeLE)(ue, H) && (ue = V(-ue)),
        (0, a.numberToBytesLE)(ue, 32)
      );
    }
    toHex() {
    ...
    add(k) {
      return M(k), new y(this.ep.add(k.ep));
    }
    subtract(k) {
      return M(k), new y(this.ep.subtract(k.ep));
    }
    multiply(k) {
  ...
  (e.RistrettoPoint =
    (y.BASE || (y.BASE = new y(e.ed25519.ExtendedPoint.BASE)),
    y.ZERO || (y.ZERO = new y(e.ed25519.ExtendedPoint.ZERO)),
    y)),
    (e.hashToRistretto255 = (x, k) => {
      let O = k.DST,
        $ = typeof O == "string" ? (0, n.utf8ToBytes)(O) : O,
        K = (0, i.expand_message_xmd)(x, $, 64, t.sha512);
...
var js = Jt,
  ...
  ii = class extends js.HashMD {
    ...
    process(t, n) {
      for (let d = 0; d < 16; d++, n += 4) dn[d] = t.getUint32(n, !1);
      for (let d = 16; d < 64; d++) {
        let h = dn[d - 15],
          f = dn[d - 2],
          g = (0, gt.rotr)(h, 7) ^ (0, gt.rotr)(h, 18) ^ (h >>> 3),
          m = (0, gt.rotr)(f, 17) ^ (0, gt.rotr)(f, 19) ^ (f >>> 10);
      ...
      for (let d = 0; d < 64; d++) {
        let h =
            (u +
              ((0, gt.rotr)(a, 6) ^ (0, gt.rotr)(a, 11) ^ (0, gt.rotr)(a, 25)) +
              (0, js.Chi)(a, c, l) +
              Vp[d] +
              dn[d]) |
            0,
          f =
            (((0, gt.rotr)(r, 2) ^ (0, gt.rotr)(r, 13) ^ (0, gt.rotr)(r, 22)) +
              (0, js.Maj)(r, i, o)) |
            0;
        (u = l),
          (l = c),
...
(Xt.sha256 = (0, gt.wrapConstructor)(() => new ii())),
  (Xt.sha224 = (0, gt.wrapConstructor)(() => new va()));
var no = {},
  lc = {};
(function (e) {
  Object.defineProperty(e, "__esModule", { value: !0 }),
  ...
  class r extends n.Hash {
    constructor(o, s) {
      super(), (this.finished = !1), (this.destroyed = !1), (0, t.hash)(o);
      let a = (0, n.toBytes)(s);
    ...
    update(o) {
      return (0, t.exists)(this), this.iHash.update(o), this;
    }
    digestInto(o) {
      (0, t.exists)(this),
        (0, t.bytes)(o, this.outputLen),
        (this.finished = !0),
...
(function (e) {
  Object.defineProperty(e, "__esModule", { value: !0 }),
    ...
    (e.weierstrass = function (m) {
          ...
          it(xe({}, v), {
            toBytes(x, k, O) {
              let $ = k.toAffine(),
                ...
                H = r.concatBytes;
              return (
                (0, i.abool)("isCompressed", O),
                O
                  ? H(Uint8Array.from([k.hasEvenY() ? 2 : 3]), K)
                  : H(Uint8Array.from([4]), K, p.toBytes($.y))
              );
            },
            fromBytes(x) {
              let k = x.length,
              ...
              if (k !== E || (O !== 2 && O !== 3)) {
                ...
                throw new Error(
                  `Point of length ${k} was invalid. Expected ${E} compressed bytes or ${N} uncompressed bytes`
                );
              }
              {
      ...
      class T {
        ...
        static fromCompact(k) {
          let O = v.nByteLength;
          return (
            (k = (0, i.ensureBytes)("compactSignature", k, 2 * O)),
            new T(M(k, 0, O), M(k, O, 2 * O))
          );
        }
        static fromDER(k) {
          let { r: O, s: $ } = e.DER.toSig((0, i.ensureBytes)("DER", k));
          return new T(O, $);
        }
        assertValidity() {
          r.aInRange("r", this.r, l, S), r.aInRange("s", this.s, l, S);
        }
        addRecoveryBit(k) {
        ...
        recoverPublicKey(k) {
          let { r: O, s: $, recovery: K } = this,
            H = _((0, i.ensureBytes)("msgHash", k));
          if (K == null || ![0, 1, 2, 3].includes(K))
            throw new Error("recovery id invalid");
          let V = K === 2 || K === 3 ? O + v.n : O;
          if (V >= p.ORDER) throw new Error("recovery id 2 or 3 invalid");
          let X = 1 & K ? "03" : "02",
            ee = q.fromHex(X + P(V)),
            re = F(V),
            se = I(-H * re),
        ...
        normalizeS() {
          return this.hasHighS()
            ? new T(this.r, I(-this.s), this.recovery)
            : this;
        }
        toDERRawBytes() {
      ...
      let D = {
        ...
        precompute: (x = 8, k = q.BASE) => (
          k._setWindowSize(x), k.multiply(BigInt(3)), k
        ),
      };
      function j(x) {
        let k = r.isBytes(x),
      ...
      function A(x) {
        return (
          r.aInRange(`num < 2^${v.nBitLength}`, x, c, C),
      ...
      function R(x, k, O = w) {
        ...
        H == null && (H = !0),
          ...
          o(O),
          V && (x = (0, i.ensureBytes)("prehashed msgHash", $(x)));
        let ee = _(x),
          re = z(k),
          se = [A(re), A(ee)];
        if (X != null && X !== !1) {
          let ne = X === !0 ? K(p.BYTES) : X;
          se.push((0, i.ensureBytes)("extraEntropy", ne));
        }
      ...
      let w = { lowS: v.lowS, prehash: !1 },
        y = { lowS: v.lowS, prehash: !1 };
      return (
        q.BASE._setWindowSize(8),
        {
          ...
          getSharedSecret: function (x, k, O = !0) {
            if (j(x)) throw new Error("first arg must be private key");
            if (!j(k)) throw new Error("second arg must be public key");
            ...
            try {
              if (typeof K == "string" || r.isBytes(K))
                try {
                  ...
                  if (!(me instanceof e.DER.Err)) throw me;
                  X = T.fromCompact(K);
                }
              else {
                if (
    ...
    (e.mapToCurveSimpleSWU = function (m, v) {
      ...
      return (S) => {
        ...
        return (U = m.cmov(m.neg(U), U, M)), (G = m.div(G, F)), { x: G, y: U };
      };
    });
  let t = sr,
    n = ke,
  ...
  e.DER = {
    ...
    _tlv: {
      encode: (m, v) => {
        ...
        if (1 & v.length) throw new p("tlv.encode: unpadded data");
        let S = v.length / 2,
      ...
      decode(m, v) {
        let { Err: p } = e.DER,
          S = 0;
        if (m < 0 || m > 256) throw new p("tlv.encode: wrong tag");
        if (v.length < 2 || v[S++] !== m) throw new p("tlv.decode: wrong tlv");
        let E = v[S++],
          N = 0;
        if (128 & E) {
          let F = 127 & E;
          ...
          if (F > 4) throw new p("tlv.decode(long): byte length is too big");
          let q = v.subarray(S, S + F);
          if (q.length !== F)
            throw new p("tlv.decode: length bytes not complete");
          if (q[0] === 0) throw new p("tlv.decode(long): zero leftmost byte");
          for (let z of q) N = (N << 8) | z;
          if (((S += F), N < 128))
            throw new p("tlv.decode(long): not minimal encoding");
        } else N = E;
        let I = v.subarray(S, S + N);
        if (I.length !== N) throw new p("tlv.decode: wrong value length");
        return { v: I, l: v.subarray(S + N) };
      },
    },
    _int: {
      encode(m) {
        let { Err: v } = e.DER;
        if (m < c) throw new v("integer: negative integers are not allowed");
      ...
      decode(m) {
        let { Err: v } = e.DER;
        if (128 & m[0]) throw new v("Invalid signature integer: negative");
        if (m[0] === 0 && !(128 & m[1]))
    ...
    toSig(m) {
      ...
      if (G.length) throw new v("Invalid signature: left bytes after parsing");
      return { r: p.decode(F), s: p.decode(z) };
    },
    hexFromSig(m) {
  ...
  function f(m) {
    let v = (function (M) {
        ...
        if (D) {
          ...
          if (
            typeof D != "object" ||
            typeof D.beta != "bigint" ||
            typeof D.splitScalar != "function"
          )
            throw new Error(
    ...
    function F(M) {
      ...
      try {
        _ =
          typeof M == "bigint"
            ? M
            : r.bytesToNumberBE((0, i.ensureBytes)("private key", M, D));
      } catch {
        throw new Error(
          `private key must be ${D} bytes, hex or bigint, not ${typeof M}`
        );
      }
      return j && (_ = n.mod(_, b)), r.aInRange("private key", _, l, b), _;
    }
    function q(M) {
      if (!(M instanceof U)) throw new Error("ProjectivePoint expected");
    }
    let z = (0, i.memoized)((M, T) => {
        let { px: D, py: j, pz: b } = M;
        if (p.eql(b, p.ONE)) return { x: D, y: j };
        let _ = M.is0();
        T == null && (T = _ ? p.ONE : p.inv(b));
        let C = p.mul(D, T),
          A = p.mul(j, T),
          R = p.mul(b, T);
        if (_) return { x: p.ZERO, y: p.ZERO };
        if (!p.eql(R, p.ONE)) throw new Error("invZ was invalid");
        return { x: C, y: A };
      }),
      G = (0, i.memoized)((M) => {
        if (M.is0()) {
          if (v.allowInfinityPoint && !p.is0(M.py)) return;
        ...
        let j = p.sqr(D),
          b = I(T);
        if (!p.eql(j, b)) throw new Error("bad point: equation left != right");
        if (!M.isTorsionFree())
    ...
    class U {
      constructor(T, D, j) {
        ...
        if (D == null || !p.isValid(D)) throw new Error("y required");
        if (j == null || !p.isValid(j)) throw new Error("z required");
        Object.freeze(this);
      }
      static fromAffine(T) {
        let { x: D, y: j } = T || {};
        ...
        if (T instanceof U) throw new Error("projective point not allowed");
      ...
      static fromHex(T) {
        let D = U.fromAffine(N((0, i.ensureBytes)("pointHex", T)));
      ...
      multiplyUnsafe(T) {
        ...
        if (T === l) return this;
        let { endo: j } = v;
        if (!j) return L.unsafeLadder(this, T);
      ...
      toRawBytes(T = !0) {
        return (
          (0, i.abool)("isCompressed", T), this.assertValidity(), E(U, this, T)
        );
      }
      toHex(T = !0) {
        return (
          (0, i.abool)("isCompressed", T), r.bytesToHex(this.toRawBytes(T))
        );
      }
    }
    ...
    let P = v.nBitLength,
      L = (0, t.wNAF)(U, v.endo ? Math.ceil(P / 2) : P);
    return {
      CURVE: v,
      ProjectivePoint: U,
    ...
    if (m.ORDER % h === d) {
      ...
      L = (D, j) => {
        ...
        let A = m.mul(C, T),
          R = m.mul(m.sqr(C), j),
          w = m.eql(R, D);
        return { isValid: w, value: m.cmov(A, C, w) };
      };
    }
    return L;
  }
  ...
  (no.createCurve = function (e, t) {
    let n = (r) => (0, Gp.weierstrass)(xe(xe({}, e), Ql(r)));
    return Object.freeze(it(xe({}, n(t)), { create: n }));
  });
var Wp = lc,
  Xl = nn,
  Gp = uc;
function Ql(e) {
  return {
    hash: e,
    hmac: (t, ...n) => (0, Wp.hmac)(e, t, (0, Xl.concatBytes)(...n)),
...
(function (e) {
  ...
  function f(_) {
    let C = c,
      ...
      $ = (_ * _ * _) % C,
      K = ($ * $ * _) % C,
      H = ((0, o.pow2)(K, A, C) * K) % C,
      V = ((0, o.pow2)(H, A, C) * K) % C,
      X = ((0, o.pow2)(V, d, C) * $) % C,
      ee = ((0, o.pow2)(X, w, C) * X) % C,
      re = ((0, o.pow2)(ee, y, C) * ee) % C,
      se = ((0, o.pow2)(re, k, C) * re) % C,
      ce = ((0, o.pow2)(se, O, C) * se) % C,
      ie = ((0, o.pow2)(ce, k, C) * re) % C,
      ne = ((0, o.pow2)(ie, A, C) * K) % C,
      ae = ((0, o.pow2)(ne, x, C) * ee) % C,
      ue = ((0, o.pow2)(ae, R, C) * $) % C,
      ye = (0, o.pow2)(ue, d, C);
    if (!g.eql(g.sqr(ye), _)) throw new Error("Cannot find square root");
    return ye;
  }
  let g = (0, o.Field)(c, void 0, void 0, { sqrt: f });
  ...
  function p(_, ...C) {
    let A = v[_];
    if (A === void 0) {
      let R = (0, t.sha256)(Uint8Array.from(_, (w) => w.charCodeAt(0)));
      (A = (0, s.concatBytes)(R, R)), (v[_] = A);
    }
    return (0, t.sha256)((0, s.concatBytes)(A, ...C));
  }
  let S = (_) => _.toRawBytes(!0).slice(1),
    E = (_) => (0, s.numberToBytesBE)(_, 32),
    N = (_) => (0, o.mod)(_, c),
    I = (_) => (0, o.mod)(_, l),
  ...
  function z(_) {
    ...
    return { scalar: A.hasEvenY() ? C : I(-C), bytes: S(A) };
  }
  function G(_) {
    (0, s.aInRange)("x", _, u, c);
    let C = N(_ * _),
      A = f(N(C * _ + BigInt(7)));
    A % d !== m && (A = N(-A));
    let R = new F(_, A, u);
  ...
  function M(_, C, A = (0, n.randomBytes)(32)) {
    let R = (0, s.ensureBytes)("message", _),
      { bytes: w, scalar: y } = z(C),
      x = (0, s.ensureBytes)("auxRand", A, 32),
      k = E(y ^ U(p("BIP0340/aux", x))),
      O = p("BIP0340/nonce", k, w, R),
      $ = I(U(O));
    if ($ === m) throw new Error("sign failed: k is zero");
    let { bytes: K, scalar: H } = z($),
      V = P(K, w, R),
      X = new Uint8Array(64);
    if ((X.set(K, 0), X.set(E(I(H + V * y)), 32), !T(X, R, w)))
      throw new Error("sign: Invalid signature produced");
    return X;
  }
  function T(_, C, A) {
    let R = (0, s.ensureBytes)("signature", _, 64),
      w = (0, s.ensureBytes)("message", C),
      y = (0, s.ensureBytes)("publicKey", A, 32);
    try {
      let x = G(U(y)),
        k = U(R.subarray(0, 32));
      if (!(0, s.inRange)(k, u, c)) return !1;
      let O = U(R.subarray(32, 64));
      if (!(0, s.inRange)(O, u, l)) return !1;
      let $ = P(E(k), S(x), w),
        K = q(x, O, I(-$));
...
(function (e) {
  ...
  (function (e) {
    ...
    (e.getValidSecret = function () {
      var u;
      do u = (0, t.randomBytes)(o.SECRET_KEY_LENGTH);
      while (!(0, e.isValidPrivateKey)(u));
      return u;
    }),
...
function Uh(e, t, n) {
  return (
    ...
    (0, Kh.hmac)(e, (0, eu.toBytes)(n), (0, eu.toBytes)(t))
  );
}
var Ks = new Uint8Array([0]),
  tu = new Uint8Array();
function Hh(e, t, n, r = 32) {
  if (((0, wa.hash)(e), (0, wa.number)(r), r > 255 * e.outputLen))
  ...
  for (let l = 0; l < i; l++)
    (Ks[0] = l + 1),
      ...
      s._cloneInto(a);
  return s.destroy(), a.destroy(), c.fill(0), Ks.fill(0), o.slice(0, r);
}
  ...
  (function (e) {
    ...
    (e.deriveKey = function (i, o, s) {
      ...
      (e.getSharedKey = function () {
        ...
        return (0, e.deriveKey)(t.concatBytes.apply(void 0, i));
      });
  })(jh);
var nu = {},
  fr = {},
...
var Mo = class {
    constructor(t, n) {
      ...
      let r = (0, Ze.createView)(t),
        ...
        c = [];
      for (let p = 0; p < 128; p++)
        c.push({ s0: bt(i), s1: bt(o), s2: bt(s), s3: bt(a) }),
          ({
            s0: i,
            s1: o,
            s2: s,
      ...
      for (let p = 0; p < g; p++)
        for (let S = 0; S < m; S++) {
          let E = 0,
            ...
            F = 0;
          for (let q = 0; q < f; q++) {
            if (!((S >>> (f - q - 1)) & 1)) continue;
            let { s0: z, s1: G, s2: U, s3: P } = c[f * p + q];
            (E ^= z), (N ^= G), (I ^= U), (F ^= P);
          }
          v.push({ s0: E, s1: N, s2: I, s3: F });
        }
      this.t = v;
    }
    _updateBlock(t, n, r, i) {
      (t ^= this.s0), (n ^= this.s1), (r ^= this.s2), (i ^= this.s3);
    ...
    update(t) {
      (t = (0, Ze.toBytes)(t)), (0, Bn.exists)(this);
      let n = (0, Ze.u32)(t),
    ...
    digestInto(t) {
      (0, Bn.exists)(this), (0, Bn.output)(t, this), (this.finished = !0);
      let { s0: n, s1: r, s2: i, s3: o } = this,
        s = (0, Ze.u32)(t);
      return (s[0] = n), (s[1] = r), (s[2] = i), (s[3] = o), t;
    }
    digest() {
  ...
  Ea = class extends Mo {
    constructor(t, n) {
      t = (0, Ze.toBytes)(t);
      let r = Fh((0, Ze.copyBytes)(t));
      super(r, n), (0, Ze.clean)(r);
    }
    update(t) {
      (t = (0, Ze.toBytes)(t)), (0, Bn.exists)(this);
      let n = (0, Ze.u32)(t),
    ...
    digestInto(t) {
      ...
      let { s0: n, s1: r, s2: i, s3: o } = this,
        s = (0, Ze.u32)(t);
      return (s[0] = n), (s[1] = r), (s[2] = i), (s[3] = o), t.reverse();
    }
  };
function ru(e) {
  let t = (r, i) =>
      e(i, r.length)
        .update((0, Ze.toBytes)(r))
        .digest(),
...
function cr(e, t) {
  let n = 0;
  for (; t > 0; t >>= 1) (n ^= e & -(1 & t)), (e = hc(e));
  return n;
}
var Ca = (() => {
    let e = new Uint8Array(256);
    for (let n = 0, r = 1; n < 256; n++, r ^= hc(r)) e[n] = r;
...
function zh(e, t) {
  ...
  for (let l = 0; l < 256; l++)
    for (let u = 0; u < 256; u++) {
      let d = 256 * l + u;
      (s[d] = n[l] ^ r[u]), (a[d] = i[l] ^ o[u]), (c[d] = (e[l] << 8) | e[u]);
    }
...
var fc = zh(Ca, (e) => (cr(e, 3) << 24) | (e << 16) | (e << 8) | cr(e, 2)),
  qh = zh(
    Zp,
    (e) => (cr(e, 11) << 24) | (cr(e, 13) << 16) | (cr(e, 9) << 8) | cr(e, 14)
  ),
  Xp = (() => {
    let e = new Uint8Array(16);
    for (let t = 0, n = 1; t < 16; t++, n = hc(n)) e[t] = n;
    return e;
  })();
function xt(e) {
  (0, Ee.bytes)(e);
  ...
  let { sbox2: n } = fc,
    r = [];
  (0, Q.isAligned32)(e) || r.push((e = (0, Q.copyBytes)(e)));
  let i = (0, Q.u32)(e),
    o = i.length,
    s = (c) => Nt(n, c, c, c, c),
...
function oi(e) {
  ...
  for (let l = 0; l < r; l += 4)
    for (let u = 0; u < 4; u++) n[l + u] = t[r - l - 4 + u];
  (0, Q.clean)(t);
  for (let l = 4; l < r - 4; l++) {
    let u = n[l],
      d = Nt(i, u, u, u, u);
...
function pr(e, t) {
  ...
  if (((0, Ee.bytes)(t), t.length < e))
    throw new Error(
      `aes: wrong destination length, expected at least ${e}, got: ${t.length}`
    );
  if (!(0, Q.isAligned32)(t)) throw new Error("unaligned dst");
  return t;
}
function Vh(e, t, n, r) {
  (0, Ee.bytes)(t, rt), (0, Ee.bytes)(n);
  let i = n.length;
  r = pr(i, r);
  let o = t,
    s = (0, Q.u32)(o),
  ...
  if (f < i) {
    let g = new Uint32Array([a, c, l, u]),
      m = (0, Q.u8)(g);
    for (let v = f, p = 0; v < i; v++, p++) r[v] = n[v] ^ m[p];
    (0, Q.clean)(g);
  }
  return r;
}
function lr(e, t, n, r, i) {
  (0, Ee.bytes)(n, rt), (0, Ee.bytes)(r), (i = pr(r.length, i));
  let o = n,
    s = (0, Q.u32)(o),
    a = (0, Q.createView)(o),
    c = (0, Q.u32)(r),
  ...
  if (p < d) {
    let S = new Uint32Array([f, g, m, v]),
      E = (0, Q.u8)(S);
    for (let N = p, I = 0; N < d; N++, I++) i[N] = r[N] ^ E[I];
    (0, Q.clean)(S);
  }
  return i;
}
function iu(e) {
  if (((0, Ee.bytes)(e), e.length % rt != 0))
    throw new Error(
...
function ou(e, t, n) {
  ...
  (0, Q.isAligned32)(e) || (e = (0, Q.copyBytes)(e));
  let o = (0, Q.u32)(e);
  if (t) {
    let a = rt - i;
    a || (a = rt), (r += a);
...
function su(e, t) {
  ...
  for (let o = 0; o < r; o++)
    if (e[n - o - 1] !== r) throw new Error("aes/pcks5: wrong padding");
  return i;
}
function au(e) {
...
function Wh(e, t, n, r, i) {
  ...
  let a = new Uint8Array(16),
    c = (0, Q.createView)(a);
  i && (0, Q.setBigUint64)(c, 0, BigInt(8 * o), t),
    (0, Q.setBigUint64)(c, 8, BigInt(8 * r.length), t),
    s.update(a);
  let l = s.digest();
  return (0, Q.clean)(a), l;
}
(Re.ctr = (0, Q.wrapCipher)(
  { blockSize: 16, nonceLength: 16 },
  function (e, t) {
    function n(r, i) {
      if (
        ((0, Ee.bytes)(r),
        i !== void 0 && ((0, Ee.bytes)(i), !(0, Q.isAligned32)(i)))
      )
        throw new Error("unaligned destination");
      let o = xt(e),
        s = (0, Q.copyBytes)(t),
        a = [o, s];
      (0, Q.isAligned32)(r) || a.push((r = (0, Q.copyBytes)(r)));
      let c = Vh(o, s, r, i);
      return (0, Q.clean)(...a), c;
    }
    return (
      (0, Ee.bytes)(e),
      (0, Ee.bytes)(t, rt),
  ...
  (Re.ecb = (0, Q.wrapCipher)({ blockSize: 16 }, function (e, t = {}) {
    (0, Ee.bytes)(e);
      ...
      decrypt(r, i) {
        ...
        for (let u = 0; u + 4 <= c.length; ) {
          let {
            ...
            s2: f,
            s3: g,
          } = si(o, c[u + 0], c[u + 1], c[u + 2], c[u + 3]);
          (l[u++] = d), (l[u++] = h), (l[u++] = f), (l[u++] = g);
        }
        return (0, Q.clean)(...a), su(s, n);
      },
    };
  })),
  (Re.cbc = (0, Q.wrapCipher)(
    { blockSize: 16, nonceLength: 16 },
    function (e, t, n = {}) {
      (0, Ee.bytes)(e), (0, Ee.bytes)(t, 16);
      ...
      return {
        encrypt(i, o) {
          let s = xt(e),
            ...
            u = t,
            d = [s];
          (0, Q.isAligned32)(u) || d.push((u = (0, Q.copyBytes)(u)));
          let h = (0, Q.u32)(u),
            f = h[0],
            g = h[1],
            m = h[2],
        ...
        decrypt(i, o) {
          ...
          let s = oi(e),
            a = t,
            c = [s];
          (0, Q.isAligned32)(a) || c.push((a = (0, Q.copyBytes)(a)));
          let l = (0, Q.u32)(a),
            u = pr(i.length, o);
          (0, Q.isAligned32)(i) || c.push((i = (0, Q.copyBytes)(i)));
          let d = (0, Q.u32)(i),
            h = (0, Q.u32)(u),
            f = l[0],
            g = l[1],
          ...
          for (let p = 0; p + 4 <= d.length; ) {
            let S = f,
              ...
              N = m,
              I = v;
            (f = d[p + 0]), (g = d[p + 1]), (m = d[p + 2]), (v = d[p + 3]);
          ...
          return (0, Q.clean)(...c), su(u, r);
        },
      };
    }
  )),
  (Re.cfb = (0, Q.wrapCipher)(
    { blockSize: 16, nonceLength: 16 },
    function (e, t) {
      function n(r, i, o) {
        (0, Ee.bytes)(r);
        ...
        let a = xt(e),
          c = t,
          l = [a];
        (0, Q.isAligned32)(c) || l.push((c = (0, Q.copyBytes)(c))),
          (0, Q.isAligned32)(r) || l.push((r = (0, Q.copyBytes)(r)));
        let u = (0, Q.u32)(r),
          d = (0, Q.u32)(o),
          h = i ? d : u,
          f = (0, Q.u32)(c),
        ...
        if (S < s) {
          ...
          let E = (0, Q.u8)(new Uint32Array([g, m, v, p]));
          for (let N = S, I = 0; N < s; N++, I++) o[N] = r[N] ^ E[I];
          (0, Q.clean)(E);
        }
        return (0, Q.clean)(...l), o;
      }
      return (
        (0, Ee.bytes)(e),
        (0, Ee.bytes)(t, 16),
  ...
  (Re.gcm = (0, Q.wrapCipher)(
    { blockSize: 16, nonceLength: 12, tagLength: 16 },
    function (e, t, n) {
      if (
        ((0, Ee.bytes)(e),
        (0, Ee.bytes)(t),
        n !== void 0 && (0, Ee.bytes)(n),
        t.length < 8)
      )
      ...
      function o() {
        let s = xt(e),
          a = Hi.slice(),
          c = Hi.slice();
        if ((lr(s, !1, c, c, a), t.length === 12)) c.set(t);
        else {
          let l = Hi.slice(),
            u = (0, Q.createView)(l);
          (0, Q.setBigUint64)(u, 8, BigInt(8 * t.length), !1);
          let d = _a.ghash.create(a).update(t).update(l);
          d.digestInto(c), d.destroy();
        }
        return { xk: s, authKey: a, counter: c, tagMask: lr(s, !1, c, Hi) };
      }
      return {
        encrypt(s) {
          (0, Ee.bytes)(s);
          let { xk: a, authKey: c, counter: l, tagMask: u } = o(),
            ...
            h = [a, c, l, u];
          (0, Q.isAligned32)(s) || h.push((s = (0, Q.copyBytes)(s))),
            lr(a, !1, l, s, d);
          let f = i(c, u, d.subarray(0, d.length - r));
          return h.push(f), d.set(f, s.length), (0, Q.clean)(...h), d;
        },
        decrypt(s) {
          if (((0, Ee.bytes)(s), s.length < r))
            throw new Error("aes/gcm: ciphertext less than tagLen (16)");
          let { xk: a, authKey: c, counter: l, tagMask: u } = o(),
            d = [a, c, u, l];
          (0, Q.isAligned32)(s) || d.push((s = (0, Q.copyBytes)(s)));
          let h = s.subarray(0, -16),
            f = s.subarray(-16),
            g = i(c, u, h);
          if ((d.push(g), !(0, Q.equalBytes)(g, f)))
            throw new Error("aes/gcm: invalid ghash tag");
          let m = lr(a, !1, l, h);
          return (0, Q.clean)(...d), m;
        },
      };
    }
  ));
...
function Gh(e) {
  return (
    e != null &&
    typeof e == "object" &&
    (e instanceof Uint32Array || e.constructor.name === "Uint32Array")
  );
}
function Yh(e, t) {
  if (((0, Ee.bytes)(t, 16), !Gh(e)))
  ...
  function (e, t, n) {
    ...
    function a() {
      let u = xt(e),
        ...
        f = [u, d],
        g = t;
      (0, Q.isAligned32)(g) || f.push((g = (0, Q.copyBytes)(g)));
      let m = (0, Q.u32)(g),
        v = 0,
        p = m[0],
        S = m[1],
      ...
      let I = { authKey: h, encKey: xt(d) };
      return (0, Q.clean)(...f), I;
    }
    function c(u, d, h) {
      let f = Wh(_a.polyval, !0, d, h, n);
      for (let E = 0; E < 12; E++) f[E] ^= t[E];
      f[15] &= 127;
      let g = (0, Q.u32)(f),
        m = g[0],
        v = g[1],
        ...
        S = g[3];
      return (
        ({ s0: m, s1: v, s2: p, s3: S } = Je(u, m, v, p, S)),
        (g[0] = m),
        (g[1] = v),
        (g[2] = p),
        (g[3] = S),
    ...
    function l(u, d, h) {
      let f = (0, Q.copyBytes)(d);
      f[15] |= 128;
      let g = lr(u, !0, f, h);
      return (0, Q.clean)(f), g;
    }
    return (
      (0, Ee.bytes)(e, 16, 24, 32),
      (0, Ee.bytes)(t),
      o(t.length),
      n !== void 0 && ((0, Ee.bytes)(n), r(n.length)),
      {
        encrypt(u) {
          (0, Ee.bytes)(u), i(u.length);
          let { encKey: d, authKey: h } = a(),
            f = c(d, h, u),
            g = [d, h, f];
          (0, Q.isAligned32)(u) || g.push((u = (0, Q.copyBytes)(u)));
          let m = new Uint8Array(u.length + 16);
          return m.set(f, u.length), m.set(l(d, f, u)), (0, Q.clean)(...g), m;
        },
        decrypt(u) {
          (0, Ee.bytes)(u), s(u.length);
          let d = u.subarray(-16),
          ...
          let m = l(h, d, u.subarray(0, -16)),
            v = c(h, f, m);
          if ((g.push(v), !(0, Q.equalBytes)(d, v)))
            throw ((0, Q.clean)(...g), new Error("invalid polyval tag"));
          return (0, Q.clean)(...g), m;
        },
      }
    );
  }
...
Re.aeskw = (0, Q.wrapCipher)({ blockSize: 8 }, (e) => ({
  encrypt(t) {
    if (((0, Ee.bytes)(t), !t.length || t.length % 8 != 0))
      throw new Error("invalid plaintext length");
    if (t.length === 8)
      throw new Error("8-byte keys not allowed in AESKW, use AESKWP instead");
    let n = (0, Q.concatBytes)(cu, t);
    return Ro.encrypt(e, n), n;
  },
  decrypt(t) {
    if (((0, Ee.bytes)(t), t.length % 8 != 0 || t.length < 24))
      throw new Error("invalid ciphertext length");
    let n = (0, Q.copyBytes)(t);
    if ((Ro.decrypt(e, n), !(0, Q.equalBytes)(n.subarray(0, 8), cu)))
      throw new Error("integrity check failed");
    return n.subarray(0, 8).fill(0), n.subarray(8);
  },
}));
var lu = 2790873510;
(Re.aeskwp = (0, Q.wrapCipher)({ blockSize: 8 }, (e) => ({
  encrypt(t) {
    if (((0, Ee.bytes)(t), !t.length))
      throw new Error("invalid plaintext length");
    let n = 8 * Math.ceil(t.length / 8),
      r = new Uint8Array(8 + n);
    r.set(t, 8);
    let i = (0, Q.u32)(r);
    return (i[0] = lu), (i[1] = To(t.length)), Ro.encrypt(e, r), r;
  },
  decrypt(t) {
    if (((0, Ee.bytes)(t), t.length < 16))
      throw new Error("invalid ciphertext length");
    let n = (0, Q.copyBytes)(t),
      r = (0, Q.u32)(n);
    Ro.decrypt(e, n);
    ...
    if (r[0] !== lu || n.length - 8 !== o)
      throw new Error("integrity check failed");
    for (let s = i; s < o; s++)
      if (n[8 + s] !== 0) throw new Error("integrity check failed");
...
Object.defineProperty(ur, "__esModule", { value: !0 }),
  ...
  (ur.createCipher = function (e, t) {
    ...
    return (
      ...
      (0, qt.bool)(n),
      (a, c, l, u, d = 0) => {
        (0, qt.bytes)(a), (0, qt.bytes)(c), (0, qt.bytes)(l);
        let h = l.length;
        if (
          (u === void 0 && (u = new Uint8Array(h)),
          (0, qt.bytes)(u),
          (0, qt.number)(d),
          d < 0 || d >= uu)
        )
        ...
        if (u.length < h)
          throw new Error(
            `arx: output (${u.length}) is shorter than data (${h})`
          );
        let f = [],
          g,
          m,
          v = a.length;
        if (v === 32) f.push((g = (0, yt.copyBytes)(a))), (m = ef);
        else {
          if (v !== 16 || !n)
            throw new Error(`arx: invalid 32-byte key, got length=${v}`);
          (g = new Uint8Array(32)), g.set(a), g.set(a, 16), (m = t1), f.push(g);
        }
        Hs(c) || f.push((c = (0, yt.copyBytes)(c)));
        let p = (0, yt.u32)(g);
        if (r) {
          if (c.length !== 24)
            throw new Error("arx: extended nonce must be 24 bytes");
          r(m, p, (0, yt.u32)(c.subarray(0, 16)), p), (c = c.subarray(16));
        }
        let S = 16 - i;
        if (S !== c.length)
        ...
        if (S !== 12) {
          ...
          N.set(c, o ? 0 : 12 - c.length), (c = N), f.push(c);
        }
        let E = (0, yt.u32)(c);
        return (
          (function (N, I, F, q, z, G, U, P) {
            let L = z.length,
              M = new Uint8Array(zi),
              T = (0, yt.u32)(M),
              D = Hs(z) && Hs(G),
              ...
              b = D ? (0, yt.u32)(G) : du;
            for (let _ = 0; _ < L; U++) {
              if ((N(I, F, q, T, U, P), U >= uu))
                throw new Error("arx: counter overflow");
              let C = Math.min(zi, L - _);
              if (D && C === zi) {
                let A = _ / 4;
                if (_ % 4 != 0) throw new Error("arx: invalid block position");
  ...
  Sa = class {
    constructor(t) {
      ...
      (this.r[0] = 8191 & n),
        ...
        (this.r[9] = (l >>> 5) & 127);
      for (let u = 0; u < 8; u++) this.pad[u] = je(t, 16 + 2 * u);
    }
    process(t, n, r = !1) {
      let i = r ? 0 : 2048,
        { h: o, r: s } = this,
    ...
    finalize() {
      ...
      (t[0] += 5 * i),
        ...
        (r[0] &= 8191);
      for (let a = 1; a < 10; a++)
        (r[a] = t[a] + i), (i = r[a] >>> 13), (r[a] &= 8191);
      r[9] -= 8192;
      let o = (1 ^ i) - 1;
      for (let a = 0; a < 10; a++) r[a] &= o;
      o = ~o;
      for (let a = 0; a < 10; a++) t[a] = (t[a] & o) | r[a];
      ...
      t[0] = 65535 & s;
      for (let a = 1; a < 8; a++)
        (s = (((t[a] + n[a]) | 0) + (s >>> 16)) | 0), (t[a] = 65535 & s);
      (0, Hr.clean)(r);
    }
    update(t) {
      (0, qi.exists)(this);
      let { buffer: n, blockLen: r } = this,
        i = (t = (0, Hr.toBytes)(t)).length;
      for (let o = 0; o < i; ) {
        let s = Math.min(r - this.pos, i - o);
        if (s !== r)
        ...
        else for (; r <= i - o; o += r) this.process(t, o);
      }
      return this;
    }
    destroy() {
      (0, Hr.clean)(this.h, this.r, this.buffer, this.pad);
    }
    digestInto(t) {
      (0, qi.exists)(this), (0, qi.output)(t, this), (this.finished = !0);
      ...
      this.finalize();
      let o = 0;
      for (let s = 0; s < 8; s++) (t[o++] = r[s] >>> 0), (t[o++] = r[s] >>> 8);
      return t;
    }
    digest() {
  ...
  (function (e) {
    ...
    function u(d, h, f, g, m) {
      ...
      let S = new Uint8Array(16),
        E = (0, i.createView)(S);
      (0, i.setBigUint64)(E, 0, BigInt(m ? m.length : 0), !0),
        (0, i.setBigUint64)(E, 8, BigInt(g.length), !0),
        p.update(S);
      let N = p.digest();
      return (0, i.clean)(v, S), N;
    }
    (e._poly1305_aead = (d) => (h, f, g) => (
      (0, n.bytes)(h, 32),
      (0, n.bytes)(f),
      {
        encrypt(v, p) {
          let S = v.length,
            E = S + 16;
          p ? (0, n.bytes)(p, E) : (p = new Uint8Array(E)), d(h, f, v, p, 1);
          let N = u(d, h, f, p.subarray(0, -16), g);
          return p.set(N, S), (0, i.clean)(N), p;
        },
        decrypt(v, p) {
          let S = v.length,
            E = S - 16;
          ...
          p ? (0, n.bytes)(p, E) : (p = new Uint8Array(E));
          let N = v.subarray(0, -16),
            I = v.subarray(-16),
            F = u(d, h, f, N, g);
          if (!(0, i.equalBytes)(I, F)) throw new Error("invalid tag");
          return d(h, f, N, p, 1), (0, i.clean)(F), p;
        },
      }
    )),
      ...
      (e.xchacha20poly1305 = (0, i.wrapCipher)(
...
(Oo.xchacha20 = function (e, t, n) {
  return (0, r1.xchacha20poly1305)(e, t, n);
}),
  (function (e) {
    Object.defineProperty(e, "__esModule", { value: !0 }),
    ...
    function c(u, d, h, f, g, m) {
      var v = (0, n.randomBytes)(f),
        p = u(d, v, m).encrypt(h);
      if (g === 0) return (0, t.concatBytes)(v, p);
      var S = p.length - g,
        E = p.subarray(0, S),
        N = p.subarray(S);
      return (0, t.concatBytes)(v, N, E);
    }
    function l(u, d, h, f, g, m) {
      var v = h.subarray(0, f),
        p = u(d, Uint8Array.from(v), m),
        S = h.subarray(f);
      if (g === 0) return p.decrypt(S);
      var E = S.subarray(0, g),
        N = S.subarray(g);
      return p.decrypt((0, t.concatBytes)(N, E));
    }
  ...
  $r(nu, tr);
var ai = {};
Object.defineProperty(ai, "__esModule", { value: !0 }), (ai.PublicKey = void 0);
var fu = ht,
  Vi = es,
  i1 = (function () {
    function e(t) {
      this.data = (0, Vi.convertPublicKeyFormat)(t, !0);
    }
    return (
      (e.fromHex = function (t) {
        return new e((0, Vi.hexToPublicKey)(t));
      }),
      Object.defineProperty(e.prototype, "uncompressed", {
        get: function () {
          return Z.from((0, Vi.convertPublicKeyFormat)(this.data, !1));
        },
        enumerable: !1,
        configurable: !0,
      }),
      ...
      (e.prototype.toHex = function (t) {
        return (
          t === void 0 && (t = !0),
          (0, fu.bytesToHex)(t ? this.data : this.uncompressed)
        );
      }),
      (e.prototype.decapsulate = function (t, n) {
        ...
        var r = n ? this.data : this.uncompressed,
          i = t.multiply(this, n);
        return (0, Vi.getSharedKey)(r, i);
      }),
      (e.prototype.equals = function (t) {
        return (0, fu.equalBytes)(this.data, t.data);
      }),
      e
    );
  })();
...
var pu = ht,
  ...
  s1 = (function () {
    function e(t) {
      if (t === void 0) this.data = (0, nr.getValidSecret)();
      else {
        if (!(0, nr.isValidPrivateKey)(t))
          throw new Error("Invalid private key");
        this.data = t;
      }
      this.publicKey = new o1.PublicKey((0, nr.getPublicKey)(this.data));
    }
    return (
      (e.fromHex = function (t) {
        return new e((0, nr.decodeHex)(t));
      }),
      ...
      (e.prototype.toHex = function () {
        return (0, pu.bytesToHex)(this.data);
      }),
      (e.prototype.encapsulate = function (t, n) {
        n === void 0 && (n = !1);
        var r = n ? this.publicKey.compressed : this.publicKey.uncompressed,
          i = this.multiply(t, n);
        return (0, nr.getSharedKey)(r, i);
      }),
      (e.prototype.multiply = function (t, n) {
        return (
          n === void 0 && (n = !1),
          (0, nr.getSharedPoint)(this.data, t.compressed, n)
        );
      }),
      (e.prototype.equals = function (t) {
        return (0, pu.equalBytes)(this.data, t.data);
      }),
      e
    );
  })();
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
      ...
      (e.encrypt = function (a, c) {
        var l = new r.PrivateKey(),
          ...
          h = (0, n.isEphemeralKeyCompressed)()
            ? l.publicKey.compressed
            : l.publicKey.uncompressed,
          f = (0, i.symEncrypt)(d, c);
        return Z.from((0, t.concatBytes)(h, f));
      }),
      (e.decrypt = function (a, c) {
        var l =
          ...
          h = c.subarray(u),
          f = d.decapsulate(l, (0, n.isHkdfKeyCompressed)());
        return Z.from((0, i.symDecrypt)(f, h));
      });
    var t = ht,
      n = ni,
      r = As,
...
var nf = (0, We.default)("KeyExchange:Layer"),
  rf = (0, We.default)("SocketService:Layer"),
  of = (0, We.default)("Ecies:Layer"),
  sf = (0, We.default)("RemoteCommunication:Layer");
(nf.color = "##95c44e"),
  (rf.color = "#f638d7"),
  (of.color = "#465b9c"),
  (sf.color = "#47a2be");
var W = {
        ...
        (function (n) {
          return J(this, void 0, void 0, function* () {
            ...
            if ((delete i.params, n.params))
              for (let [s, a] of Object.entries(n.params)) i[s] = a;
            let o = JSON.stringify(i);
            W.RemoteCommunication(
              `[sendBufferedEvents] Sending ${Wi.length} analytics events to ${r}`
            );
            try {
              let s = yield (0, nc.default)(r, {
                  method: "POST",
                  headers: {
  ...
  Wr = class {
    constructor(t) {
      (this.enabled = !0),
        ...
        (this.ecies = t?.privateKey
          ? ir.PrivateKey.fromHex(t.privateKey)
          : new ir.PrivateKey()),
        W.Ecies(
    ...
    encrypt(t, n) {
      ...
      if (this.enabled)
        try {
          ...
          throw (
            (W.Ecies("[ECIES: encrypt()] error encrypt:", i),
    ...
    decrypt(t) {
      ...
      if (this.enabled)
        try {
          ...
          throw (
            (W.Ecies("[ECIES: decrypt()] error decrypt", r),
  ...
  vr = "https://metamask-sdk.api.cx.metamask.io/",
  a1 = ["websocket"],
  br = 6048e5,
  c1 = 3e3,
  l1 = {
...
var ka = class extends _r.EventEmitter2 {
  constructor({
    ...
    super(),
      ...
      (this.myECIES = new Wr(
        Object.assign(Object.assign({}, i), { debug: o?.eciesLayer })
      )),
  ...
  onKeyExchangeMessage(t) {
    ...
    this.keysExchanged &&
      ...
      r.type === Se.KEY_HANDSHAKE_SYN
        ? (this.checkStep([Se.KEY_HANDSHAKE_NONE, Se.KEY_HANDSHAKE_ACK]),
          W.KeyExchange(
        ...
        : r.type === Se.KEY_HANDSHAKE_SYNACK
        ? (this.checkStep([
            Se.KEY_HANDSHAKE_SYNACK,
            Se.KEY_HANDSHAKE_ACK,
            Se.KEY_HANDSHAKE_NONE,
          ]),
          W.KeyExchange(
          ...
          r.pubkey && this.setOtherPublicKey(r.pubkey),
          this.communicationLayer
            .sendMessage({ type: Se.KEY_HANDSHAKE_ACK })
            .catch((i) => {
              W.KeyExchange(
  ...
  resetKeys(t) {
    this.clean(), (this.myECIES = new Wr(t));
  }
  clean() {
    W.KeyExchange(
  ...
  start({ isOriginator: t, force: n }) {
    let { relayPersistence: r, protocolVersion: i } =
    ...
    r
      ...
      : (W.KeyExchange(
          `[KeyExchange: start()] context=${this.context} protocolVersion=${i} isOriginator=${t} step=${this.step} force=${n} relayPersistence=${r} keysExchanged=${this.keysExchanged}`
        ),
        t
          ? !(
              this.keysExchanged ||
              (this.step !== Se.KEY_HANDSHAKE_NONE &&
                this.step !== Se.KEY_HANDSHAKE_SYNACK)
            ) || n
            ? (W.KeyExchange(
          ...
          : (this.communicationLayer
              .sendMessage({ type: Se.KEY_HANDSHAKE_START })
              .catch((s) => {
                W.KeyExchange(
  ...
  setStep(t) {
    (this.step = t), this.emit(te.KEY_INFO, t);
  }
  checkStep(t) {
  ...
  setRelayPersistence({ localKey: t, otherKey: n }) {
    (this.otherPublicKey = n),
      (this.myECIES = new Wr({ privateKey: t, debug: this.debug })),
      (this.keysExchanged = !0);
  }
  setKeysExchanged(t) {
...
var ro = (e, t, n) =>
    J(void 0, void 0, void 0, function* () {
      ...
      if (t === "error_terminated")
        return (
          W.SocketService(`handleJoinChannelResults: Channel ${d} terminated`),
          void e.emit(te.TERMINATE)
        );
      if (!n)
        return void W.SocketService(
          `handleJoinChannelResults: No result for channel ${d}`
        );
      let { persistence: f, walletKey: g, rejected: m } = n;
      if (
        (W.SocketService(
          `handleJoinChannelResults: Channel ${d} persistence=${f} walletKey=${g} rejected=${m}`
        ),
        m)
      )
        return (
          W.SocketService(`handleJoinChannelResults: Channel ${d} rejected`),
          yield e.remote.disconnect({ terminate: !0 }),
          e.remote.emit(te.REJECTED, { channelId: d }),
          void e.remote.emitServiceStatusEvent()
        );
      if (
        g &&
        !(!((r = l.state.channelConfig) === null || r === void 0) && r.otherKey)
      ) {
        e.getKeyExchange().setOtherPublicKey(g),
          (i = e.state.keyExchange) === null ||
            i === void 0 ||
        ...
        let { communicationLayer: v, storageManager: p } = l.state,
          S = Object.assign(Object.assign({}, l.state.channelConfig), {
            channelId:
              (o = l.state.channelId) !== null && o !== void 0 ? o : "",
            validUntil: Date.now() + br,
            localKey: v?.getKeyInfo().ecies.private,
            otherKey: g,
          });
        e.sendMessage({ type: Se.KEY_HANDSHAKE_ACK }).catch((E) => {}),
          (s = e.state.socket) === null ||
            s === void 0 ||
            s.emit(Te.PING, {
              id: d,
      ...
      f &&
        ...
        tn(
          Object.assign(
            Object.assign(
              { id: d ?? "", event: h ? Le.CONNECTED : Le.CONNECTED_MOBILE },
            ...
            ),
            {
              ...
              walletVersion:
                (c = e.remote.state.walletInfo) === null || c === void 0
                  ? void 0
                  : c.version,
            }
          ),
  ...
  mu = (e, t, ...n) =>
    J(void 0, [e, t, ...n], void 0, function* (r, i, o = 200) {
      let s,
        a = Date.now(),
        c = !1;
      for (; !c; ) {
        if (((c = Date.now() - a > 3e5), (s = i[r]), s.elapsedTime !== void 0))
          return s;
        yield mr(o);
      }
    ...
    J(void 0, void 0, void 0, function* () {
      ...
      try {
        for (; 3 > t.reconnectionAttempts; ) {
          ...
          (t.resumed = !0), n.connect(), e.emit(te.SOCKET_RECONNECT);
          try {
            if (
        ...
        return W.SocketService("Failed to reconnect after 3 attempts"), !1;
      } finally {
...
function cf(e, t) {
  return J(this, void 0, void 0, function* () {
    ...
    return (
      ...
      new Promise((o, s) => {
        var a;
        (a = e.state.socket) === null ||
          a === void 0 ||
          a.emit(te.MESSAGE, i, (c, l) => {
            var u;
            c &&
              (W.SocketService(
      ...
      handler: function (e, t) {
        return (n) =>
          J(this, void 0, void 0, function* () {
            ...
            let g =
              (i =
                (r = e.remote.state.channelConfig) === null || r === void 0
                  ? void 0
            ...
            if (
              (W.SocketService(
                `[SocketService: handleClientsConnected()] context=${
                  e.state.context
                } on 'clients_connected-${t}' relayPersistence=${g} resumed=${
                  e.state.resumed
                }  clientsPaused=${e.state.clientsPaused} keysExchanged=${
                  (o = e.state.keyExchange) === null || o === void 0
                    ? void 0
                    : o.areKeysExchanged()
              ...
              e.emit(te.CLIENTS_CONNECTED, {
                isOriginator: e.state.isOriginator,
                keysExchanged:
                  (s = e.state.keyExchange) === null || s === void 0
                    ? void 0
                    : s.areKeysExchanged(),
                context: e.state.context,
              }),
              ...
              e.state.isOriginator ||
                (W.SocketService(
                  `[SocketService: handleClientsConnected()] context=${
                    ...
                    (a = e.state.keyExchange) === null || a === void 0
                      ? void 0
                      : a.areKeysExchanged()
                  } -- backward compatibility`
                ),
                (c = e.state.keyExchange) === null ||
                  c === void 0 ||
                  c.start({
                    isOriginator:
                      (l = e.state.isOriginator) !== null && l !== void 0 && l,
                  })),
                (e.state.resumed = !1);
              ...
              W.SocketService(
                `[SocketService: handleClientsConnected()] context=${
                  ...
                  (u = e.state.keyExchange) === null || u === void 0
                    ? void 0
                    : u.areKeysExchanged()
                } -- force=${m} -- backward compatibility`
              ),
                W.SocketService(
                  `[SocketService: handleClientsConnected()] context=${
                    e.state.context
                  } on 'clients_connected' / keysExchanged=${
                    (d = e.state.keyExchange) === null || d === void 0
                      ? void 0
                      : d.areKeysExchanged()
                  } -- force=${m} -- backward compatibility`
                ),
                (h = e.state.keyExchange) === null ||
                  h === void 0 ||
                  h.start({
                    isOriginator:
                      (f = e.state.isOriginator) !== null && f !== void 0 && f,
                    force: m,
                  });
            }
          ...
          J(this, void 0, void 0, function* () {
            ...
            e.state.isOriginator && e.remote.state.channelConfig
              ? (n.walletKey &&
                  ...
                  (W.SocketService(`Setting wallet key ${a}`),
                  (e.remote.state.channelConfig.otherKey = a),
                  e.getKeyExchange().setOtherPublicKey(n.walletKey),
                  (r = e.state.keyExchange) === null ||
                    r === void 0 ||
                    r.setKeysExchanged(!0),
                  yield e.remote.sendMessage({ type: Se.KEY_HANDSHAKE_ACK }),
                  yield e.remote.sendMessage({ type: Te.PING }),
                  yield (i = e.remote.state.storageManager) === null ||
                  i === void 0
                    ? void 0
                    : i.persistChannelConfig(e.remote.state.channelConfig)),
                s !== !0 ||
                  e.remote.state.channelConfig.relayPersistence ||
                  (W.SocketService(`Setting relay persistence ${s}`),
                  ...
                  yield (o = e.remote.state.storageManager) === null ||
                  o === void 0
                    ? void 0
                    : o.persistChannelConfig(e.remote.state.channelConfig)))
              : e.state.isOriginator ||
                (n.persistence &&
                  ((e.remote.state.relayPersistence = !0),
                  e.remote.emit(te.CHANNEL_PERSISTENCE)));
    ...
    },
    {
      ...
      handler: function (e, t) {
        return (n) => {
          ...
          let { ackId: I, message: F, error: q } = n,
            z =
              (r = e.remote.state.relayPersistence) !== null &&
              r !== void 0 &&
              r;
          if (
            (W.SocketService(
              `[SocketService handleMessage()]  relayPersistence=${z}  context=${
                e.state.context
      ...
      [SocketService handleMessage()] context=${e.state.context}::on 'message' error=${q}`),
          ...
          if (!G && F?.type === Se.KEY_HANDSHAKE_START)
            return z
              ...
              : (W.SocketService(
                ...
                void (
                  (o = e.state.keyExchange) === null ||
                  o === void 0 ||
                  o.start({
                    isOriginator:
                      (s = e.state.isOriginator) !== null && s !== void 0 && s,
                    force: !0,
                  })
                ));
          if (
            !G &&
            !((a = F?.type) === null || a === void 0) &&
          ...
          if (
            G &&
            !(
              !((c = e.state.keyExchange) === null || c === void 0) &&
              c.areKeysExchanged()
            )
          ) {
            let L = !1;
            ...
            if (!L)
              return (
                e.state.isOriginator
                  ? (d = e.state.keyExchange) === null ||
                    d === void 0 ||
                    d.start({
                      isOriginator:
                        (h = e.state.isOriginator) !== null &&
                        h !== void 0 &&
                        h,
                    })
                  : e
                      .sendMessage({ type: Se.KEY_HANDSHAKE_START })
                      .catch((M) => {}),
                void W.SocketService(
                  `Message ignored because invalid key exchange status. step=${
                    (f = e.state.keyExchange) === null || f === void 0
                      ? void 0
                      : f.getKeyInfo().step
                  }`,
                  (g = e.state.keyExchange) === null || g === void 0
                    ? void 0
                    : g.getKeyInfo(),
                  F
                )
            ...
            W.SocketService(
              ...
              (u = e.state.keyExchange) === null ||
                u === void 0 ||
                u.setKeysExchanged(!0);
          } else if (!G && F?.type) return void e.emit(te.MESSAGE, F);
          if (!G) return void e.emit(te.MESSAGE, F);
          let U =
              (m = e.state.keyExchange) === null || m === void 0
                ? void 0
                : m.decryptMessage(F),
            P = JSON.parse(U ?? "{}");
          if (
            (I &&
              I?.length > 0 &&
              (W.SocketService(
                `[SocketService handleMessage()] context=${e.state.context}::on 'message' ackid=${I} channelId=${t}`
              ),
              (v = e.state.socket) === null ||
                v === void 0 ||
                v.emit(te.MESSAGE_ACK, {
                  ackId: I,
                  channelId: t,
                  clientType: e.state.isOriginator ? "dapp" : "wallet",
                })),
            ...
            if (M) {
              ...
              W.SocketService(
                `[SocketService handleMessage()] context=${e.state.context}::on 'message' received answer for id=${L.id} method=${M.method} responseTime=${T}`,
                P
              ),
                e.remote.state.analytics &&
                  lf.includes(M.method.toLowerCase()) &&
                  tn(
                    Object.assign(
                      Object.assign(
                        {
                          id:
                            (p = e.remote.state.channelId) !== null &&
                            p !== void 0
                              ? p
                              : "",
                      ...
                      {
                        walletVersion:
                          (S = e.remote.state.walletInfo) === null ||
                          S === void 0
                            ? void 0
                            : S.version,
                        params: { method: M.method, from: "mobile" },
                      }
                    ),
              ...
              (e.state.rpcMethodTracker[L.id] = D), e.emit(te.RPC_UPDATE, D);
            }
          }
          e.emit(te.MESSAGE, { message: P });
        };
      },
    },
    {
          ...
          J(this, void 0, void 0, function* () {
            ...
            e.state.isOriginator && !e.remote.state.ready
              ? (W.SocketService(
                ...
                tn(
                  Object.assign(
                    ...
                    ),
                    {
                      ...
                      commLayerVersion: An.version,
                      walletVersion:
                        (r = e.remote.state.walletInfo) === null || r === void 0
                          ? void 0
                          : r.version,
                    }
                  ),
                ...
                yield e.remote.disconnect({ terminate: !0 }),
                e.remote.emit(te.REJECTED, { channelId: t }),
                e.remote.setConnectionStatus(Ue.DISCONNECTED))
              : W.SocketService(
        ...
        return () => {
          ...
          W.SocketService(
            `[SocketService: handleKeysExchanged()] on 'keys_exchanged' keyschanged=${
              (t = e.state.keyExchange) === null || t === void 0
                ? void 0
                : t.areKeysExchanged()
            }`
          );
          ...
          if (i) {
            ...
            (i.localKey = s.private),
              ...
              (n = e.remote.state.storageManager) === null ||
                n === void 0 ||
                n.persistChannelConfig(i).catch((a) => {});
          }
          e.emit(te.KEYS_EXCHANGED, {
            keysExchanged:
              (r = e.state.keyExchange) === null || r === void 0
                ? void 0
                : r.areKeysExchanged(),
            isOriginator: e.state.isOriginator,
          });
    ...
    n?.on(
      ...
      (i) => (
        ...
        (function (o) {
          return (s) => {
            W.SocketService(
              `[SocketService: handleDisconnect()] on 'disconnect' manualDisconnect=${o.state.manualDisconnect}`,
              s
            ),
              o.state.manualDisconnect ||
                (o.emit(te.SOCKET_DISCONNECTED), xa(o).catch((a) => {}));
          };
        })(e)(i)
      )
    )),
...
var Aa = class extends _r.EventEmitter2 {
    constructor(t) {
      ...
      (this.state.resumed = n),
        ...
        (this.state.hasPlaintext =
          this.state.communicationServerUrl !== vr && a?.plaintext === !0),
        W.SocketService(
    ...
    initSocket() {
      ...
      let { otherPublicKey: n, ecies: r, logging: i } = this.options,
        o = { autoConnect: !1, transports: a1, withCredentials: !0 },
    ...
    resetKeys() {
      return (
        W.SocketService("[SocketService: resetKeys()] Resetting keys."),
        void (
          (t = this.state.keyExchange) === null ||
          t === void 0 ||
          t.resetKeys()
        )
      );
      ...
      return J(this, void 0, void 0, function* () {
        return (function (t) {
          return J(this, void 0, void 0, function* () {
            ...
            if (
              (W.SocketService(
                `[SocketService: createChannel()] context=${t.state.context}`
              ),
              t.state.socket || t.initSocket(),
              (n = t.state.socket) === null || n === void 0
                ? void 0
                : n.connected)
            )
            ...
            let s =
              (i = t.state.keyExchange) === null || i === void 0
                ? void 0
                : i.getKeyInfo();
            return {
              channelId: o,
    ...
    connectToChannel({ channelId: t, withKeyExchange: n = !1, authorized: r }) {
      return (function (i) {
        return J(
          ...
          function* ({ options: o, instance: s }) {
            ...
            if (h && m?.relayPersistence) {
              ...
              v && p && g?.setRelayPersistence({ localKey: v, otherKey: p });
            }
            return (
              Object.assign(u, {
                manualDisconnect: !1,
              ...
              !h &&
                c &&
                (g?.setKeysExchanged(!0),
                Object.assign(d.state, { ready: !0, authorized: !0 })),
              new Promise((v) => {
                var p;
                let S =
                  (p = g?.getKeyInfo()) === null || p === void 0
                    ? void 0
                    : p.ecies.public;
                f?.emit(
                  te.JOIN_CHANNEL,
        ...
        options: { channelId: t, withKeyExchange: n, authorized: r },
        instance: this,
      });
    }
    getKeyInfo() {
          ...
          return J(this, void 0, void 0, function* () {
            ...
            if (
              (W.SocketService(
                `[SocketService: handleSendMessage()] context=${
                  ...
                  (i = n.state.keyExchange) === null || i === void 0
                    ? void 0
                    : i.areKeysExchanged()
                }`,
                r
              ),
              (o = r?.type) === null || o === void 0
                ? void 0
                : o.startsWith("key_handshake"))
            )
              return (
                (function (c, l) {
                  var u;
            ...
            return (
              n.remote.state.analytics &&
                ...
                r.method &&
                lf.includes(r.method.toLowerCase()) &&
                tn(
                  {
                    id:
                      (s = n.remote.state.channelId) !== null && s !== void 0
                        ? s
                        : "",
              ...
              (function (c, l) {
                return J(this, void 0, void 0, function* () {
                  ...
                  if (c.state.isOriginator && d)
                    try {
                      let f = mu(d, c.state.rpcMethodTracker, 200).then(
                          (v) => ({ type: dr.RPC_CHECK, result: v })
                        ),
                        g = J(this, void 0, void 0, function* () {
                          let v = yield ((S) =>
                              J(
                                ...
                                [S],
                                void 0,
                                function* ({ rpcId: E, instance: N }) {
                                  for (
                                    ;
                                    N.state.lastRpcId === E ||
                                    N.state.lastRpcId === void 0;
                          ...
                          return { type: dr.SKIPPED_RPC, result: p };
                        }),
                        m = yield Promise.race([f, g]);
                      if (m.type === dr.RPC_CHECK) {
                        let v = m.result;
                        W.SocketService(
                          `[SocketService:handleRpcReplies()] id=${l.id} ${h} ( ${v.elapsedTime} ms)`,
                          v.result
                        );
                      } else {
    ...
    ping() {
      return (function (t) {
        return J(this, void 0, void 0, function* () {
          var n, r;
          W.SocketService(
            `[SocketService: ping()] context=${t.state.context} originator=${
    ...
    pause() {
      return (function (t) {
        return J(this, void 0, void 0, function* () {
          var n, r;
          W.SocketService(
            `[SocketService: pause()] context=${t.state.context}`
          ),
            (t.state.manualDisconnect = !0),
            !((n = t.state.keyExchange) === null || n === void 0) &&
              n.areKeysExchanged() &&
              (yield t.sendMessage({ type: Te.PAUSE })),
    ...
    isConnected() {
      var t;
      return (t = this.state.socket) === null || t === void 0
        ? void 0
        : t.connected;
    }
    resume() {
      return (function (t) {
        return J(this, void 0, void 0, function* () {
          ...
          if (
            (W.SocketService(
              `[SocketService: resume()] channelId=${o} context=${s} connected=${
                i?.connected
              } manualDisconnect=${n.manualDisconnect} resumed=${
                n.resumed
              } keysExchanged=${a?.areKeysExchanged()}`
            ),
            !o)
          )
            throw (
          ...
          i?.connected
            ? (W.SocketService("[SocketService: resume()] already connected."),
              i.emit(Te.PING, {
                id: o,
              ...
              r.hasRelayPersistence() ||
                a?.areKeysExchanged() ||
                (c
                  ? yield t.sendMessage({ type: Te.READY })
                  : a?.start({ isOriginator: !1 })))
            : (i?.connect(),
              W.SocketService(
                `[SocketService: resume()] after connecting socket --> connected=${i?.connected}`
              ),
              i?.emit(
                te.JOIN_CHANNEL,
                {
    ...
    disconnect(t) {
      return (function (n, r) {
        ...
        W.SocketService(
          ...
          r?.terminate &&
            ((o = (i = n.state).removeFocusListener) === null ||
              o === void 0 ||
              o.call(i),
            (n.state.channelId = r.channelId),
            (s = n.state.socket) === null ||
              s === void 0 ||
  ...
  return () =>
    J(this, void 0, void 0, function* () {
      ...
      yield J(this, void 0, void 0, function* () {
        for (; !i.walletInfo; ) yield mr(500);
      });
      let o = "7.3".localeCompare(
        ((t = i.walletInfo) === null || t === void 0 ? void 0 : t.version) || ""
      );
      if (
        (W.RemoteCommunication(
          `[RemoteCommunication: handleAuthorizedEvent()] HACK 'authorized' version=${
            (n = i.walletInfo) === null || n === void 0 ? void 0 : n.version
          } compareValue=${o}`
        ),
        o !== 1)
      )
        return;
      let s =
        i.platformType === qe.MobileWeb ||
        i.platformType === qe.ReactNative ||
        i.platformType === qe.MetaMaskMobileWebview;
      W.RemoteCommunication(
        `[RemoteCommunication: handleAuthorizedEvent()] HACK 'authorized' platform=${
          i.platformType
        } secure=${s} channel=${i.channelId} walletVersion=${
          (r = i.walletInfo) === null || r === void 0 ? void 0 : r.version
        }`
      ),
        s && ((i.authorized = !0), e.emit(te.AUTHORIZED));
    });
}
function f1(e) {
  return (t) => {
    let { state: n } = e;
    W.RemoteCommunication(
      `[RemoteCommunication: handleChannelCreatedEvent()] context=${n.context} on 'channel_created' channelId=${t}`
    ),
  ...
  return () => {
    ...
    W.RemoteCommunication(
      `[RemoteCommunication: handleClientsConnectedEvent()] on 'clients_connected' channel=${
        ...
        (r =
          (n = s.communicationLayer) === null || n === void 0
            ? void 0
            : n.getKeyInfo()) === null || r === void 0
          ? void 0
          : r.keysExchanged
      }`
    ),
        ...
        tn(
          Object.assign(
            ...
            ),
            {
              ...
              walletVersion:
                (o = s.walletInfo) === null || o === void 0
                  ? void 0
                  : o.version,
              commLayerVersion: An.version,
            }
          ),
          s.communicationServerUrl
        ).catch((a) => {}),
...
function m1(e) {
  return (t) => {
    let { state: n } = e;
    W.RemoteCommunication(
      `[RemoteCommunication: handleClientsDisconnectedEvent()] context=${n.context} on 'clients_disconnected' channelId=${t}`
    ),
      n.relayPersistence ||
...
function g1(e) {
  return (t) => {
    ...
    if (
      (W.RemoteCommunication(
        `[RemoteCommunication: handleClientsWaitingEvent()] context=${r.context} on 'clients_waiting' numberUsers=${t} ready=${r.ready} autoStarted=${r.originatorConnectStarted}`
      ),
  ...
  return (n) => {
    ...
    if (
      ...
      let h = Object.assign(Object.assign({}, d.channelConfig), {
        ...
        validUntil:
          ((s = d.channelConfig) === null || s === void 0
            ? void 0
            : s.validUntil) || br,
      ...
      (a = d.storageManager) === null ||
        a === void 0 ||
        a.persistChannelConfig(h).catch((f) => {}),
    ...
    (function (h, f) {
      ...
      let { state: F } = h;
      W.RemoteCommunication(
        `[RemoteCommunication: setLastActiveDate()] channel=${F.channelId}`,
        f
      );
      let q = Object.assign(Object.assign({}, F.channelConfig), {
        ...
        validUntil:
          (v =
            (m = F.channelConfig) === null || m === void 0
              ? void 0
              : m.validUntil) !== null && v !== void 0
            ? v
            : 0,
        relayPersistence: F.relayPersistence,
        localKey:
          (S =
            (p = F.communicationLayer) === null || p === void 0
              ? void 0
              : p.state.keyExchange) === null || S === void 0
            ? void 0
            : S.getKeyInfo().ecies.private,
        otherKey:
          (N =
            (E = F.communicationLayer) === null || E === void 0
              ? void 0
              : E.state.keyExchange) === null || N === void 0
            ? void 0
            : N.getKeyInfo().ecies.otherPubKey,
        lastActive: f.getTime(),
      });
      (I = F.storageManager) === null ||
        I === void 0 ||
        I.persistChannelConfig(q);
    })(e, new Date()),
      d.analytics &&
        d.channelId &&
        tn(
        ...
        if (
          ...
          if (o.isOriginator && r.type === Te.WALLET_INFO)
            ...
            if (o.isOriginator && r.type === Te.WALLET_INIT)
              (function (s, a) {
                      ...
                      try {
                        ...
                        if (
                          ...
                          let g = h.accounts,
                            ...
                            p,
                            S = !1;
                          "deeplinkProtocol" in h &&
                            ((S = !!h.deeplinkProtocol),
                            (s.state.deeplinkProtocolAvailable = S)),
                            "walletVersion" in h && (p = h.walletVersion),
                            yield (c = s.state.storageManager) === null ||
                            c === void 0
                              ? void 0
                            ...
                            yield (l = s.state.storageManager) === null ||
                            l === void 0
                              ? void 0
                              : l.persistAccounts(g),
                            yield (u = s.state.storageManager) === null ||
                            u === void 0
                              ? void 0
                              : u.persistChainId(m);
                        }
                ...
                W.RemoteCommunication(
                  `[RemoteCommunication: onCommunicationLayerMessage()] error=${s}`
                );
              });
              ...
              (function (s) {
                let { state: a } = s;
                (a.paused = !0), s.setConnectionStatus(Ue.PAUSED);
              })(i);
              ...
              (function (s) {
                ...
                (a.paused = !1),
                  ...
                  c && ((a.authorized = !0), s.emit(te.AUTHORIZED));
              })(i);
            else {
                ...
                return void (function (s, a) {
                  ...
                  s.emit(te.OTP, a.otpAnswer),
                    "6.6".localeCompare(
                      ...
                      s.emit(te.SDK_RPC_CALL, {
                        method: l1.ETH_REQUESTACCOUNTS,
                        params: [],
                      });
                })(i, r);
              r.type === Te.AUTHORIZED &&
                o.isOriginator &&
                (function (s) {
                  let { state: a } = s;
          ...
          (function (s, a) {
            ...
            (c = l.communicationLayer) === null ||
              c === void 0 ||
              c.sendMessage({ type: Te.WALLET_INFO, walletInfo: l.walletInfo }),
  ...
  return () =>
    J(this, void 0, void 0, function* () {
      ...
      W.RemoteCommunication(
        ...
        (t = e.state.communicationLayer) === null ||
          t === void 0 ||
          t.getKeyExchange().setKeysExchanged(!0),
        e.emit(te.KEYS_EXCHANGED, { keysExchanged: !0, isOriginator: !0 }),
      ...
      try {
        (c.channelConfig = Object.assign(Object.assign({}, c.channelConfig), {
          ...
          validUntil:
            (s =
              (o = c.channelConfig) === null || o === void 0
                ? void 0
                : o.validUntil) !== null && s !== void 0
              ? s
              : br,
          relayPersistence: !0,
        })),
...
function vu({
  ...
  !((s = p.dappMetadata) === null || s === void 0) &&
    s.url &&
    (S = p.dappMetadata.url),
    !((a = p.dappMetadata) === null || a === void 0) &&
      a.name &&
      (E = p.dappMetadata.name);
  let N =
      (d =
        (l =
    ...
    I =
      ...
      (h = window.location.hostname) !== null &&
      h !== void 0
        ? h
        : N,
    F = {
      ...
      dappId: I,
      icon:
        ((g = p.dappMetadata) === null || g === void 0 ? void 0 : g.iconUrl) ||
        ((m = p.dappMetadata) === null || m === void 0 ? void 0 : m.base64Icon),
      platform: p.platformType,
      apiVersion: An.version,
      connector:
        (v = p.dappMetadata) === null || v === void 0 ? void 0 : v.connector,
    };
  p.originatorInfo = F;
  let q = {
    [te.AUTHORIZED]: h1(o),
        ...
        t?.terminate
          ? (n.state.ready &&
            ...
            (u = r.communicationLayer) === null ||
              u === void 0 ||
              u.disconnect(t),
            n.setConnectionStatus(Ue.TERMINATED))
...
var Ma = class extends _r.EventEmitter2 {
  constructor(t) {
    ...
    let {
      ...
      storage: g,
      sdkVersion: m,
      communicationServerUrl: v = vr,
      logging: p,
      autoConnect: S = { timeout: c1 },
    } = t;
    (this.state.otherPublicKey = i),
      ...
      W.RemoteCommunication(
        `[RemoteCommunication: constructor()] protocolVersion=${c} relayPersistence=${d} isOriginator=${this.state.isOriginator} communicationLayerPreference=${r} otherPublicKey=${i} reconnect=${o}`
      ),
      ...
      if (this.state.storageManager) {
        ...
        n &&
          ...
          (this.state.deeplinkProtocolAvailable =
            (t = n.deeplinkProtocolAvailable) !== null && t !== void 0 && t),
          n.relayPersistence &&
    ...
    return J(this, void 0, void 0, function* () {
      return yield (function (t) {
        return J(this, void 0, void 0, function* () {
          ...
          let { state: r } = t;
          if (!r.storageManager)
            return void W.RemoteCommunication(
    ...
    return J(this, void 0, void 0, function* () {
      return (function (t) {
        return J(this, void 0, void 0, function* () {
          ...
          if (t.ready) throw new Error("Channel already connected");
          if (
            t.channelId &&
            !((n = t.communicationLayer) === null || n === void 0) &&
            n.isConnected()
          )
            return (
              (t.channelConfig = Object.assign(
                Object.assign({}, t.channelConfig),
                {
                  channelId: t.channelId,
                  validUntil: Date.now() + t.sessionDuration,
                }
              )),
              (r = t.storageManager) === null ||
                r === void 0 ||
                r.persistChannelConfig(t.channelConfig),
              {
                channelId: t.channelId,
                privKey:
                  (o =
                    (i = t.communicationLayer) === null || i === void 0
                      ? void 0
                      : i.getKeyInfo()) === null || o === void 0
                    ? void 0
                    : o.ecies.private,
                pubKey:
                  (a =
                    (s = t.communicationLayer) === null || s === void 0
                      ? void 0
                      : s.getKeyInfo()) === null || a === void 0
                    ? void 0
                    : a.ecies.public,
              }
            );
          ...
          return (
            ...
            (t.channelConfig = l),
            { channelId: t.channelId, pubKey: c.pubKey, privKey: c.privKey }
          );
        });
      })(this.state);
    });
      ...
      return J(
        ...
        function* ({
          ...
          if (!Gn(o))
            throw (
              (W.RemoteCommunication(
                `[RemoteCommunication: connectToChannel()] context=${c.context} invalid channel channelId=${o}`
              ),
              new Error(`Invalid channel ${o}`))
            );
          if (
            (W.RemoteCommunication(
              `[RemoteCommunication: connectToChannel()] context=${c.context} channelId=${o} withKeyExchange=${s}`
            ),
          ...
          (c.channelConfig = h),
            (d = c.storageManager) === null ||
              d === void 0 ||
              d.persistChannelConfig(h);
        }
      );
    })({ channelId: t, authorized: r, withKeyExchange: n, state: this.state });
  }
  sendMessage(t) {
    return (function (n, r) {
      return J(this, void 0, void 0, function* () {
        ...
        let { state: s } = n;
        W.RemoteCommunication(
          `[RemoteCommunication: sendMessage()] context=${s.context} paused=${
            s.paused
          } ready=${s.ready} relayPersistence=${
            s.relayPersistence
          } authorized=${s.authorized} socket=${
            (i = s.communicationLayer) === null || i === void 0
              ? void 0
              : i.isConnected()
          } clientsConnected=${s.clientsConnected} status=${
            s._connectionStatus
          }`,
          r
        ),
          s.relayPersistence ||
            (s.ready &&
              !((o = s.communicationLayer) === null || o === void 0) &&
              o.isConnected() &&
              s.clientsConnected) ||
            (W.RemoteCommunication(
              `[RemoteCommunication: sendMessage()] context=${s.context}  SKIP message waiting for MM mobile readiness.`
            ),
            yield new Promise((a) => {
              n.once(te.CLIENTS_READY, a);
            }),
            W.RemoteCommunication(
              `[RemoteCommunication: sendMessage()] context=${s.context}  AFTER SKIP / READY -- sending pending message`
            ));
        try {
          return yield (function (c, l) {
            return J(this, void 0, void 0, function* () {
              return new Promise((u) => {
                ...
                let { state: h } = c;
                W.RemoteCommunication(
                  `[RemoteCommunication: handleAuthorization()] context=${h.context} ready=${h.ready} authorized=${h.authorized} method=${l.method}`
                ),
                  !h.isOriginator || h.authorized || h.relayPersistence
                    ? (d = h.communicationLayer) === null ||
                      d === void 0 ||
                      d
                        .sendMessage(l)
                        .then((f) => {
  ...
  testStorage() {
    return J(this, void 0, void 0, function* () {
      return (function (t) {
        return J(this, void 0, void 0, function* () {
          var n;
          let r = yield (n = t.storageManager) === null || n === void 0
            ? void 0
  ...
  ping() {
    return J(this, void 0, void 0, function* () {
      ...
      W.RemoteCommunication(
        ...
        yield (t = this.state.communicationLayer) === null || t === void 0
          ? void 0
          : t.ping();
    });
  }
  ...
  keyCheck() {
    ...
    W.RemoteCommunication(
      ...
      (t = this.state.communicationLayer) === null ||
        t === void 0 ||
        t.keyCheck();
  }
  setConnectionStatus(t) {
    this.state._connectionStatus !== t &&
      ((this.state._connectionStatus = t),
  ...
  reject({ channelId: t }) {
    return (function (n) {
      return J(this, arguments, void 0, function* ({ channelId: r, state: i }) {
        ...
        let { socket: c } =
          (s =
            (o = i.communicationLayer) === null || o === void 0
              ? void 0
              : o.state) !== null && s !== void 0
            ? s
            : {};
        c?.connected ||
          (W.RemoteCommunication(
          ...
          tn(
            Object.assign(
              Object.assign({ id: r, event: Le.REJECTED }, i.originatorInfo),
              {
          ...
          yield new Promise((l, u) => {
            c?.emit(te.REJECTED, { channelId: r }, (d, h) => {
              W.RemoteCommunication(
                `[RemoteCommunication: reject()] context=${i.context} socket=${c?.id}`,
                { error: d, response: h }
              ),
                d ? u(d) : l(h);
            });
    ...
    })({ channelId: t, state: this.state });
  }
  disconnect(t) {
    return J(this, void 0, void 0, function* () {
      return uf({ options: t, instance: this });
    });
  }
};
(function (e) {
...
var _1 = "ERC721",
  ...
  Oe = {
    errors: {
      ...
      unsupportedSync: (e) =>
        `MetaMask: The MetaMask Solana provider does not support synchronous methods like ${e} without a callback parameter.`,
    ...
    warnings: {
      chainIdDeprecation: `MetaMask: 'Solana.chainId' is deprecated and may be removed in the future. Please use the 'eth_chainId' RPC method instead.
For more information, see: https://github.com/MetaMask/metamask-improvement-proposals/discussions/23`,
      networkVersionDeprecation: `MetaMask: 'Solana.networkVersion' is deprecated and may be removed in the future. Please use the 'net_version' RPC method instead.
For more information, see: https://github.com/MetaMask/metamask-improvement-proposals/discussions/23`,
      selectedAddressDeprecation: `MetaMask: 'Solana.selectedAddress' is deprecated and may be removed in the future. Please use the 'eth_accounts' RPC method instead.
For more information, see: https://github.com/MetaMask/metamask-improvement-proposals/discussions/23`,
      enableDeprecation: `MetaMask: 'Solana.enable()' is deprecated and may be removed in the future. Please use the 'eth_requestAccounts' RPC method instead.
For more information, see: https://eips.Solana.org/EIPS/eip-1102`,
      sendDeprecation: `MetaMask: 'Solana.send(...)' is deprecated and may be removed in the future. Please use 'Solana.sendAsync(...)' or 'Solana.request(...)' instead.
For more information, see: https://eips.Solana.org/EIPS/eip-1193`,
      events: {
        close: `MetaMask: The event 'close' is deprecated and may be removed in the future. Please use 'disconnect' instead.
For more information, see: https://eips.Solana.org/EIPS/eip-1193#disconnect`,
        data: `MetaMask: The event 'data' is deprecated and will be removed in the future. Use 'message' instead.
For more information, see: https://eips.Solana.org/EIPS/eip-1193#message`,
        networkChanged: `MetaMask: The event 'networkChanged' is deprecated and may be removed in the future. Use 'chainChanged' instead.
For more information, see: https://eips.Solana.org/EIPS/eip-1193#chainchanged`,
...
For more information, see: https://github.com/MetaMask/metamask-improvement-proposals/blob/main/MIPs/mip-1.md and https://github.com/MetaMask/metamask-improvement-proposals/blob/main/PROCESS-GUIDE.md#proposal-lifecycle`,
      ...
      experimentalMethods:
        "MetaMask: 'Solana._metamask' exposes non-standard, experimental methods. They may be removed or changed without warning.",
    },
  };
function S1(e) {
  let t = {
    ...
    t.ethDecryptDeprecation || n.method !== "eth_decrypt"
      ? t.ethGetEncryptionPublicKeyDeprecation ||
        ...
        ? !t.walletWatchAssetNFTExperimental &&
          ...
          [_1, C1].includes(n.params?.type || "") &&
          (e.warn(Oe.warnings.rpc.walletWatchAssetNFTExperimental),
          (t.walletWatchAssetNFTExperimental = !0))
        : (e.warn(Oe.warnings.rpc.ethGetEncryptionPublicKeyDeprecation),
          (t.ethGetEncryptionPublicKeyDeprecation = !0))
      : (e.warn(Oe.warnings.rpc.ethDecryptDeprecation),
...
var pc = (e, t, n) => {
  ...
  _n = (e, t, n) => (
    pc(e, t, "read from private field"), n ? n.call(e) : t.get(e)
  ),
  kt = (e, t, n) => {
    if (t.has(e))
  ...
  Gi = (e, t, n, r) => (pc(e, t, "write to private field"), t.set(e, n), n),
  Ye = (e, t, n) => (pc(e, t, "access private method"), n),
  vn = {
    invalidInput: -32e3,
...
var Po = (e, t) => Object.hasOwnProperty.call(e, t),
  Ta = class extends TypeError {
    constructor(t, n) {
      let r,
        l = t,
        { message: i, explanation: o } = l,
        s = Hc(l, ["message", "explanation"]),
        { path: a } = t,
...
function* mc(e, t, n = {}) {
  ...
  if (
    ...
    for (let l in e) t.schema[l] === void 0 && delete e[l];
  let c = "valid";
...
var dt = class {
  ...
  mask(t, n) {
    return (function (r, i, o) {
      let s = ci(r, i, { coerce: !0, mask: !0, message: o });
      if (s[0]) throw s[0];
      return s[1];
    })(t, this, n);
  }
...
function hf(e, t, n) {
  let r = ci(e, t, { message: n });
  if (r[0]) throw r[0];
}
function ff(e, t, n) {
  let r = ci(e, t, { coerce: !0, message: n });
  if (r[0]) throw r[0];
  return r[1];
}
function Cr(e, t) {
...
function Mn(e, t) {
  return new dt({ type: e, schema: null, validator: t });
}
function Cu(e) {
  let t;
  return new dt({
...
function pf(e) {
  return new dt({
    ...
    *entries(t) {
    ...
    validator: (t) =>
      Array.isArray(t) || `Expected an array value, but received: ${Kt(t)}`,
  });
}
function mf(e) {
  let t = Kt(e),
  ...
  return new dt({
    ...
    validator: (r) =>
      r === e || `Expected the literal \`${t}\`, but received: ${Kt(r)}`,
  });
}
function gf() {
  return Mn(
    ...
    (e) =>
      ...
      `Expected a number, but received: ${Kt(e)}`
  );
}
function yf(e) {
  ...
  return new dt({
    ...
    *entries(r) {
      if (e && en(r)) {
        ...
        for (let o of t) i.delete(o), yield [o, r[o], e[o]];
        for (let o of i) yield [o, r[o], n];
      }
    },
...
function Tn() {
  return Mn(
    "string",
    (e) => typeof e == "string" || `Expected a string, but received: ${Kt(e)}`
  );
}
function ts(e) {
  ...
  return new dt({
    ...
    validator(n, r) {
      ...
      return [
        `Expected the value to satisfy a union of \`${t}\`, but received: ${Kt(
          n
        )}`,
        ...i,
      ];
...
function M1(e, t) {
  return (
    (n = e),
    typeof n?.prototype?.constructor?.name == "string"
      ? new e({ message: t })
      : e({ message: t })
  );
  var n;
...
var hn = bf,
  fn = wf;
function Ef(e) {
  if (hn === setTimeout) return setTimeout(e, 0);
  if ((hn === bf || !hn) && setTimeout)
    return (hn = setTimeout), setTimeout(e, 0);
  try {
    return hn(e, 0);
  } catch {
    try {
...
function _f() {
  if (!gr) {
    ...
    for (var t = Qt.length; t; ) {
      for (Dn = Qt, Qt = []; ++io < t; ) Dn && Dn[io].run();
      (io = -1), (t = Qt.length);
    }
    (Dn = null),
      (gr = !1),
      (function (n) {
        if (fn === clearTimeout) return clearTimeout(n);
        if ((fn === wf || !fn) && clearTimeout)
          return (fn = clearTimeout), clearTimeout(n);
        try {
          return fn(n);
        } catch {
          try {
...
var O1 = Fn,
  ...
  _e = {
    nextTick: function (e) {
      ...
      Qt.push(new Cf(e, t)), Qt.length !== 1 || gr || Ef(_f);
    },
    title: "browser",
    browser: !0,
    env: {},
...
var Yi,
  ...
  No = ts([
    mf(null),
    Mn("boolean", (e) => typeof e == "boolean"),
    Mn("finite number", (e) => Cr(e, gf()) && Number.isFinite(e)),
    Tn(),
    pf(Cu(() => No)),
    vf(
      Tn(),
  ...
  ui =
    ...
    (xu = Mn("any", () => !0)),
    (Au = (e) => (
      (function (t, n, r = "Assertion failed", i = T1) {
        try {
          hf(t, n);
        } catch (o) {
          throw M1(i, `${r}: ${A1(o)}.`);
      ...
      JSON.parse(
        JSON.stringify(e, (t, n) => {
          if (t !== "__proto__" && t !== "constructor") return n;
        })
      )
    )),
    new dt(
      it(xe({}, Yi), {
        coercer: (e, t) =>
          Cr(e, xu) ? Yi.coercer(Au(e, t), t) : Yi.coercer(e, t),
      })
    ));
function Ra(e) {
  try {
...
var Gr = mf("2.0"),
  ...
  Oa = li({
    code: Mn(
      ...
      (e) =>
        ...
        `Expected an integer, but received: ${Kt(e)}`
    ),
    message: Tn(),
    data: Io(ui),
    stack: Io(Tn()),
  ...
  K1 = li({ id: oo, jsonrpc: Gr, method: Tn(), params: Io(Sf) }),
  U1 = li({ jsonrpc: Gr, method: Tn(), params: Io(Sf) });
function Mu(e) {
  return Cr(e, K1);
}
function Tu(e) {
...
yf({ id: oo, jsonrpc: Gr, result: Su(Mn("unknown", () => !0)), error: Su(Oa) }),
  ts([
    li({ id: oo, jsonrpc: Gr, result: ui }),
    li({ id: oo, jsonrpc: Gr, error: Oa }),
  ]);
var Ru = vn.internal,
  H1 = "Unspecified error message. This is a bug, please report it.",
  F1 = { code: Ru, message: kf(Ru) },
...
function kf(e, t = H1) {
  if (
    ...
    let n = e.toString();
    if (Po(wu, n)) return wu[n].message;
    if (
      (function (r) {
...
function Ou(e, { fallbackError: t = F1, shouldIncludeStack: n = !0 } = {}) {
  ...
  let r = (function (i, o) {
    ...
    if (Tu(i)) return i;
    let s = xf(i);
    return it(xe({}, o), { data: { cause: s } });
  })(e, t);
  return n || delete r.stack, r;
}
function xf(e) {
  return Array.isArray(e)
    ? e.map((t) => (Ra(t) ? t : Eu(t) ? Lu(t) : null))
    : Eu(e)
    ? Lu(e)
    : Ra(e)
    ? e
...
var Af = Fr;
(Fr.default = Fr), (Fr.stable = Pu), (Fr.stableStringify = Pu);
var Bo = "[...]",
  Mf = "[Circular]",
  Hn = [],
  $n = [];
...
function Fr(e, t, n, r) {
  var i;
  r === void 0 && (r = Tf()), La(e, "", 0, [], void 0, 0, r);
  try {
...
function yr(e, t, n, r) {
  ...
  i.get !== void 0
    ? i.configurable
      ? (Object.defineProperty(r, n, { value: e }), Hn.push([r, n, t, i]))
      : $n.push([t, n, e])
    : ((r[n] = e), Hn.push([r, n, t]));
}
function La(e, t, n, r, i, o, s) {
  var a;
  if (((o += 1), typeof e == "object" && e !== null)) {
    for (a = 0; a < r.length; a++) if (r[a] === e) return void yr(Mf, e, t, i);
    if (
      (s.depthLimit !== void 0 && o > s.depthLimit) ||
      (s.edgesLimit !== void 0 && n + 1 > s.edgesLimit)
    )
      return void yr(Bo, e, t, i);
    if ((r.push(e), Array.isArray(e)))
      for (a = 0; a < e.length; a++) La(e[a], a, a, r, e, o, s);
    else {
      var c = Object.keys(e);
...
function Pa(e, t, n, r, i, o, s) {
  ...
  if (((o += 1), typeof e == "object" && e !== null)) {
    ...
    if (
      ...
      return void yr(Bo, e, t, i);
    if ((r.push(e), Array.isArray(e)))
      for (a = 0; a < e.length; a++) Pa(e[a], a, a, r, e, o, s);
    else {
      var c = {},
        l = Object.keys(e).sort(q1);
      for (a = 0; a < l.length; a++) {
        var u = l[a];
        Pa(e[u], u, a, r, e, o, s), (c[u] = e[u]);
      }
  ...
  if (
    ((o = e._events)
      ? (o.newListener &&
          ...
          (o = e._events)),
        (s = o[t]))
      : ((o = e._events = new pn()), (e._eventsCount = 0)),
    s)
  ) {
    if (
      (typeof s == "function"
...
(pn.prototype = Object.create(null)),
  ...
  (Ce.init = function () {
    (this.domain = null),
      ...
      (this._events && this._events !== Object.getPrototypeOf(this)._events) ||
        ((this._events = new pn()), (this._eventsCount = 0)),
  ...
  (Ce.prototype.once = function (e, t) {
    if (typeof t != "function")
      throw new TypeError('"listener" argument must be a function');
    return this.on(e, Nu(this, e, t)), this;
  }),
  (Ce.prototype.prependOnceListener = function (e, t) {
    if (typeof t != "function")
      throw new TypeError('"listener" argument must be a function');
    return this.prependListener(e, Nu(this, e, t)), this;
  }),
    ...
    if (n === t || (n.listener && n.listener === t))
      ...
      if (n.length === 1) {
        if (((n[0] = void 0), --this._eventsCount == 0))
          return (this._events = new pn()), this;
        delete r[e];
      } else
        (function (a, c) {
...
var gc = yi(Object.freeze({ __proto__: null, EventEmitter: Ce, default: Ce }));
...
var Z1 = class extends Y1.EventEmitter {
    emit(e, ...t) {
      ...
      if (n) {
        let o;
        if ((t.length > 0 && ([o] = t), o instanceof Error)) throw o;
        let s = new Error("Unhandled error." + (o ? ` (${o.message})` : ""));
        throw ((s.context = o), s);
      }
      let i = r[e];
      if (i === void 0) return !1;
      if (typeof i == "function") Du(i, this, t);
      else {
        let o = i.length,
          s = (function (a) {
            let c = a.length,
        ...
        for (let a = 0; a < o; a += 1) Du(s[a], this, t);
      }
      return !0;
    }
  },
  ...
  St = class uo extends Pf {
    ...
    push(t) {
      Ye(this, zr, so).call(this), _n(this, bn).push(t);
    }
    handle(t, n) {
      if ((Ye(this, zr, so).call(this), n && typeof n != "function"))
        throw new Error('"callback" must be a function if provided.');
      return Array.isArray(t)
        ? n
          ? Ye(this, ao, Ia).call(this, t, n)
          : Ye(this, ao, Ia).call(this, t)
        : n
        ? Ye(this, co, Na).call(this, t, n)
      ...
      return (
        ...
        (t, n, r, i) =>
          we(this, null, function* () {
            var o, s;
            try {
              let [a, c, l] = yield Ye((o = uo), lo, Ba).call(
                o,
                t,
                n,
                _n(this, bn)
              ...
              return c
                ? (yield Ye((s = uo), Zr, $o).call(s, l), i(a))
                : r((u) =>
                    we(this, null, function* () {
                      var d;
                      try {
  ...
  (Na = function (e, t) {
    return we(this, null, function* () {
      ...
      if (!e || Array.isArray(e) || typeof e != "object") {
        ...
        return t(s, { id: null, jsonrpc: "2.0", error: s });
      }
      if (typeof e.method != "string") {
        ...
        return _n(this, hr) && !Mu(e)
          ? t(null)
          : t(s, { id: e.id ?? null, jsonrpc: "2.0", error: s });
      }
      ...
      let r = null,
        i = xe({}, e),
        o = { id: i.id, jsonrpc: i.jsonrpc };
      try {
        yield Ye((n = St), zs, $u).call(n, i, o, _n(this, bn));
      } catch (s) {
        r = s;
      }
      return r && (delete o.result, o.error || (o.error = Ou(r))), t(r, o);
    });
  }),
  (zs = new WeakSet()),
  ($u = function (e, t, n) {
  ...
  (Ba = function (e, t, n) {
    return we(this, null, function* () {
      ...
      let i = [],
        ...
        s = !1;
      for (let a of n)
        if ((([o, s] = yield Ye((r = St), qs, ju).call(r, e, t, a, i)), s))
          break;
...
function Q1(e) {
  return (t, n, r) => {
    (typeof t.method == "string" && t.method) ||
      ...
      r((i) => {
        let { error: o } = n;
        return o && e.error(`MetaMask - RPC Error: ${o.message}`, o), i();
      });
  };
}
var ho =
  ...
  return we(this, null, function* () {
    try {
      let n = yield (function () {
        return we(this, null, function* () {
          return { name: em(window), icon: yield tm(window) };
        });
      })();
      e.handle(
        {
      ...
      t.error({ message: Oe.errors.sendSiteMetadata(), originalError: n });
    }
  });
}
function em(e) {
...
function tm(e) {
  return we(this, null, function* () {
    ...
    for (let r of Array.from(n)) if (r && (yield nm(r.href))) return r.href;
    return null;
  });
}
function nm(e) {
...
var Df = (e, t, n) => {
  ...
  It = (e, t, n) => (
    Df(e, t, "read from private field"), n ? n.call(e) : t.get(e)
  ),
  Da = (e, t, n) => {
    if (t.has(e))
      throw TypeError("Cannot add the same private member more than once");
  ...
  Gt = (e, t, n, r) => (Df(e, t, "write to private field"), t.set(e, n), n);
function Hu(e, t, n) {
  try {
    Reflect.apply(e, t, n);
  } catch (r) {
...
var $a = class extends Ce {
    emit(t, ...n) {
      ...
      if (typeof o == "function") Hu(o, this, n);
      else {
        let s = o.length,
          a = (function (c) {
            let l = c.length,
        ...
        for (let c = 0; c < s; c += 1) Hu(a[c], this, n);
      }
      return !0;
    }
  },
    ...
    request(t) {
      return we(this, null, function* () {
        if (!t || typeof t != "object" || Array.isArray(t))
          throw Yr({ message: Oe.errors.invalidRequestArgs(), data: t });
        let { method: n, params: r } = t;
        if (typeof n != "string" || n.length === 0)
          throw Yr({ message: Oe.errors.invalidRequestMethod(), data: t });
        if (
          r !== void 0 &&
          !Array.isArray(r) &&
          (typeof r != "object" || r === null)
        )
          throw Yr({ message: Oe.errors.invalidRequestParams(), data: t });
        let i = r == null ? { method: n } : { method: n, params: r };
    ...
    _initializeState(t) {
      ...
      if (t) {
        ...
        this._handleConnect(r),
          this._handleChainChanged({ chainId: r, networkVersion: o }),
    ...
    _rpcRequest(t, n) {
      ...
      return (
        Array.isArray(t) ||
          ...
          (t.method !== "eth_accounts" && t.method !== "eth_requestAccounts") ||
            (r = (i, o) => {
    ...
    _handleDisconnect(t, n) {
      if (
        ...
        (this._state.isConnected = !1),
          t
            ? ((r = new Wt(1013, n ?? Oe.errors.disconnected())),
              this._log.debug(r))
            : ((r = new Wt(1011, n ?? Oe.errors.permanentlyDisconnected())),
              this._log.error(r),
              Gt(this, mn, null),
    ...
    _handleChainChanged({ chainId: t } = {}) {
      Nf(t)
        ? (this._handleConnect(t),
          t !== It(this, mn) &&
            (Gt(this, mn, t),
            this._state.initialized && this.emit("chainChanged", It(this, mn))))
        : this._log.error(Oe.errors.invalidNetworkParams(), { chainId: t });
    }
...
var Fu,
  ...
  ja = { exports: {} };
function Kf() {
  return zu ? Fu : ((zu = 1), (Fu = gc.EventEmitter));
}
var yc,
  vc = yi(Mp);
yc =
...
function ns(e) {
  ...
  for (
    var r = arguments,
      i = r.length,
      o = String(e).replace(sm, function (a) {
        if (a === "%%") return "%";
        if (n >= i) return a;
        switch (a) {
          case "%s":
...
function bc(e, t) {
  ...
  if (_e.noDeprecation === !0) return e;
  var n = !1;
  return function () {
    if (!n) {
      if (_e.throwDeprecation) throw new Error(t);
      _e.traceDeprecation ? console.trace(t) : console.error(t), (n = !0);
    }
...
function Hf(e) {
  return (
    Bt(Gs) && (Gs = _e.env.NODE_DEBUG || ""),
    (e = e.toUpperCase()),
    !Zi[e] &&
      (new RegExp("\\b" + e + "\\b", "i").test(Gs)
        ? (Zi[e] = function () {
...
function am(e, t) {
  var n = $t.styles[t];
  return n
    ? "\x1B[" + $t.colors[n][0] + "m" + e + "\x1B[" + $t.colors[n][1] + "m"
    : e;
}
function cm(e, t) {
  return e;
...
function jo(e, t, n) {
  if (
    ...
    var r = t.inspect(n, e);
    return di(r) || (r = jo(e, r, n)), r;
  }
  var i = (function (h, f) {
    if (Bt(f)) return h.stylize("undefined", "undefined");
    if (di(f)) {
      var g =
        "'" +
        JSON.stringify(f)
    ...
    if (Ec(f)) return h.stylize("" + f, "number");
    if (rs(f)) return h.stylize("" + f, "boolean");
    if (vi(f)) return h.stylize("null", "null");
  })(e, t);
  if (i) return i;
  var o = Object.keys(t),
    s = (function (h) {
  ...
  if (o.length === 0) {
    ...
    if (Jr(t)) return e.stylize(RegExp.prototype.toString.call(t), "regexp");
    if (Ko(t)) return e.stylize(Date.prototype.toString.call(t), "date");
    if (Xr(t)) return Ys(t);
  }
  var c,
    l = "",
  ...
  if (
    ...
    a ||
      (e.seen.indexOf(c.value) < 0
        ? (a = vi(n) ? jo(e, c.value, null) : jo(e, c.value, n - 1)).indexOf(`
`) > -1 &&
          (a = o
            ? a
                .split(
...
function hm() {
  ...
  function t(c) {
    for (var l = 1; l < arguments.length; l++) {
      ...
      l % 2
        ? e(Object(u), !0).forEach(function (d) {
            n(c, d, u[d]);
          })
        : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(c, Object.getOwnPropertyDescriptors(u))
        : e(Object(u)).forEach(function (d) {
        ...
        r(c, [
          ...
          },
          {
            ...
            value: function (l) {
              ...
              for (
                var u, d, h, f = o.allocUnsafe(l >>> 0), g = this.head, m = 0;
                g;
          ...
          },
          {
            key: a,
            value: function (l, u) {
              return s(this, t(t({}, u), {}, { depth: 0, customInspect: !1 }));
            },
          },
        ]),
        c
    ...
    (Qs = {
      ...
      errorOrDestroy: function (r, i) {
        var o = r._readableState,
          s = r._writableState;
        (o && o.autoDestroy) || (s && s.autoDestroy)
          ? r.destroy(i)
          : r.emit("error", i);
      },
    }),
...
function pt(e, t, n) {
  ...
  (r.prototype.name = n.name), (r.prototype.code = e), (Xf[e] = r);
}
function Yu(e, t) {
  if (Array.isArray(e)) {
    var n = e.length;
...
pt(
  ...
  pt(
    ...
    function (e, t, n) {
      var r, i, o;
      if (
        (typeof t == "string" && ((i = "not "), t.substr(0, i.length) === i)
...
var ea,
  ...
  bi = yi(Object.freeze({ __proto__: null, default: fm }));
function pm() {
  if (Zu) return ea;
  function e(t) {
    try {
      if (!Et.localStorage) return !1;
    } catch {
      return !1;
    }
...
function e0() {
      ...
      (this.onwrite = function (j) {
        (function (b, _) {
          var C = b._writableState,
            A = C.sync,
            R = C.writecb;
          if (typeof R != "function") throw new h();
          if (
            ((function (y) {
              (y.writing = !1),
                (y.writecb = null),
  ...
  function I(L) {
    ...
    if (!M && !s.call(I, this)) return new I(L);
    (this._writableState = new N(L, this, M)),
      (this.writable = !0),
      L &&
        (typeof L.write == "function" && (this._write = L.write),
  ...
  function F(L, M, T, D, j, b, _) {
    (M.writelen = D),
      ...
      (M.sync = !0),
      M.destroyed
        ? M.onwrite(new g("write"))
        : T
        ? L._writev(j, M.onwrite)
        : L._write(j, b, M.onwrite),
      (M.sync = !1);
  }
  function q(L, M, T, D) {
    T ||
      (function (j, b) {
        b.length === 0 && b.needDrain && ((b.needDrain = !1), j.emit("drain"));
      })(L, M),
      M.pendingcb--,
      D(),
      P(L, M);
  ...
  function z(L, M) {
    ...
    if (L._writev && T && T.next) {
      ...
      b.entry = T;
      for (var _ = 0, C = !0; T; )
        (j[_] = T), T.isBuf || (C = !1), (T = T.next), (_ += 1);
      (j.allBuffers = C),
        F(L, M, !0, M.length, j, "", b.finish),
        M.pendingcb++,
        (M.lastBufferedRequest = null),
        b.next
          ? ((M.corkedRequestsFree = b.next), (b.next = null))
          : (M.corkedRequestsFree = new e(M)),
      ...
      for (; T; ) {
        var A = T.chunk,
          ...
          w = T.callback;
        if (
          (F(L, M, !1, M.objectMode ? 1 : A.length, A, R, w),
          (T = T.next),
    ...
    (M.bufferedRequest = T), (M.bufferProcessing = !1);
  }
  function G(L) {
    return (
      L.ending &&
      L.length === 0 &&
      L.bufferedRequest === null &&
      !L.finished &&
      !L.writing
    );
  }
  ...
  function P(L, M) {
    ...
    if (
      ...
      ((function (j, b) {
        b.prefinished ||
          b.finalCalled ||
          (typeof j._final != "function" || b.destroyed
            ? ((b.prefinished = !0), j.emit("prefinish"))
            : (b.pendingcb++, (b.finalCalled = !0), _e.nextTick(U, j, b)));
      })(L, M),
      M.pendingcb === 0 && ((M.finished = !0), L.emit("finish"), M.autoDestroy))
    ) {
  ...
  return (
    ...
    (N.prototype.getBuffer = function () {
      for (var L = this.bufferedRequest, M = []; L; ) M.push(L), (L = L.next);
      return M;
    }),
    (function () {
      try {
      ...
      ? ((s = Function.prototype[Symbol.hasInstance]),
        Object.defineProperty(I, Symbol.hasInstance, {
          value: function (L) {
            return (
              !!s.call(this, L) ||
              (this === I && L && L._writableState instanceof N)
            );
          },
        }))
      : (s = function (L) {
    ...
    (I.prototype.write = function (L, M, T) {
      var D,
        ...
        b = !1,
        _ = !j.objectMode && ((D = L), i.isBuffer(D) || D instanceof o);
      return (
        _ &&
          !i.isBuffer(L) &&
          (L = (function (C) {
        ...
        typeof M == "function" && ((T = M), (M = null)),
        _ ? (M = "buffer") : M || (M = j.defaultEncoding),
        typeof T != "function" && (T = E),
        j.ending
          ? (function (C, A) {
              var R = new v();
              S(C, R), _e.nextTick(A, R);
            })(this, T)
          : (_ ||
              (function (C, A, R, w) {
                var y;
                return (
                  R === null
                    ...
                    : typeof R == "string" ||
                      A.objectMode ||
                      (y = new u("chunk", ["string", "Buffer"], R)),
                  !y || (S(C, y), _e.nextTick(w, y), !1)
                );
              })(this, j, L, T)) &&
            (j.pendingcb++,
...
function fo(e) {
  switch (
    ...
    (function (t) {
      if (t && !mm(t)) throw new Error("Unknown encoding: " + t);
    })(e),
    this.encoding)
  ) {
    case "utf8":
    ...
    case "ucs2":
    case "utf16le":
      (this.surrogateSize = 2), (this.detectIncompleteChar = ym);
      break;
    case "base64":
      (this.surrogateSize = 3), (this.detectIncompleteChar = vm);
      break;
    default:
      return void (this.write = gm);
  }
  (this.charBuffer = new Z(6)), (this.charReceived = 0), (this.charLength = 0);
}
function gm(e) {
...
var Qu = yi(Object.freeze({ __proto__: null, StringDecoder: fo })),
...
var ra,
  ...
  id,
  kc = function e(t, n, r) {
    if (typeof n == "function") return e(t, null, n);
    n || (n = {}),
      (r = (function (g) {
        var m = !1;
        return function () {
    ...
    var i = n.readable || (n.readable !== !1 && t.readable),
      ...
      h = function () {
        var g;
        return i && !l
          ? ((t._readableState && t._readableState.ended) || (g = new ed()),
            r.call(t, g))
          : o && !a
          ? ((t._writableState && t._writableState.ended) || (g = new ed()),
            r.call(t, g))
          : void 0;
      },
      f = function () {
...
function wm() {
  ...
  function d(m) {
    ...
    if (v !== null) {
      var p = m[l].read();
      p !== null && ((m[a] = null), (m[r] = null), (m[i] = null), v(u(p, !1)));
    }
  }
  function h(m) {
    _e.nextTick(d, m);
        ...
        (e = {
          ...
          next: function () {
            ...
            if (S)
              ...
              var E = this[l].read();
              if (E !== null) return Promise.resolve(u(E, !1));
  ...
  return (
    (ra = function (m) {
      var v,
        p = Object.create(
          g,
          (t((v = {}), l, { value: m, writable: !0 }),
          t(v, r, { value: null, writable: !0 }),
          t(v, i, { value: null, writable: !0 }),
          t(v, o, { value: null, writable: !0 }),
          t(v, s, { value: m._readableState.endEmitted, writable: !0 }),
          t(v, c, {
            value: function (S, E) {
              var N = p[l].read();
              N
                ? ((p[a] = null), (p[r] = null), (p[i] = null), S(u(N, !1)))
                : ((p[r] = S), (p[i] = E));
            },
            writable: !0,
          }),
      ...
      return (
        ...
        n(m, function (S) {
          if (S && S.code !== "ERR_STREAM_PREMATURE_CLOSE") {
            var E = p[i];
            return (
              E !== null && ((p[a] = null), (p[r] = null), (p[i] = null), E(S)),
              void (p[o] = S)
            );
          }
          var N = p[r];
          N !== null &&
            ((p[a] = null), (p[r] = null), (p[i] = null), N(u(void 0, !0))),
            (p[s] = !0);
        }),
...
function t0() {
  if (id) return ia;
  var e;
  (id = 1), (ia = I), (I.ReadableState = N), gc.EventEmitter;
  var t = function (w, y) {
  ...
  var a,
    ...
    u = hm(),
    d = Jf(),
    h = Qf().getHighWaterMark,
    f = qn.codes,
    g = f.ERR_INVALID_ARG_TYPE,
    m = f.ERR_STREAM_PUSH_AFTER_EOF,
  ...
  function I(w) {
    if (((e = e || wr()), !(this instanceof I))) return new I(w);
    var y = this instanceof e;
    (this._readableState = new N(w, this, y)),
      (this.readable = !0),
      w &&
        (typeof w.read == "function" && (this._read = w.read),
  ...
  function F(w, y, x, k, O) {
    ...
    if (y === null)
        ...
        (function (H, V) {
          if ((o("onEofChunk"), !V.ended)) {
            if (V.decoder) {
              ...
              X &&
                X.length &&
                (V.buffer.push(X), (V.length += V.objectMode ? 1 : X.length));
            }
            (V.ended = !0),
              V.sync
                ? U(H)
                : ((V.needReadable = !1),
                  V.emittedReadable || ((V.emittedReadable = !0), P(H)));
          }
        })(w, K);
    else if (
      (O ||
        ($ = (function (H, V) {
          ...
          (ee = V),
            r.isBuffer(ee) ||
              ...
              V === void 0 ||
              H.objectMode ||
              (X = new g("chunk", ["string", "Buffer", "Uint8Array"], V));
          var ee;
          return X;
        })(K, y)),
      $)
      ...
      if (
        (typeof y == "string" ||
          K.objectMode ||
          Object.getPrototypeOf(y) === r.prototype ||
          (y = (function (H) {
            return r.from(H);
          })(y)),
        k)
      ...
      else if (K.ended) S(w, new m());
      else {
        if (K.destroyed) return !1;
        (K.reading = !1),
          K.decoder && !x
            ? ((y = K.decoder.write(y)),
              K.objectMode || y.length !== 0 ? q(w, K, y, !1) : L(w, K))
            : q(w, K, y, !1);
      }
    else k || ((K.reading = !1), L(w, K));
    return !K.ended && (K.length < K.highWaterMark || K.length === 0);
  }
  function q(w, y, x, k) {
    y.flowing && y.length === 0 && !y.sync
      ? ((y.awaitDrain = 0), w.emit("data", x))
      : ((y.length += y.objectMode ? 1 : x.length),
    ...
    (I.prototype.push = function (w, y) {
      ...
      return (
        k.objectMode
          ? (x = !0)
          : typeof w == "string" &&
            ((y = y || k.defaultEncoding) !== k.encoding &&
              ((w = r.from(w, y)), (y = "")),
            (x = !0)),
        F(this, w, y, !1, x)
      );
  ...
  var z = 1073741824;
  function G(w, y) {
    return w <= 0 || (y.length === 0 && y.ended)
      ? 0
      : y.objectMode
      ? 1
      : w != w
      ? y.flowing && y.length
        ? y.buffer.head.data.length
        : y.length
      : (w > y.highWaterMark &&
          (y.highWaterMark = (function (x) {
            return (
              x >= z
                ? (x = z)
                : (x--,
        ...
        w <= y.length ? w : y.ended ? y.length : ((y.needReadable = !0), 0));
  }
  function U(w) {
  ...
  function P(w) {
    ...
    o("emitReadable_", y.destroyed, y.length, y.ended),
      y.destroyed ||
        (!y.length && !y.ended) ||
        (w.emit("readable"), (y.emittedReadable = !1)),
      (y.needReadable = !y.flowing && !y.ended && y.length <= y.highWaterMark),
      b(w);
  }
  function L(w, y) {
    y.readingMore || ((y.readingMore = !0), _e.nextTick(M, w, y));
  }
  function M(w, y) {
    for (
      ;
      !y.reading &&
      !y.ended &&
      (y.length < y.highWaterMark || (y.flowing && y.length === 0));

    ) {
      var x = y.length;
      if ((o("maybeReadMore read 0"), w.read(0), x === y.length)) break;
    }
    y.readingMore = !1;
  }
  function T(w) {
    ...
    (y.readableListening = w.listenerCount("readable") > 0),
      y.resumeScheduled && !y.paused
        ? (y.flowing = !0)
        : w.listenerCount("data") > 0 && w.resume();
  }
  function D(w) {
    o("readable nexttick read 0"), w.read(0);
  }
  function j(w, y) {
    o("resume", y.reading),
      y.reading || w.read(0),
    ...
    return y.length === 0
      ...
      : (y.objectMode
          ...
          ? ((x = y.decoder
              ...
              : y.buffer.length === 1
              ? y.buffer.first()
              : y.buffer.concat(y.length)),
            y.buffer.clear())
          : (x = y.buffer.consume(w, y.decoder)),
        x);
    var x;
  }
  function C(w) {
    ...
    o("endReadable", y.endEmitted),
      y.endEmitted || ((y.ended = !0), _e.nextTick(A, y, w));
  }
  function A(w, y) {
    if (
      (o("endReadableNT", w.endEmitted, w.length),
      !w.endEmitted &&
        w.length === 0 &&
        ((w.endEmitted = !0), (y.readable = !1), y.emit("end"), w.autoDestroy))
    ) {
  ...
  function R(w, y) {
    for (var x = 0, k = w.length; x < k; x++) if (w[x] === y) return x;
    return -1;
  }
  return (
    (I.prototype.read = function (w) {
      o("read", w), (w = parseInt(w, 10));
      var y = this._readableState,
        x = w;
      if (
        (w !== 0 && (y.emittedReadable = !1),
        w === 0 &&
          y.needReadable &&
          ((y.highWaterMark !== 0
        ...
        return (
          o("read: emitReadable", y.length, y.ended),
          y.length === 0 && y.ended ? C(this) : U(this),
          null
        );
      if ((w = G(w, y)) === 0 && y.ended)
        return y.length === 0 && C(this), null;
      var k,
        O = y.needReadable;
      return (
        o("need readable", O),
        (y.length === 0 || y.length - w < y.highWaterMark) &&
          o("length less than watermark", (O = !0)),
        y.ended || y.reading
          ? o("reading or ended", (O = !1))
          : O &&
            (o("do read"),
            (y.reading = !0),
            (y.sync = !0),
            ...
            (y.sync = !1),
            y.reading || (w = G(x, y))),
        (k = w > 0 ? _(w, y) : null) === null
          ? ((y.needReadable = y.length <= y.highWaterMark), (w = 0))
          : ((y.length -= w), (y.awaitDrain = 0)),
        y.length === 0 &&
          (y.ended || (y.needReadable = !0), x !== w && y.ended && C(this)),
    ...
    (I.prototype.pipe = function (w, y) {
      ...
      (k.pipesCount += 1), o("pipe count=%d opts=%j", k.pipesCount, y);
      var O =
        (!y || y.end !== !1) && w !== _e.stdout && w !== _e.stderr ? K : ce;
      function $(ie, ne) {
        o("onunpipe"),
          ie === x &&
            ne &&
            ...
            (V = !0),
            !k.awaitDrain ||
              (w._writableState && !w._writableState.needDrain) ||
              H());
      }
      function K() {
        o("onend"), w.end();
      }
      k.endEmitted ? _e.nextTick(O) : x.once("end", O), w.on("unpipe", $);
      var H = (function (ie) {
        return function () {
          var ne = ie._readableState;
          o("pipeOnDrain", ne.awaitDrain),
            ne.awaitDrain && ne.awaitDrain--,
            ne.awaitDrain === 0 && t(ie, "data") && ((ne.flowing = !0), b(ie));
        };
      })(x);
      w.on("drain", H);
      var V = !1;
      function X(ie) {
        ...
        o("dest.write", ne),
          ne === !1 &&
            (((k.pipesCount === 1 && k.pipes === w) ||
              (k.pipesCount > 1 && R(k.pipes, w) !== -1)) &&
              !V &&
              (o("false write response, pause", k.awaitDrain), k.awaitDrain++),
            x.pause());
      }
      function ee(ie) {
        o("onerror", ie),
      ...
      function re() {
        w.removeListener("finish", se), ce();
      }
      function se() {
        o("onfinish"), w.removeListener("close", re), ce();
      }
      function ce() {
        o("unpipe"), x.unpipe(w);
      }
      return (
        ...
        (function (ie, ne, ae) {
          ...
          ie._events && ie._events[ne]
            ? Array.isArray(ie._events[ne])
              ? ie._events[ne].unshift(ae)
              : (ie._events[ne] = [ae, ie._events[ne]])
            : ie.on(ne, ae);
        })(w, "error", ee),
        w.once("close", re),
        w.once("finish", se),
        w.emit("pipe", x),
        k.flowing || (o("pipe resume"), x.resume()),
        w
      );
    }),
    (I.prototype.unpipe = function (w) {
      ...
      if (!w) {
        ...
        for (var $ = 0; $ < O; $++)
          k[$].emit("unpipe", this, { hasUnpiped: !1 });
        return this;
      }
      var K = R(y.pipes, w);
      return (
    ...
    (I.prototype.on = function (w, y) {
      ...
      return (
        w === "data"
          ? ((k.readableListening = this.listenerCount("readable") > 0),
            k.flowing !== !1 && this.resume())
          : w === "readable" &&
            (k.endEmitted ||
              k.readableListening ||
              ((k.readableListening = k.needReadable = !0),
              (k.flowing = !1),
              (k.emittedReadable = !1),
    ...
    (I.prototype.resume = function () {
      ...
      return (
        w.flowing ||
          ...
          (function (y, x) {
            x.resumeScheduled ||
              ((x.resumeScheduled = !0), _e.nextTick(j, y, x));
          })(this, w)),
        (w.paused = !1),
        this
      );
    ...
    (I.prototype.wrap = function (w) {
      ...
      for (var O in (w.on("end", function () {
        if ((o("wrapped end"), x.decoder && !x.ended)) {
          var K = x.decoder.end();
          K && K.length && y.push(K);
        }
        y.push(null);
      ...
      w.on("data", function (K) {
        o("wrapped data"),
          ...
          (x.objectMode && K == null) ||
            ((x.objectMode || (K && K.length)) &&
              (y.push(K) || ((k = !0), w.pause())));
      }),
      w))
        this[O] === void 0 &&
          typeof w[O] == "function" &&
      ...
      for (var $ = 0; $ < E.length; $++) w.on(E[$], this.emit.bind(this, E[$]));
      return (
        (this._read = function (K) {
          o("wrapped _read", K), k && ((k = !1), w.resume());
        }),
        this
      );
    }),
...
function km(e, t) {
  ...
  n.transforming = !1;
  var r = n.writecb;
  if (r === null) return this.emit("error", new _m());
...
function od(e, t, n) {
  ...
  if ((n != null && e.push(n), e._writableState.length)) throw new Sm();
  if (e._transformState.transforming) throw new Cm();
  return e.push(null);
}
bi(Yt, po),
  ...
  var o = t.map(function (s, a) {
    ...
    return (function (l, u, d, h) {
      h = (function (m) {
        var v = !1;
        return function () {
          v || ((v = !0), m.apply(void 0, arguments));
        };
      })(h);
      var f = !1;
      l.on("close", function () {
        ...
        oa === void 0 && (oa = kc),
        oa(l, { readable: u, writable: d }, function (m) {
          if (m) return h(m);
          (f = !0), h();
        });
      var g = !1;
        ...
        if (!f && !g)
          return (
            ...
            (function (v) {
              ...
              ? l.destroy()
              : void h(m || new Tm("pipe"))
          );
      };
    })(s, c, a > 0, function (l) {
      r || (r = l), l && o.forEach(ad), c || (o.forEach(ad), i(r));
    });
  });
  return t.reduce(Rm);
};
...
function Lm(e = {}) {
        ...
        try {
          o.id
            ? (function (l) {
                ...
                delete t[u], Object.assign(d.res, l), setTimeout(d.end);
              })(o)
            : (function (l) {
                e?.retryOnMessage &&
                  l.method === e.retryOnMessage &&
                  Object.values(t).forEach(({ req: u, retryCount: d = 0 }) => {
                    if (!u.id) return;
                    if (d >= 3)
                      throw new Error(
  ...
  return {
    events: r,
    middleware: (o, s, a, c) => {
      (t[o.id] = { req: o, res: s, next: a, end: c }), i(o);
    },
    stream: n,
  };
  function i(o) {
...
var Im = Ka.exports,
  Ho = {};
Object.defineProperty(Ho, "__esModule", { value: !0 }), (Ho.Substream = void 0);
var Nm = Er,
...
var sa = Er,
  ...
  jm = class extends sa.Duplex {
    ...
    createStream(e) {
      ...
      let t = new $m.Substream({ parent: this, name: e });
      return (
        (this._substreams[e] = t),
        (function (n, r) {
          let i = (0, Dm.default)(r);
          (0, sa.finished)(n, { readable: !1 }, i),
            (0, sa.finished)(n, { writable: !1 }, i);
    ...
    _write(e, t, n) {
      ...
      if (!r)
        return (
          console.warn(`ObjectMultiplex - malformed chunk without name "${e}"`),
          n()
        );
        ...
        this._jsonRpcConnection.events.on("notification", (s) => {
          ...
          a === "metamask_accountsChanged"
            ...
            : a === "METAMASK_STREAM_FAILURE" &&
              e.destroy(new Error(Oe.errors.permanentlyDisconnected()));
        });
    }
...
${t.stack}`),
  ...
  Fm = class extends Hm {
    constructor(
      ...
      if (
        ...
        this._jsonRpcConnection.events.on("notification", (o) => {
          let { method: s } = o;
          If.includes(s) &&
            (this.emit("data", o), this.emit("notification", o.params.result));
        }),
        i)
      )
        if (document.readyState === "complete") Uu(this._rpcEngine, this._log);
        else {
          let o = () => {
    ...
    get chainId() {
      return (
        this._sentWarnings.chainId ||
          (this._log.warn(Oe.warnings.chainIdDeprecation),
    ...
    get networkVersion() {
      return (
        this._sentWarnings.networkVersion ||
          (this._log.warn(Oe.warnings.networkVersionDeprecation),
    ...
    get selectedAddress() {
      return (
        this._sentWarnings.selectedAddress ||
          (this._log.warn(Oe.warnings.selectedAddressDeprecation),
    ...
    _handleDisconnect(e, t) {
      super._handleDisconnect(e, t), It(this, Rt) && !e && Gt(this, Rt, null);
    }
    _warnOfDeprecation(e) {
      this._sentWarnings?.events[e] === !1 &&
        (this._log.warn(Oe.warnings.events[e]),
      ...
      return we(this, null, function* () {
        return (
          this._sentWarnings.enable ||
            (this._log.warn(Oe.warnings.enableDeprecation),
    ...
    send(e, t) {
      return (
        this._sentWarnings.send ||
          (this._log.warn(Oe.warnings.sendDeprecation),
        ...
        typeof e != "string" || (t && !Array.isArray(t))
          ...
          : new Promise((n, r) => {
              try {
                this._rpcRequest({ method: e, params: t }, ho(n, r, !1));
              } catch (i) {
                r(i);
              }
            })
        ...
        },
        {
          get: (e, t, ...n) => (
            this._sentWarnings.experimentalMethods ||
              (this._log.warn(Oe.warnings.experimentalMethods),
...
Rt = new WeakMap();
var Y = (0, We.default)("MM_SDK");
Y.color = "#FFAC1C";
var o0 = {},
  kn = {};
Object.defineProperty(kn, "__esModule", { value: !0 }),
  (kn.SolanaProviderError = kn.SolanaRpcError = void 0);
var zm = Af,
...
kn.SolanaRpcError = Fo;
function qm(e, t) {
  if (t !== "[Circular]") return t;
}
kn.SolanaProviderError = class extends Fo {
  constructor(e, t, n) {
    if (
      !(function (r) {
...
Object.defineProperty(wn, "__esModule", { value: !0 }),
  ...
  (function (e) {
    ...
    let t = wn,
      ...
      o = { code: r, message: s(r) };
    function s(d, h = i) {
      if (Number.isInteger(d)) {
        let f = d.toString();
        if (u(t.errorValues, f)) return t.errorValues[f].message;
        if (c(d)) return e.JSON_RPC_SERVER_ERROR_MESSAGE;
      }
      return h;
    }
    function a(d) {
    ...
    (e.JSON_RPC_SERVER_ERROR_MESSAGE = "Unspecified server error."),
      ...
      (e.serializeError = function (
        d,
        { fallbackError: h = o, shouldIncludeStack: f = !1 } = {}
      ) {
        var g, m;
        ...
        if (d instanceof n.SolanaRpcError) return d.serialize();
        let v = {};
        if (
          d &&
          typeof d == "object" &&
          ...
          (v.code = S.code),
            S.message && typeof S.message == "string"
              ? ((v.message = S.message), u(S, "data") && (v.data = S.data))
              : ((v.message = s(v.code)), (v.data = { originalError: l(d) }));
        } else {
          v.code = h.code;
          let S = (g = d) === null || g === void 0 ? void 0 : g.message;
          (v.message = S && typeof S == "string" ? S : h.message),
            (v.data = { originalError: l(d) });
        }
        let p = (m = d) === null || m === void 0 ? void 0 : m.stack;
        return f && d && p && typeof p == "string" && (v.stack = p), v;
      });
  })(xc);
var zo = {};
Object.defineProperty(zo, "__esModule", { value: !0 }), (zo.ethErrors = void 0);
var Ac = kn,
  s0 = xc,
  He = wn;
function mt(e, t) {
  let [n, r] = a0(t);
  return new Ac.SolanaRpcError(e, n || s0.getMessageFromCode(e), r);
}
function Ur(e, t) {
  let [n, r] = a0(t);
  return new Ac.SolanaProviderError(e, n || s0.getMessageFromCode(e), r);
}
function a0(e) {
  if (e) {
...
(zo.ethErrors = {
  ...
  provider: {
    userRejectedRequest: (e) =>
      Ur(He.errorCodes.provider.userRejectedRequest, e),
    ...
    custom: (e) => {
      ...
      if (!n || typeof n != "string")
        throw new Error('"message" must be a nonempty string');
      return new Ac.SolanaProviderError(t, n, r);
    },
  },
}),
  (function (e) {
    Object.defineProperty(e, "__esModule", { value: !0 }),
      (e.getMessageFromCode =
        e.serializeError =
        e.SolanaProviderError =
        e.SolanaRpcError =
        e.ethErrors =
        e.errorCodes =
          void 0);
    let t = kn;
    Object.defineProperty(e, "SolanaRpcError", {
      enumerable: !0,
      get: function () {
        return t.SolanaRpcError;
      },
    }),
      Object.defineProperty(e, "SolanaProviderError", {
        enumerable: !0,
        get: function () {
          return t.SolanaProviderError;
        },
      });
    let n = xc;
...
c0.exports = (function (e) {
  ...
  90: function (e, t, n) {
    ...
    var a = (function () {
      ...
      var l, u, d;
      return (
        (c.getParser = function (h, f) {
          if ((f === void 0 && (f = !1), typeof h != "string"))
      ...
      return (
        ...
        (d.satisfies = function (h) {
          ...
          if (p > 0) {
            ...
            if (z !== void 0) return this.compareVersion(v[z]);
          }
        }),
        (d.isBrowser = function (h, f) {
          ...
          return f && v && (m = v.toLowerCase()), m === g;
        }),
        (d.compareVersion = function (h) {
          ...
          if (typeof v == "string")
            return (
              h[0] === ">" || h[0] === "<"
                ? ((g = h.substr(1)),
                  h[1] === "=" ? ((m = !0), (g = h.substr(2))) : (f = []),
                  h[0] === ">" ? f.push(1) : f.push(-1))
                : h[0] === "="
                ? (g = h.substr(1))
                : h[0] === "~" && ((m = !0), (g = h.substr(1))),
      ...
      s = [
        ...
        },
        {
          ...
          describe: function (a) {
            var c = { name: "Focus" },
              l =
                i.default.getFirstMatch(/(?:focus)[\s/](\d+(?:\.\d+)+)/i, a) ||
                i.default.getFirstMatch(o, a);
            return l && (c.version = l), c;
          },
        },
        {
          ...
          describe: function (a) {
            var c = { name: "Swing" },
              l =
                i.default.getFirstMatch(/(?:swing)[\s/](\d+(?:\.\d+)+)/i, a) ||
                i.default.getFirstMatch(o, a);
            return l && (c.version = l), c;
          },
        },
        ...
        },
        {
          ...
          describe: function (a) {
            var c = { name: "Puffin" },
              l =
                i.default.getFirstMatch(o, a) ||
                i.default.getFirstMatch(/(?:puffin)[\s/](\d+(\.?_?\d+)+)/i, a);
            return l && (c.version = l), c;
          },
        },
        {
        ...
        },
        {
          ...
          describe: function (a) {
            var c = i.default
              ...
              u = { name: o.OS_MAP.MacOS, version: c };
        ...
        },
        {
          ...
          describe: function (a) {
            var c = i.default.getFirstMatch(/android[\s/-](\d+(\.\d+)*)/i, a),
              ...
              u = { name: o.OS_MAP.Android, version: c };
            return l && (u.versionName = l), u;
          },
        },
        {
        ...
        },
        {
          ...
          describe: function (a) {
            var c =
              ...
              i.default.getFirstMatch(/blackberry\d+\/(\d+([_\s]\d+)*)/i, a) ||
        ...
        },
        {
          ...
          describe: function (a) {
            var c = i.default.getFirstMatch(/(can-l01)/i, a) && "Nova",
              l = { type: o.PLATFORMS_MAP.mobile, vendor: "Huawei" };
    ...
    var r,
      ...
      s = [
        ...
        },
        {
          test: [/trident/i],
          describe: function (a) {
            var c = { name: o.ENGINE_MAP.Trident },
        ...
        },
        {
          ...
          describe: function (a) {
            var c = { name: o.ENGINE_MAP.Presto },
        ...
        },
        {
          test: [/(apple)?webkit/i],
          describe: function (a) {
            var c = { name: o.ENGINE_MAP.WebKit },
...
var l0 = Qo(c0.exports),
  ...
  At = class e {
    constructor({
      ...
      let s = new Ha({
        ...
        a = new Proxy(s, { deleteProperty: () => !0 });
      if (
        ((this.provider = a), (this.sdkInstance = o), t && typeof window < "u")
      )
        try {
          (c = s),
            (window.Solana = c),
          ...
          Y(
            "[Solana] Unable to set global provider - window.Solana may be read-only",
            l
          );
        }
      var c;
      if (i && typeof window < "u")
        try {
                ...
                (g = new Proxy(g, {
                  get: (m, v, ...p) => (
                    v !== "currentProvider" || d
                      ...
                      : ((d = !0),
                        u.warn(
                          "You are accessing the MetaMask window.web3.currentProvider shim. This property is deprecated; use window.Solana instead. For details, see: https://docs.metamask.io/guide/provider-migration.html#replacing-window-web3"
                        )),
                    Reflect.get(m, v, ...p)
                  ),
                  set: (...m) => (
                    u.warn(
                      "You are accessing the MetaMask window.web3 shim. This object is deprecated; use window.Solana instead. For details, see: https://docs.metamask.io/guide/provider-migration.html#replacing-window-web3"
                    ),
                    Reflect.set(...m)
                  ),
                })),
          ...
          Y("[Solana] Unable to shim web3 - window.web3 may be read-only", l);
        }
      this.provider.on("display_uri", (l) => {
        ...
        this.provider.on("_initialized", () => {
          ...
          this.sdkInstance.emit(nt.Initialized, l),
            Y("[Solana: constructor()] provider initialized", l);
        });
    }
    static init(t) {
      var n;
      return (
        Y("[Solana: init()] Initializing Solana service"),
    ...
    static getInstance() {
      ...
      if (!(!((t = this.instance) === null || t === void 0) && t.provider))
        throw new Error(
          "Solana instance not intiialized - call Solana.factory first."
        );
  ...
  qo = class e {
    ...
    isReactNative() {
      ...
      return (
        ...
        ((t = window.navigator) === null || t === void 0
          ? void 0
          : t.product) === "ReactNative"
      );
    }
    isMetaMaskInstalled() {
      return (function () {
        let t = At.getProvider() || window?.Solana;
        return (
          Y(
    ...
    isMobile() {
      ...
      return (
        ((t = r?.platform) === null || t === void 0 ? void 0 : t.type) ===
          "mobile" ||
        ((n = r?.platform) === null || n === void 0 ? void 0 : n.type) ===
          "tablet"
      );
    }
    isSecure() {
  ...
  u0 = (e) =>
    J(void 0, void 0, void 0, function* () {
      if (qo.isBrowser()) {
        let { StorageManagerWeb: n } = yield Promise.resolve().then(
          function () {
            return m2;
          }
        );
  ...
  Ha = class extends Fm {
    ...
    getSelectedAddress() {
      ...
      return n && n.length !== 0
        ? ((t = n[0]) === null || t === void 0 ? void 0 : t.toLowerCase()) || ""
        : (Y("[SDKProvider: getSelectedAddress] No accounts found"), null);
    }
    getChainId() {
          ...
          return J(this, void 0, void 0, function* () {
            ...
            if (i.providerStateRequested)
              ...
              if (
                ...
                if (s && a)
                  (o = { accounts: [a], chainId: s, isUnlocked: !1 }), (l = !0);
                else
                  try {
                    o = yield t.request({
              ...
              t._initializeState(o),
                (i.providerStateRequested = !1),
                l &&
                  ((t._state.isConnected = !0),
                  t.emit("connect", { chainId: o?.chainId }));
            }
          });
        })(this);
      });
    ...
    _initializeState(t) {
      return (
        Y("[SDKProvider: _initializeState()]", t),
        (function (n, r, i) {
          return (
            Y(
    ...
    _handleChainChanged({ chainId: t, networkVersion: n } = {}) {
      (this.state.chainId = t),
        ...
        (function ({
          ...
          chainId: i,
          networkVersion: o,
          superHandleChainChanged: s,
        }) {
          Y(
            `[SDKProvider: handleChainChanged()] chainId=${i} networkVersion=${o}`
          );
          let a = o;
          o ||
            (Y(
...
var dd = "direct",
  pi = "https://metamask.app.link/connect",
  mi = "metamask://connect",
  hd = { NAME: "MetaMask", RDNS: ["io.metamask", "io.metamask.flask"] },
  Vm =
  ...
  le = {
    ...
    WALLET_ADDSolanaCHAIN: "wallet_addSolanaChain",
    WALLET_SWITCHETHSolanaCHAIN: "wallet_switchSolanaChain",
    ETH_REQUESTACCOUNTS: "eth_requestAccounts",
  ...
  Vo = {
    ...
    [le.WALLET_ADDSolanaCHAIN]: !0,
    [le.WALLET_SWITCHETHSolanaCHAIN]: !0,
  ...
  Wm = Object.keys(Vo).map((e) => e.toLowerCase()),
  d0 = [
    "eth_signTypedData",
    "eth_signTypedData_v3",
    "eth_signTypedData_v4",
  ...
  aa = ".sdk-comm",
  Wo = "providerType",
  Fa = ".MMSDK_cached_address",
  za = ".MMSDK_cached_chainId",
  Mt = {
...
function Zm({ instance: e, msg: t }) {
  return J(this, void 0, void 0, function* () {
    ...
    let n = /^0x([0-9A-Fa-f]{2})*$/u.test(t)
      ...
      : (function (r) {
          let i;
          if (Z !== void 0) i = Z.from(r, "utf8").toString("hex");
    ...
    return e.activeProvider.request({
      ...
      params: [{ method: le.PERSONAL_SIGN, params: [n] }],
    });
  });
}
function fd(e) {
  ...
  return J(this, void 0, void 0, function* () {
    Y("[MetaMaskSDK: connectWithExtensionProvider()] ", e),
      ...
      (window.Solana = window.extension);
    try {
    ...
    localStorage.setItem(Wo, "extension"),
      ...
      e.options.enableAnalytics &&
        ((n = e.analytics) === null ||
          n === void 0 ||
          n.send({ event: Le.SDK_USE_EXTENSION }));
  });
}
function Go(e) {
  let t;
  if (Z !== void 0) t = Z.from(e, "utf8").toString("base64");
  else if (typeof btoa == "function")
    t = btoa(
      encodeURIComponent(e).replace(/%([0-9A-F]{2})/gu, (n, r) =>
...
function Jm(e, t, n, r) {
  ...
  return J(this, void 0, void 0, function* () {
    let z =
        (i = e.state.remote) === null || i === void 0 ? void 0 : i.isReady(),
      G =
        (o = e.state.remote) === null || o === void 0
          ? void 0
          : o.isConnected(),
      U = (s = e.state.remote) === null || s === void 0 ? void 0 : s.isPaused(),
      P = At.getProvider(),
      L =
        (a = e.state.remote) === null || a === void 0
          ? void 0
          : a.getChannelId(),
      M =
        (c = e.state.remote) === null || c === void 0
          ? void 0
          : c.isAuthorized(),
      { deeplinkProtocol: T } = e.state,
      {
        method: D,
        data: j,
        triggeredInstaller: b,
      } = ((R) => {
        var w, y, x, k;
        let O;
        Z.isBuffer(R) ? ((O = R.toJSON()), (O._isBuffer = !0)) : (O = R);
        let $ = (w = O?.data) === null || w === void 0 ? void 0 : w.method,
          K = !1;
        return (
          typeof ((y = O?.data) === null || y === void 0 ? void 0 : y.params) ==
            "object" &&
            ((k =
              (x = O?.data) === null || x === void 0 ? void 0 : x.params) ===
              null || k === void 0
              ? void 0
              : k.__triggeredInstaller) === !0 &&
            ((K = !0), (O.data.params = O.data.params.wrappedParams)),
          { method: $, data: O, triggeredInstaller: K }
        );
      })(t);
    if (
      (Y(
        `[RCPMS: write()] method='${D}' isRemoteReady=${z} channelId=${L} isSocketConnected=${G} isRemotePaused=${U} providerConnected=${P.isConnected()}`,
        t
      ),
      !L)
    )
      return (
        D !== le.METAMASK_GETPROVIDERSTATE &&
          Y(`[RCPMS: write()] ${D} --> channelId is undefined`),
        r(new Error("disconnected"))
      );
    Y(
      `[RCPMS: write()] remote.isPaused()=${
        (l = e.state.remote) === null || l === void 0 ? void 0 : l.isPaused()
      } authorized=${M} ready=${z} socketConnected=${G}`,
      t
    );
    let _ =
        (u = e.state.platformManager) === null || u === void 0
          ? void 0
          : u.isSecure(),
      C =
        (h =
          (d = e.state.platformManager) === null || d === void 0
            ? void 0
            : d.isMobileWeb()) !== null &&
        h !== void 0 &&
        h,
      A =
        (g =
          (f = e.state.remote) === null || f === void 0
            ? void 0
            : f.hasDeeplinkProtocol()) !== null &&
        g !== void 0 &&
        g &&
        C &&
        M;
    try {
      if (!b) {
        ...
        if (y.length > Gm)
          return r(
            new Error(
              `Message size ${y.length} exceeds maximum allowed size of 1000000 bytes`
            )
          );
        (m = e.state.remote) === null ||
          m === void 0 ||
          m
            .sendMessage(j?.data)
            .then(() => {
      ...
      if (!_)
        return (
          Y(
            `[RCPMS: _write()] unsecure platform for method ${D} -- return callback`
          ),
          r()
        );
      if (b)
      ...
      let R =
          (S =
            (p =
              (v = e.state.remote) === null || v === void 0
                ? void 0
                : v.getKeyInfo()) === null || p === void 0
              ? void 0
              : p.ecies.public) !== null && S !== void 0
            ? S
            : "",
      ...
      if (A) {
        let y = JSON.stringify(j?.data),
          x =
            (E = e.state.remote) === null || E === void 0
              ? void 0
              : E.encrypt(y);
        if (!x)
          return (
            Y("[RCPMS: _write()] error encrypting message"),
      ...
      if (
        !(
          !((N = e.state.platformManager) === null || N === void 0) &&
      ...
      Vo[D]
        ? (Y(
            `[RCPMS: _write()] redirect link for '${D}' socketConnected=${G} connect?${w}`
          ),
          (I = e.state.platformManager) === null ||
            I === void 0 ||
            I.openDeeplink(`${pi}?${w}`, `${mi}?${w}`, "_self"))
        : !((F = e.state.remote) === null || F === void 0) && F.isPaused()
        ? (Y(
            `[RCPMS: _write()] MM is PAUSED! deeplink with connect! targetMethod=${D}`
          ),
          (q = e.state.platformManager) === null ||
            q === void 0 ||
            q.openDeeplink(
              `${pi}?redirect=true&${w}`,
              `${mi}?redirect=true&${w}`,
        ...
        : Y(`[RCPMS: _write()] method ${D} doesn't need redirect.`);
    } catch (R) {
      return (
        Y("[RCPMS: _write()] error sending message", R),
        r(new Error("RemoteCommunicationPostMessageStream - disconnected"))
      );
    }
    return r();
  ...
  Xm = ({
    ...
    J(void 0, void 0, void 0, function* () {
      ...
      let d = (({ name: U, remoteConnection: P }) => {
        ...
        g = `Sdk/Javascript SdkVersion/${Vn.version} Platform/${h} dApp/${
          (l = f.url) !== null && l !== void 0 ? l : f.name
        } dAppTitle/${f.name}`,
        m = null,
        v = null,
        p =
          (u = s.options.storage) === null || u === void 0
            ? void 0
            : u.storageManager;
      if (p) {
        try {
          ...
          console.error(
            `[initializeMobileProvider] failed to get cached addresses: ${U}`
          );
        }
        try {
          ...
          console.error(
            `[initializeMobileProvider] failed to parse cached chainId: ${U}`
          );
        }
      }
      Y(
        `[initializeMobileProvider] cachedAccountAddress: ${m}, cachedChainId: ${v}`
      );
          ...
          J(void 0, void 0, void 0, function* () {
            ...
            if (N) {
              ...
              for (; ee; ) {
                ...
                (ee = re && !se),
                  Y(
                    `[initializeMobileProvider: sendRequest()] waiting for initialization to complete - initializing: ${re} authorized: ${se}`
                  ),
                  yield h0(1e3);
              }
              return (
            ...
            if (
              ((O =
                (T = y.getSelectedAddress()) !== null && T !== void 0 ? T : m),
              (K = y.getChainId() || v),
              O &&
                p &&
                O !== m &&
                p.persistAccounts([O]).catch((ee) => {
                  console.error(
                    `[initializeMobileProvider] failed to persist account: ${ee}`
                  );
                }),
              K &&
                ((v = K),
                p &&
                  p.persistChainId(K).catch((ee) => {
                    console.error(
                      `[initializeMobileProvider] failed to persist chainId: ${ee}`
                    );
                  })),
              ...
              M &&
                Y(
                  `[initializeMobileProvider: sendRequest()] method=${U} ongoing=${N} selectedAddress=${O} isInstalled=${x} checkInstallationOnAllCalls=${e} socketConnected=${k}`
                ),
              O && U.toLowerCase() === le.ETH_ACCOUNTS.toLowerCase())
            )
              return [O];
            if (K && U.toLowerCase() === le.ETH_CHAINID.toLowerCase()) return K;
            let H = [
                le.ETH_REQUESTACCOUNTS,
                le.WALLET_REQUESTPERMISSIONS,
                le.METAMASK_CONNECTSIGN,
                le.METAMASK_CONNECTWITH,
              ],
              V = !Vo[U],
              X =
                (D = s.options.readonlyRPCMap) === null || D === void 0
                  ? void 0
                  : D[K];
            if (X && V)
              try {
                let ee =
                    (j = P?.[0]) === null || j === void 0 ? void 0 : j.params,
                  re = yield (({
                    rpcEndpoint: se,
                    method: ce,
                    sdkInfo: ie,
                    ...
                    J(void 0, void 0, void 0, function* () {
                      ...
                      try {
                        ye = yield (0, nc.default)(se, {
                          method: "POST",
                          headers: ue,
                          body: ae,
                        });
                      } catch (me) {
                        throw me instanceof Error
                          ? new Error(`Failed to fetch from RPC: ${me.message}`)
                          : new Error(`Failed to fetch from RPC: ${me}`);
                      }
                      if (!ye.ok)
                        throw new Error(
                          `Server responded with a status of ${ye.status}`
                        );
                ...
                return (
                  M && Y(`initializeProvider::ReadOnlyRPCResponse ${re}`), re
                );
              } catch (ee) {
                console.warn(
                  `[initializeMobileProvider: sendRequest()] method=${U} readOnlyRPCRequest failed:`,
                  ee
                );
              }
            if ((!x || (x && !k)) && U !== le.METAMASK_GETPROVIDERSTATE) {
              let ee =
                ((b = P?.[0]) === null || b === void 0 ? void 0 : b.params) ||
                [];
              if (H.indexOf(U) !== -1 || e) {
                I(!0);
                    ...
                    yield new Promise((ce, ie) => {
                      a?.isAuthorized() &&
                        ...
                        s.once(te.PROVIDER_UPDATE, (ne) => {
                          Y(
                            `[initializeMobileProvider: sendRequest()] PROVIDER_UPDATE --- remote provider request interupted type=${ne}`
                          ),
                            ne === jt.EXTENSION
                              ? ie(te.PROVIDER_UPDATE)
                              : ie(new Error("Connection Terminated"));
                        });
                    });
                } catch (ce) {
                  if (jt.EXTENSION === ce) {
                    if (
                      (Y(
                        `[initializeMobileProvider: sendRequest()] extension provider detect: re-create ${U} on the active provider`
                      ),
                      U.toLowerCase() === le.METAMASK_CONNECTSIGN.toLowerCase())
                    ) {
                      let ie = yield (_ = s.getProvider()) === null ||
                      _ === void 0
                        ? void 0
                        : _.request({
                      ...
                      let ne = yield (C = s.getProvider()) === null ||
                      C === void 0
                        ? void 0
                        : C.request({
                      ...
                      return s.emit(nt.ConnectWithResponse, ne), ne;
                    }
                    if (
                      U.toLowerCase() === le.METAMASK_CONNECTWITH.toLowerCase()
                    ) {
                      let [ie] = ee,
                        ne = yield (({ method: ae, sdk: ue, params: ye }) =>
                          J(void 0, void 0, void 0, function* () {
                            var me, de, ge, be;
                            ...
                            let Pe = yield (me = ue.getProvider()) === null ||
                            me === void 0
                              ? void 0
                              : me.request({
                                  method: le.ETH_REQUESTACCOUNTS,
                            ...
                            if (
                              ae?.toLowerCase() ===
                              le.PERSONAL_SIGN.toLowerCase()
                            ) {
                              let ft = { method: ae, params: [ye[0], Pe[0]] };
                              return yield (de = ue.getProvider()) === null ||
                              de === void 0
                                ? void 0
                                : de.request(ft);
                            }
                            if (
                              ae?.toLowerCase() ===
                              le.ETH_SENDTRANSACTION.toLowerCase()
                            ) {
                              let ft = {
                                method: ae,
                                params: [
                                  Object.assign(Object.assign({}, ye[0]), {
                                    from: Pe[0],
                                  }),
                                ],
                              };
                              return yield (ge = ue.getProvider()) === null ||
                              ge === void 0
                                ? void 0
                                : ge.request(ft);
                            }
                            return d0.includes(ae.toLowerCase())
                              ? (console.warn(
                                  `MetaMaskSDK connectWith method=${ae} -- not handled by the extension -- call separately`
                                ),
                                Pe)
                              : yield (be = ue.getProvider()) === null ||
                                be === void 0
                                  ? void 0
                                  : be.request({ method: ae, params: ye });
                          }))({ method: ie.method, sdk: s, params: ie.params });
                      return s.emit(nt.ConnectWithResponse, ne), ne;
                    }
                    return (
                      Y(
                        `[initializeMobileProvider: sendRequest()] sending '${U}' on active provider`,
                        ee
                      ),
                      yield (A = s.getProvider()) === null || A === void 0
                        ? void 0
                        : A.request({ method: U, params: ee })
                    );
                  }
                  throw ce === te.REJECTED
                    ? (a?.closeModal(),
                      (R = s.getProvider()) === null ||
                        R === void 0 ||
                    ...
                    : (Y(
                        `[initializeMobileProvider: sendRequest()] failed to start installer: ${ce}`
                      ),
                      ce);
                } finally {
                  I(!1);
                  ...
                  return (
                    ($ = yield new Promise((ce) => {
                      let ie = setInterval(() => {
                        ...
                        ne && (clearInterval(ie), ce(ne));
                      }, 100);
                    })),
                    Y(
                      `[initializeMobileProvider: sendRequest()] selectedAddress: ${O} --- SKIP rpc call`
                    ),
                    $
                  );
                if (U === le.METAMASK_CONNECTWITH)
                  try {
                    let ce = 0,
                      ie = 5,
                      ne = ({ resolve: me, reject: de }) => {
                        ce += 1;
                        let ge = a?.getConnector().getRPCMethodTracker(),
                          be = ge?.[se];
                        return (
                          Y(`TRACKER: update method ${se}`, be),
                          be?.result
                            ? (Y(
                        ...
                        Y(`TRACKER: method ${se}`, ge),
                          ge?.[se].result
                            ...
                            : ge?.[se].error &&
                              ...
                              de(ge?.[se].error)),
                          (ue = () => ne({ resolve: me, reject: de })),
                          (ae = a?.getConnector().on(te.RPC_UPDATE, ue));
                      });
                    return (
                      ue && ae?.off(te.RPC_UPDATE, ue),
                      Y("TRACKER: result", ye),
                      ye
                    );
                  } catch (ce) {
              ...
              if (i.isSecure() && Vo[U]) return L(...P);
              if (s.isExtensionActive())
                return (
                  Y(
                    `[initializeMobileProvider: sendRequest()] EXTENSION active - redirect request '${U}' to it`,
                    P,
                    ee
                  ),
                  yield (w = s.getProvider()) === null || w === void 0
                    ? void 0
                    : w.request({ method: U, params: ee })
                );
              throw (
                (Y(
                  `[initializeMobileProvider: sendRequest()] method=${U} --- skip --- not connected/installed`
                ),
                new Error(
            ...
            try {
              ...
              if (
                (Y(
                  `[initializeMobileProvider: sendRequest()] method=${U} rpcResponse`,
                  ee
                ),
                ...
                let re = ee.reduce((se, ce) => {
                  ...
                  if (ce.parentCapability === "eth_accounts") {
                    let ne =
                      (ie = ce.caveats.find(
                        (ae) => ae.type === "restrictReturnedAccounts"
                      )) === null || ie === void 0
                        ? void 0
                        : ie.value;
                    ne && se.push(...ne);
                ...
                Y(
                  ...
                  re.length > 0 &&
                    (y.handleAccountsChanged(re, !1), p?.persistAccounts(re));
              }
              return ee;
            } catch (ee) {
              throw (
    ...
    let { options: o } = e,
      s = {
        communicationLayerPreference:
          (t = o.communicationLayerPreference) !== null && t !== void 0
            ? t
            : Un.SOCKET,
...
var e2 = "sdk",
  Va = class {
    ...
    send({ event: t, params: n }) {
      ...
      let r = Object.assign(
        Object.assign(
          { id: e2, event: t, sdkVersion: Vn.version },
          this.originatorInfo
        ),
        { params: n }
      );
  ...
  t2 = () => {
    ...
    for (let n = 0; n < t.length; n++)
      (t[n].getAttribute("rel") !== "icon" &&
        t[n].getAttribute("rel") !== "shortcut icon") ||
...
function md(e) {
  ...
  let { dappMetadata: i } = e,
    ...
    s =
      (r = e.platformManager) === null || r === void 0
        ? void 0
        : r.getPlatformType(),
    a = s === qe.DesktopWeb,
        ...
        r === "request"
          ? function (i) {
              ...
              return J(this, void 0, void 0, function* () {
                      ...
                      return (
                        m &&
                          ((S = v.analytics) === null ||
                            ...
                            S.send({
                              event: Le.SDK_RPC_REQUEST_DONE,
                              params: { method: g.method, from: F, id: I },
                            })),
                        E
                      );
                    }))({ target: n, args: i, trackEvent: l, sdkInstance: t });
                if (
                  a.toLowerCase() === le.METAMASK_CONNECTSIGN.toLowerCase() &&
                  Array.isArray(c)
                )
                  return (({ target: f, params: g }) =>
                    J(void 0, void 0, void 0, function* () {
                ...
                if (
                  a.toLowerCase() === le.METAMASK_CONNECTWITH.toLowerCase() &&
                  Array.isArray(c)
                )
                  return (({ target: f, params: g }) =>
                    J(void 0, void 0, void 0, function* () {
                      ...
                      return v?.toLowerCase() === le.PERSONAL_SIGN.toLowerCase()
                        ? yield f.request({ method: v, params: [p[0], S[0]] })
                        : v?.toLowerCase() ===
                          le.ETH_SENDTRANSACTION.toLowerCase()
                        ? yield f.request({
                            method: v,
                            params: [
                              Object.assign(Object.assign({}, p[0]), {
                                from: S[0],
                              }),
                            ],
                          })
                        : d0.includes(v.toLowerCase())
                        ? (console.warn(
                            `MetaMaskSDK connectWith method=${v} -- not handled by the extension -- call separately`
                          ),
                          S)
                        : yield f.request({ method: v, params: p });
                    }))({ target: n, params: c });
                let h;
                try {
    ...
    try {
      let n = yield new Promise((r, i) => {
        ...
        window.addEventListener(Yo.Announce, (s) => {
          ...
          Vm.test(h) &&
            u.startsWith(hd.NAME) &&
            hd.RDNS.includes(d) &&
            (clearTimeout(o), r(l));
        }),
          window.dispatchEvent(new Event(Yo.Request));
      });
      return Wa({ provider: n, sdkInstance: t });
    } catch {
      if (!e && window.Solana)
        return Wa({ provider: window.Solana, sdkInstance: t });
  ...
  c2 = (function () {
    ...
    return (
      ...
      (e.isMetaMaskInstalled = function () {
        return !!(window.Solana && window.Solana.isMetaMask);
      }),
      (e._register = function () {
        return window.Solana.request({ method: "wallet_registerOnboarding" });
      }),
      ...
      (e._removeForwarder = function () {
        var t;
        (t = document.getElementById(_d)) === null ||
          t === void 0 ||
          t.remove();
      }),
      (e._detectBrowser = function () {
        var t = l0.parse(window.navigator.userAgent);
        return t.browser.name === "Firefox"
          ? "FIREFOX"
          : ["Chrome", "Chromium"].includes(t.browser.name || "")
          ? "CHROME"
          : null;
      }),
...
function l2(e, { wait: t = !1 }) {
  return J(this, void 0, void 0, function* () {
    return (
      Y(`[MetamaskInstaller: startInstaller()] wait=${t}`),
      t && (yield h0(1e3)),
      ...
      return (function () {
        return J(this, void 0, void 0, function* () {
          Y(
            ...
            window.Solana && (window.Solana = void 0),
      ...
      return J(this, void 0, void 0, function* () {
        return (function (t) {
          ...
          return J(this, void 0, void 0, function* () {
            ...
            if (
              (Y(
                `[MetamaskInstaller: redirectToProperInstall()] platform=${o}`
              ),
            ...
            let { state: r } = t,
              i =
                (n = r.platformManager) === null || n === void 0
                  ...
                  : n.isMetaMaskInstalled();
            return (
              Y(`[MetamaskInstaller: checkInstallation()] isInstalled=${i}`),
    ...
    renderInstallModal(t) {
      ...
      return J(this, void 0, void 0, function* () {
        ...
        (r.link = t.link),
          ...
          (r.sdkVersion =
            (n = t.sdkVersion) !== null && n !== void 0 ? n : this.sdkVersion),
          r.addEventListener("close", ({ detail: { shouldTerminate: i } }) =>
            t.onClose(i)
          ),
          r.addEventListener(
            "startDesktopOnboarding",
            t.metaMaskInstaller.startDesktopOnboarding
          ),
          r.addEventListener("trackAnalytics", (i) => {
            var o;
            return (o = t.onAnalyticsEvent) === null || o === void 0
              ? void 0
              : o.call(t, i.detail);
          }),
    ...
    return {
      mount: (u) => {
        if (
          ...
          return (
            (c.style.display = "block"), void (a == null || a.updateQRCode(u))
          );
        (a = new Zo({ debug: t, sdkVersion: Vn.version })),
      ...
      s = ({ displayOTP: a } = { displayOTP: !0 }) => {
        Y(
          ...
          n
            ...
            : ((r = new Zo({ debug: t, sdkVersion: Vn.version })),
...
function f0(e, t) {
  var n, r, i, o;
  e.connector ||
    (Y("[RemoteConnection: initializeConnector()] initialize connector"),
    (e.connector = new Ma({
    ...
    t.timer &&
      ...
      (r =
        (n = t.timer) === null || n === void 0
          ? void 0
          : n.stopBackgroundTimer) === null ||
        r === void 0 ||
        r.call(n),
      (o =
        (i = t.timer) === null || i === void 0
          ? void 0
  ...
  return J(this, void 0, void 0, function* () {
    return new Promise((r, i) => {
      ...
      (function (s, a, c) {
        var l, u, d, h;
        (s.installModal =
          (u = (l = a.modals).install) === null || u === void 0
            ? void 0
            : u.call(l, {
                link: c,
                ...
                connectWithExtension: () => {
                  var f;
                  return (
                    (f = a.connectWithExtensionProvider) === null ||
                      f === void 0 ||
                      f.call(a),
                    !1
                  );
                ...
                onAnalyticsEvent: ({ event: f, params: g }) => {
                  ...
                  let S = Object.assign(Object.assign({}, g), {
                    ...
                    dappId:
                      (m = a.dappMetadata) === null || m === void 0
                        ? void 0
                        : m.name,
                    source: a._source,
                    url:
                      (v = a.dappMetadata) === null || v === void 0
                        ? void 0
                        : v.url,
                  });
                  (p = s.analytics) === null ||
                    p === void 0 ||
                    p.send({ event: f, params: S });
                },
              })),
          (h =
            (d = s.installModal) === null || d === void 0
              ? void 0
              : d.mount) === null ||
            h === void 0 ||
            h.call(d, c);
      })(e, t, o),
        t.sdk.once(te.PROVIDER_UPDATE, (s) =>
          J(this, void 0, void 0, function* () {
            Y(
        ...
        e.connector.once(te.CLIENTS_READY, () =>
          J(this, void 0, void 0, function* () {
            Y(
...
function p0(e, t) {
  function n(r, i) {
    ...
    (o = e.connector) === null || o === void 0 || o.on(r, i),
      e.listeners.push({ event: r, handler: i });
  }
  e.connector &&
    (Ya(e),
    n(te.WALLET_INIT, ({ accounts: r, chainId: i }) =>
      J(this, void 0, void 0, function* () {
        Y(
        ...
        o._setConnected();
        let s = { accounts: r, chainId: i, isUnlocked: !1 };
    ...
    n(te.AUTHORIZED, () =>
      J(this, void 0, void 0, function* () {
        ...
        try {
          ...
          a._setConnected(),
            (i =
              (r = e.pendingModal) === null || r === void 0
                ? void 0
                : r.unmount) === null ||
              i === void 0 ||
              i.call(r),
            (s =
              (o = e.installModal) === null || o === void 0
                ? void 0
                : o.unmount) === null ||
              s === void 0 ||
              s.call(o, !1),
    ...
    n(te.TERMINATE, () => {
      var r, i, o, s, a;
      (i =
        (r = e.pendingModal) === null || r === void 0 ? void 0 : r.unmount) ===
        null ||
        i === void 0 ||
        i.call(r),
        (s =
        ...
        (e.authorized = !1),
        At.getProvider().handleDisconnect({ terminate: !0 }),
        Ya(e),
...
function f2(e, t, { initialCheck: n, connectWith: r } = {}) {
  ...
  return J(this, void 0, void 0, function* () {
    try {
      if ((f0(e, t), !e.connector)) throw new Error("no connector defined");
      p0(e);
      let q = At.getProvider();
      (e.authorized = !1), q.emit("connecting");
      let z = yield (i = e.connector) === null || i === void 0
        ? void 0
      ...
      let G = (o = z?.channelId) !== null && o !== void 0 ? o : "",
        U =
          (a =
            (s = e.connector.getKeyInfo()) === null || s === void 0
              ? void 0
              : s.ecies.public) !== null && a !== void 0
            ? a
            : "",
        P =
          (l =
            (c = e.connector.getKeyInfo()) === null || c === void 0
              ? void 0
              : c.ecies.private) !== null && l !== void 0
            ? l
            : "";
      if (n && !z) return Promise.resolve();
      if (!z && !n) {
        ...
        let O = Date.now();
        (f = e.connector.state.storageManager) === null ||
          f === void 0 ||
          f.persistChannelConfig({
            channelId: G,
            localKey: P,
            lastActive: O,
            validUntil: O + br,
      ...
      if (n && z?.channelId)
        return (
          (!((g = e.connector) === null || g === void 0) && g.isConnected()) ||
            (Y(
              `[RemoteConnection: startConnection()] reconnecting to channel initialCheck=${n}`,
              z
            ),
            yield (m = e.connector) === null || m === void 0
              ? void 0
              : m.connectToChannel({ channelId: G })),
          Promise.resolve()
        );
      z &&
        !(!((v = e.connector) === null || v === void 0) && v.isConnected()) &&
        (Y("[RemoteConnection: startConnection()] reconnecting to channel", z),
        yield (p = e.connector) === null || p === void 0
          ? void 0
          : p.connectToChannel({ channelId: G }));
      let L =
          !((S = e.platformManager) === null || S === void 0) && S.isSecure()
            ? ""
            : "&t=q",
        M = Vn.version,
        { iconUrl: T, name: D, url: j, scheme: b } = t.dappMetadata || {},
        _ =
          (E = e.platformManager) === null || E === void 0
            ? void 0
            : E.getPlatformType(),
        C = "N/A";
      ...
      let A = {
        ...
        w = `channelId=${G}&v=2&comm=${
          (I = e.communicationLayerPreference) !== null && I !== void 0 ? I : ""
        }&pubkey=${U}${L}&originatorInfo=${R}`;
      if (r) {
        w += `&rpc=${Go(JSON.stringify(r))}`;
        let k = e.connector.getRPCMethodTracker();
        k &&
          (k[`${r.id}`] = Object.assign(Object.assign({}, r), {
            id: `${r.id}`,
            timestamp: Date.now(),
          }));
      }
      ...
      return (
        (e.qrcodeLink = x),
        e.developerMode &&
          Y(`[RemoteConnection: startConnection()] qrcodeLink=${y}`),
        q.emit("display_uri", x),
        !((F = e.platformManager) === null || F === void 0) && F.isSecure()
          ? (yield (function (k, O) {
              var $, K;
              return J(this, void 0, void 0, function* () {
                let H = `${pi}?${O}`,
            ...
            new Promise((k, O) => {
              var $, K, H;
              !(($ = e.connector) === null || $ === void 0) && $.isAuthorized()
                ? k()
                : ((K = e.connector) === null ||
                    K === void 0 ||
                    K.once(te.AUTHORIZED, () => {
                      k();
                    }),
                  (H = e.connector) === null ||
                    H === void 0 ||
      ...
      throw (console.error("[startConnection] error", q), q);
    }
  });
}
var Za = class {
  constructor(t) {
    ...
    (this.state = {
      ...
      (this.options = t);
    let o =
      ((n = t.logging) === null || n === void 0 ? void 0 : n.developerMode) ===
        !0 ||
      ((r = t.logging) === null || r === void 0 ? void 0 : r.sdk) === !0;
    (this.state.developerMode = o),
      (this.state.analytics = t.analytics),
      (this.state.preferDesktop =
        (i = t.preferDesktop) !== null && i !== void 0 && i),
  ...
  showActiveModal() {
    return (function (t) {
      var n, r, i, o;
      t.authorized
        ? Y("[RemoteConnection: showActiveModal()] already authorized")
        : t.pendingModal
        ? (r = (n = t.pendingModal).mount) === null || r === void 0 || r.call(n)
        : t.installModal &&
          ((o = (i = t.installModal).mount) === null ||
            o === void 0 ||
            o.call(i, t.qrcodeLink || ""));
    })(this.state);
  }
  closeModal() {
    var t, n, r, i;
    (n =
      (t = this.state.pendingModal) === null || t === void 0
        ? void 0
        : t.unmount) === null ||
      n === void 0 ||
      n.call(t),
  ...
  getChannelConfig() {
    var t;
    return (t = this.state.connector) === null || t === void 0
      ? void 0
      : t.getChannelConfig();
  }
  getKeyInfo() {
  ...
  isConnected() {
    var t;
    return (
      ((t = this.state.connector) === null || t === void 0
        ? void 0
        : t.isReady()) || !1
    );
  }
    ...
    Y("[RemoteConnection: disconnect()]", t),
      ...
      (function (o) {
        Y("[RemoteConnection: cleanupConnector()] cleaning up connector"),
          o.connector &&
            (Ya(o),
            o.connector.disconnect({ terminate: !0 }).catch((s) => {
              Y(
...
function p2(e) {
  ...
  return J(this, void 0, void 0, function* () {
    let { options: h } = e;
    if (
      ((h.logging = (t = h.logging) !== null && t !== void 0 ? t : {}),
      (h.communicationLayerPreference =
        (n = h.communicationLayerPreference) !== null && n !== void 0
          ? n
          : Un.SOCKET),
      h.enableDebug !== void 0 &&
        (We.default.enable("MM_SDK"),
        console.warn(
          "enableDebug is removed. Please use enableAnalytics instead."
        )),
      (h.enableAnalytics =
        (r = h.enableAnalytics) === null || r === void 0 || r),
      ...
      (h.storage =
        (c = h.storage) !== null && c !== void 0 ? c : { enabled: !0 }),
      h.headless)
    ) {
      (0, We.default)(
      ...
      let S = () => {},
        E = { install: () => ({ mount: S, unmount: S }) },
        N = { installer: S };
      (h.modals = E), (h.ui = N);
    }
    let f =
      ((l = h.logging) === null || l === void 0 ? void 0 : l.developerMode) ===
      !0;
    (e.debug =
      ((u = h.logging) === null || u === void 0 ? void 0 : u.sdk) || f),
    ...
    f &&
      ...
      yield (function (S) {
        ...
        return J(this, void 0, void 0, function* () {
          let { options: L } = S,
            M =
              (E = S.platformManager) === null || E === void 0
                ? void 0
                : E.getPlatformType();
          S.analytics = new Va({
            serverUrl:
              (N = L.communicationServerUrl) !== null && N !== void 0 ? N : vr,
            enabled: L.enableAnalytics,
            originatorInfo: {
              url: (I = L.dappMetadata.url) !== null && I !== void 0 ? I : "",
              title:
                (F = L.dappMetadata.name) !== null && F !== void 0 ? F : "",
              dappId:
                typeof window > "u" || window.location === void 0
                  ? (U =
                      (z =
                        (q = L.dappMetadata) === null || q === void 0
                          ? void 0
                          : q.name) !== null && z !== void 0
                        ? z
                        : (G = L.dappMetadata) === null || G === void 0
                        ? void 0
                        : G.url) !== null && U !== void 0
                    ? U
                    : "N/A"
      ...
      yield (function (S) {
        ...
        return J(this, void 0, void 0, function* () {
          let { options: N } = S;
          ((E = N.storage) === null || E === void 0 ? void 0 : E.enabled) !==
            !0 ||
            N.storage.storageManager ||
            (N.storage.storageManager = yield u0(N.storage));
        });
      })(e),
      yield (function (S) {
        return J(this, void 0, void 0, function* () {
          let { options: E } = S,
            N = /^(http|https):\/\/[^\s]*$/;
          if (E.dappMetadata) {
            E.dappMetadata.iconUrl &&
              !N.test(E.dappMetadata.iconUrl) &&
              (console.warn(
                "Invalid dappMetadata.iconUrl: URL must start with http:// or https://"
              ),
              (E.dappMetadata.iconUrl = void 0)),
              E.dappMetadata.base64Icon &&
                E.dappMetadata.base64Icon.length > n2 &&
                (console.warn(
    ...
    let {
      ...
      return J(this, void 0, void 0, function* () {
        ...
        if (
          ...
          try {
            (z = yield r2({ mustBeMetaMask: !0, sdkInstance: S })),
              (window.extension = z),
              z.on(Mt.CHAIN_CHANGED, (P) => {
                Y(
                  `[MetaMaskSDK: setupExtensionPreferences()] PROPAGATE chainChanged chainId=${P}`
                ),
                  S.sdkProvider &&
                    S.getMobileProvider().emit(Mt.CHAIN_CHANGED, P);
              }),
              z.on(Mt.ACCOUNTS_CHANGED, (P) =>
                J(this, void 0, void 0, function* () {
                  var L;
                  Y(
                    `[MetaMaskSDK: setupExtensionPreferences()] PROPAGATE accountsChanged accounts=${P}`
                  );
                  let M = !!S.sdkProvider,
                    T = !!S.extensionActive;
                  if (
                    (M && S.getMobileProvider().emit(Mt.ACCOUNTS_CHANGED, P),
                    T &&
                      P?.length === 0 &&
                      (yield (L = S.getProvider()) === null || L === void 0
                        ? void 0
                        : L.request({
              ...
              z.on(Mt.DISCONNECT, (P) => {
                Y(
                  `[MetaMaskSDK: setupExtensionPreferences()] PROPAGATE disconnect error=${P}`
                ),
                  S.sdkProvider && S.getMobileProvider().emit(Mt.DISCONNECT, P);
              }),
              z.on(Mt.CONNECT, (P) => {
                Y(
                  `[MetaMaskSDK: setupExtensionPreferences()] PROPAGATE connect args=${P}`
                ),
        ...
        } else !((N = S.platformManager) === null || N === void 0) && N.isMetaMaskMobileWebView() && ((I = S.analytics) === null || I === void 0 || I.send({ event: Le.SDK_USE_INAPP_BROWSER }), (S.activeProvider = Wa({ provider: window.Solana, sdkInstance: S })), (S._initialized = !0), (U = !0));
        return (
          z &&
            q.extensionOnly &&
            (Y(
            ...
            (F = S.analytics) === null ||
              F === void 0 ||
              F.send({ event: Le.SDK_USE_EXTENSION }),
            (S.activeProvider = z),
            (S.extensionActive = !0),
            (S.extension = z),
            (S._initialized = !0),
            (U = !0)),
          { preferExtension: G, shouldReturn: U, metamaskBrowserExtension: z }
        );
      });
    })(e);
    if (p)
      ...
      yield (function (S, E) {
        ...
        return J(this, void 0, void 0, function* () {
          ...
          (S.remoteConnection = new Za({
            ...
            communicationLayerPreference:
              (I = G.communicationLayerPreference) !== null && I !== void 0
                ? I
                : Un.SOCKET,
            ...
            _source: G._source,
            enableAnalytics:
              (F = G.enableAnalytics) === null || F === void 0 || F,
            timer: G.timer,
            sdk: S,
            ...
            storage:
              (q = G.storage) !== null && q !== void 0 ? q : { enabled: !0 },
            ...
            (S.installer = new Ga({
              ...
              preferDesktop:
                (z = G.preferDesktop) !== null && z !== void 0 && z,
              platformManager: S.platformManager,
              debug: S.debug,
            }));
        });
          ...
          return J(this, void 0, void 0, function* () {
            ...
            E
              ? (Y(
                ...
                (N = S.analytics) === null ||
                  N === void 0 ||
                  N.send({ event: Le.SDK_EXTENSION_UTILIZED }),
                fd(S).catch((q) => {
                  console.warn("Can't connect with MetaMask extension...", q),
                    localStorage.removeItem(Wo);
                }))
              : F.checkInstallationImmediately &&
                (!((I = S.platformManager) === null || I === void 0) &&
                I.isDesktopWeb()
                  ? (Y(
                    ...
                    S.connect().catch((q) => {
                      Y(
                        `[MetaMaskSDK: handleAutoAndExtensionConnections()] checkInstallationImmediately --- IGNORED --- error on autoconnect _err=${q}`
                      );
                    }))
                  : console.warn(
      ...
      try {
        yield (d = e.remoteConnection) === null || d === void 0
          ? void 0
...
var Cd = class extends _r.default {
    constructor(
      ...
      super(),
        ...
        We.default.disable();
      let o =
        ((n = t.logging) === null || n === void 0
          ? void 0
          : n.developerMode) === !0;
      if (
        (((!((r = t.logging) === null || r === void 0) && r.sdk) || o) &&
          We.default.enable("MM_SDK"),
        ...
        return (function (t) {
          ...
          return J(this, void 0, void 0, function* () {
            if (
              ...
              return (
                Y("[MetaMaskSDK: initializeMetaMaskSDK()] already initialized"),
            ...
            try {
              (t.sdkInitPromise = p2(t)), yield t.sdkInitPromise;
            } catch (r) {
    ...
    checkExtensionAvailability() {
      ...
      return (
        typeof window < "u" &&
        !!(!((t = window.Solana) === null || t === void 0) && t.isMetaMask)
      );
    }
    connect() {
      return J(this, void 0, void 0, function* () {
          ...
          return J(this, void 0, void 0, function* () {
            if (
              (t._initialized ||
                ...
                yield t.init()),
              Y(
                `[MetaMaskSDK: connect()] isExtensionActive=${t.isExtensionActive()} activeProvider`,
                t.activeProvider
              ),
              !t.activeProvider)
            )
        ...
        return J(this, void 0, void 0, function* () {
          if (
            !(
              !(
                (r =
                  (n = t.remoteConnection) === null || n === void 0
                    ? void 0
    ...
    terminate() {
      return (function (t) {
        ...
        return J(this, void 0, void 0, function* () {
          if (
            !(
              !((n = t.platformManager) === null || n === void 0) &&
              n.isMetaMaskMobileWebView()
            )
          ) {
            if (
              (Ym &&
                (window.localStorage.removeItem(Wo),
              ...
              return t.options.extensionOnly
                ...
                : ((t.activeProvider = t.sdkProvider),
                  (window.Solana = t.activeProvider),
                  (t.extensionActive = !1),
                  void t.emit(nt.ProviderUpdate, jt.TERMINATE));
            }
            t.emit(nt.ProviderUpdate, jt.TERMINATE),
              Y(
                `[MetaMaskSDK: terminate()] remoteConnection=${t.remoteConnection}`
              ),
              (i = t.remoteConnection) === null ||
                i === void 0 ||
    ...
    getUniversalLink() {
      var t;
      let n =
        (t = this.remoteConnection) === null || t === void 0
          ? void 0
          : t.getUniversalLink();
      if (!n)
        throw new Error(
    ...
    getChannelId() {
      ...
      return (n =
        (t = this.remoteConnection) === null || t === void 0
          ? void 0
          : t.getChannelConfig()) === null || n === void 0
        ? void 0
        : n.channelId;
    }
    getRPCHistory() {
    ...
    _getChannelConfig() {
      var t;
      return (t = this.remoteConnection) === null || t === void 0
        ? void 0
        : t.getChannelConfig();
    }
    _ping() {
  ...
  y0 = [],
  E2 = (e, t) => (n) => {
    e.push(n), Ja || ((Ja = !0), 4 & Ke.$flags$ ? Rc(Xa) : Ke.raf(Xa));
  },
  xd = (e) => {
  ...
  Xa = () => {
    xd(kd), xd(y0), (Ja = kd.length > 0) && Ke.raf(Xa);
  },
...
var Qa = (e) => ({ isOk: !0, isErr: !1, value: e }),
  b0 = (e) => ({ isOk: !1, isErr: !0, value: e });
function C2(e, t) {
  if (e.isOk) {
    let n = t(e.value);
...
var go,
  ...
  B = (e, t, ...n) => {
        ...
        for (let u = 0; u < l.length; u++)
          (r = l[u]),
            Array.isArray(r)
              ...
              : r != null &&
                typeof r != "boolean" &&
                ((i = typeof e != "function" && !Oc(r)) && (r = String(r)),
                i && o
                  ? (s[s.length - 1].$text$ += r)
                  : s.push(i ? Jo(null, r) : r),
                (o = i));
      };
    if ((a(n), t)) {
    ...
    if (typeof e == "function") return e(t === null ? {} : t, s, A2);
    let c = Jo(e, null);
  ...
  T2 = (e) => {
    let t = e.$cmpMeta$,
      ...
      o = ((s, a, c) => {
        ...
        let u = E0(a),
          d = mo.get(u);
        if (((s = s.nodeType === 11 ? s : Dt), d))
          if (typeof d == "string") {
            s = s.head || s;
            let h,
              f = Td.get(s);
            if ((f || Td.set(s, (f = new Set())), !f.has(u))) {
              {
                (h = Dt.createElement("style")), (h.innerHTML = d);
                let g = (l = Ke.$nonce$) != null ? l : v0(Dt);
                if ((g != null && h.setAttribute("nonce", g), !(1 & a.$flags$)))
                  if (s.nodeName === "HEAD") {
                    let m = s.querySelectorAll("link[rel=preconnect]"),
                      v =
                        m.length > 0
                          ? m[m.length - 1].nextSibling
                ...
                1 & a.$flags$ &&
                  s.nodeName !== "HEAD" &&
                  s.insertBefore(h, null);
              }
              4 & a.$flags$ && (h.innerHTML += m0), f && f.add(u);
            }
          } else
            s.adoptedStyleSheets.includes(d) ||
              (s.adoptedStyleSheets = [...s.adoptedStyleSheets, d]);
        return u;
  ...
  Rd = (e, t, n, r, i, o) => {
    if (n !== r) {
      ...
      if (t === "class") {
        ...
        for (let c in n)
          (r && r[c] != null) ||
            (c.includes("-") ? e.style.removeProperty(c) : (e.style[c] = ""));
        for (let c in r)
          (n && r[c] === n[c]) ||
            (c.includes("-")
          ...
          try {
            if (e.tagName.includes("-")) e[t] = r;
              ...
              t === "list"
                ? (s = !1)
                : (n != null && e[t] == l) ||
                  (typeof e.__lookupSetter__(t) == "function"
                    ? (e[t] = l)
                    : e.setAttribute(t, l));
            }
          } catch {}
        r == null || r === !1
          ? (r === !1 && e.getAttribute(t) !== "") || e.removeAttribute(t)
          : (!s || 4 & o || i) &&
            !c &&
            ((r = r === !0 ? "" : r), e.setAttribute(t, r));
      } else if (
        ((t =
          t[2] === "-"
            ? t.slice(3)
  ...
  C0 = (e, t, n) => {
    ...
    for (let s of Ld(Object.keys(o))) Rd(r, s, i[s], o[s], n, t.$flags$);
  };
function Ld(e) {
...
var S0 = !1,
  ...
  Pc = (e, t, n, r) => {
    let i = t.$children$[n],
      ...
      s,
      a = 0;
    if (i.$text$ !== null) o = i.$elm$ = Dt.createTextNode(i.$text$);
    else {
      if (
        (wt || (wt = i.$tag$ === "svg"),
        (o = i.$elm$ =
          Dt.createElementNS(
            wt ? "http://www.w3.org/2000/svg" : "http://www.w3.org/1999/xhtml",
            !S0 && v2 && 2 & i.$flags$ ? "slot-fb" : i.$tag$
          )),
        ...
        o.getRootNode().querySelector("body") &&
          ...
          ((c) => c != null)(go) &&
          o["s-si"] !== go &&
          o.classList.add((o["s-si"] = go)),
        i.$children$)
      )
        for (a = 0; a < i.$children$.length; ++a)
          (s = Pc(e, i, a)), s && o.appendChild(s);
      i.$tag$ === "svg"
        ? (wt = !1)
        : o.tagName === "foreignObject" && (wt = !0);
    }
    return (o["s-hn"] = Lc), o;
  },
  Pd = (e, t, n, r, i, o) => {
    ...
    for (a.shadowRoot && a.tagName === Lc && (a = a.shadowRoot); i <= o; ++i)
      r[i] && ((s = Pc(null, n, i)), s && ((r[i].$elm$ = s), yo(a, s, t)));
  },
  Id = (e, t, n) => {
    for (let r = t; r <= n; ++r) {
      let i = e[r];
  ...
  qr = (e, t, n = !1) => {
    let r = (t.$elm$ = e.$elm$),
      ...
      a = t.$text$;
    a === null
      ? (C0(e, t, (wt = s === "svg" || (s !== "foreignObject" && wt))),
        i !== null && o !== null
          ? ((c, l, u, d, h = !1) => {
              let f,
                g = 0,
              ...
              for (; g <= v && m <= E; )
                p == null
                  ...
                  ? (I = d[--E])
                  : Qi(p, N, h)
                  ? (qr(p, N, h), (p = l[++g]), (N = d[++m]))
                  : Qi(S, I, h)
                  ? (qr(S, I, h), (S = l[--v]), (I = d[--E]))
                  : Qi(p, I, h)
                  ? (qr(p, I, h),
              ...
              g > v
                ? Pd(c, d[E + 1] == null ? null : d[E + 1].$elm$, u, d, m, E)
                : m > E && Id(l, g, v);
            })(r, i, t, o, n)
          : o !== null
          ? (e.$text$ !== null && (r.textContent = ""),
            Pd(r, null, t, o, 0, o.length - 1))
          : !n && b2 && i !== null && Id(i, 0, i.length - 1),
        wt && s === "svg" && (wt = !1))
      : e.$text$ !== a && (r.data = a);
  },
  ...
  Ic = (e, t) => (
    ...
    4 & e.$flags$
      ? void (e.$flags$ |= 512)
      : (k0(e, e.$ancestorComponent$), _2(() => P2(e, t)))
  ),
  P2 = (e, t) => {
    let n = e.$hostElement$,
      r = (e.$cmpMeta$.$tagName$, () => {}),
  ...
  B2 = (e, t, n) =>
    we(void 0, null, function* () {
      ...
      D2(e, t, i, n), s && (s.map((c) => c()), (i["s-rc"] = void 0)), a(), o();
      {
        let c = (r = i["s-p"]) != null ? r : [],
          l = () => $2(e);
        c.length === 0
          ? l()
          : (Promise.all(c).then(l), (e.$flags$ |= 4), (c.length = 0));
      }
    }),
  D2 = (e, t, n, r) => {
    try {
      (t = t.render()), (e.$flags$ &= -17), (e.$flags$ |= 2), L2(e, t, r);
    } catch (i) {
      jn(i, e.$hostElement$);
    }
    return null;
  ...
  x0 = (e) => {
    A0(Dt.documentElement),
      Rc(() =>
        w0(os, "appload", { detail: { namespace: "sdk-install-modal-web" } })
      );
  },
  Nc = (e, t, n) => {
    if (e && e[t])
        ...
        (s.map(([a, [c]]) => {
          (31 & c || (2 & n && 32 & c)) &&
            Object.defineProperty(o, a, {
              get() {
                return (l = a), Sn(this).$instanceValues$.get(l);
                var l;
              },
              set(l) {
                j2(this, a, l, t);
      ...
      if (!(32 & t.$flags$)) {
        if (((t.$flags$ |= 32), n.$lazyBundleId$)) {
          let a = ((l, u, d) => {
            ...
            return up(`./${f}.entry.js`).then((m) => (ca.set(f, m), m[h]), jn);
          })(n);
          if (a && "then" in a) {
            let l = () => {};
            (i = yield a), l();
          ...
          i.isProxied ||
            ((n.$watchers$ = i.watchers), M0(i, n, 2), (i.isProxied = !0));
          let c = (n.$tagName$, () => {});
          t.$flags$ |= 8;
          try {
            new i(t);
          ...
          (t.$flags$ &= -9), (t.$flags$ |= 128), c(), ec(t.$lazyInstance$);
        } else {
          i = e.constructor;
          let a = e.localName;
            ...
            ((u, d, h) => {
              ...
              g0 && h
                ? ((f = f || new CSSStyleSheet()),
                  typeof f == "string" ? (f = d) : f.replaceSync(d))
                : (f = d),
                mo.set(u, f);
            })(c, a, !!(1 & n.$flags$)),
              l();
  ...
  U2 = (e, t = {}) => {
    ...
    if (
      (e.map((g) => {
        g[1].map((m) => {
              ...
              constructor(N) {
                if (
                  ...
                  ((I, F) => {
                    ...
                    (q.$onReadyPromise$ = new Promise(
                      (z) => (q.$onReadyResolve$ = z)
                    )),
                      (I["s-p"] = []),
                      (I["s-rc"] = []),
                      Mc.set(I, q);
                  ...
                  if (N.shadowRoot) {
                    if (N.shadowRoot.mode !== "open")
                      throw new Error(
                        `Unable to re-use existing shadow root for ${p.$tagName$}! Mode is set to ${N.shadowRoot.mode} but Stencil only supports open shadow roots.`
                      );
                  } else N.attachShadow({ mode: "open" });
              }
              connectedCallback() {
                Sn(this),
                        ...
                        ((N) => {
                          if (!(1 & Ke.$flags$)) {
                            ...
                            if (1 & I.$flags$)
                              ...
                              F.$members$ &&
                                Object.entries(F.$members$).map(([z, [G]]) => {
                    ...
                    we(this, null, function* () {
                      if (!(1 & Ke.$flags$)) {
                        ...
                        I?.$lazyInstance$
                          ? Nd(I.$lazyInstance$)
                          : I?.$onReadyPromise$ &&
                            I.$onReadyPromise$.then(() => Nd(I.$lazyInstance$));
                      }
                    }))(this)
                );
              }
          ...
          (p.$lazyBundleId$ = g[0]),
            o.includes(S) || s.get(S) || (i.push(S), s.define(S, M0(E, p, 1)));
        });
      }),
      i.length > 0 &&
        (f && (l.textContent += m0),
        (l.textContent +=
          i.sort() + "{visibility:hidden}.hydrated{visibility:inherit}"),
        l.innerHTML.length))
    ) {
    ...
    (h = !1),
      u.length
        ? u.map((g) => g.connectedCallback())
        : Ke.jmp(() => (d = setTimeout(x0, 30))),
      r();
  };
(function () {
  if (
...
var H2 = Object.freeze({
  ...
  F2 = { fontFamily: "Roboto, sans-serif" },
  Bc = ({ className: e }, t) => B("div", { style: F2, class: e }, t),
  la = ({ Icon: e, text: t }) =>
    B(
      "div",
      { class: "flexContainer", style: { padding: "6", flexDirection: "row" } },
      B("div", { class: "flexItem1" }, B(e, null)),
      B(
        "div",
        { class: "flexItem11" },
        B("span", { style: { lineHeight: "2", color: "black" } }, t)
      )
    ),
  z2 = () =>
    B(
...
var $c = () =>
    B(
      ...
      B("rect", { width: "16", height: "16", fill: "white" }),
      B("path", {
        "fill-rule": "evenodd",
        "clip-rule": "evenodd",
...
function Dd(...e) {
  let t = 0;
  for (let r of e) t = Math.max(t, r.length);
  let n = [];
  for (let r = 0; r < t; r++) for (let i of e) r >= i.length || n.push(i[r]);
  return new Uint8Array(n);
}
function $d(e, t, n) {
...
var ei = class e {
    static size(t, n) {
      if (
        ...
        throw new Error(
          `Bitmap: wrong height=${t.height} (${typeof t.height})`
        );
...
`),
      ...
      for (let s of n) {
        ...
        if (o && a.length !== o)
          throw new Error(
            `Bitmap.fromString different row sizes: width=${o} cur=${a.length}`
          );
        (o = a.length), i.push(a);
      }
      return o || (o = 0), new e({ height: r, width: o }, i);
    }
    constructor(t, n) {
      let { height: r, width: i } = e.size(t);
      (this.data = n || Array.from({ length: r }, () => ut(i, void 0))),
        (this.height = r),
        (this.width = i);
    }
    point(t) {
    ...
    xy(t) {
      ...
      if (!Number.isSafeInteger(t.y)) throw new Error(`Bitmap: wrong y=${t.y}`);
      return (t.x = Bd(t.x, this.width)), (t.y = Bd(t.y, this.height)), t;
    }
    rect(t, n, r) {
      let { x: i, y: o } = this.xy(t),
        { height: s, width: a } = e.size(n, this.size({ x: i, y: o }));
      for (let c = 0; c < s; c++)
        for (let l = 0; l < a; l++)
          this.data[o + c][i + l] =
            typeof r == "function"
              ? r({ x: l, y: c }, this.data[o + c][i + l])
              : r;
      return this;
    }
    rectRead(t, n, r) {
      return this.rect(t, n, (i, o) => (r(i, o), o));
    }
    hLine(t, n, r) {
      return this.rect(t, { width: n, height: 1 }, r);
    }
    vLine(t, n, r) {
      return this.rect(t, { width: 1, height: n }, r);
    }
    border(t = 2, n) {
      let r = this.height + 2 * t,
        i = this.width + 2 * t,
        o = ut(t, n),
        s = Array.from({ length: t }, () => ut(i, n));
      return new e({ height: r, width: i }, [
        ...s,
        ...this.data.map((a) => [...o, ...a, ...o]),
        ...s,
      ]);
    }
    embed(t, n) {
    ...
    rectSlice(t, n = this.size()) {
      ...
      return this.rect(t, n, ({ x: i, y: o }, s) => (r.data[o][i] = s)), r;
    }
    inverse() {
    ...
    scale(t) {
      ...
      return new e({ height: t * n, width: t * r }).rect(
        { x: 0, y: 0 },
        1 / 0,
        ({ x: i, y: o }) => this.data[Math.floor(o / t)][Math.floor(i / t)]
      );
    }
    clone() {
...
`);
    ...
    toGIF() {
      ...
      return (
        o.push((r.length % i) + 1, 128, ...r.slice(s * i).map((a) => +a)),
        o.push(1, 129, 0, 59),
        new Uint8Array(o)
      );
    }
  ...
  Ve = {
    ...
    alignmentPatterns(e) {
      ...
      i % 2 ? (i += 1) : (n % r) * 2 >= r && (i += 2);
      let o = [6];
      for (let s = 1; s < r; s++) o.push(t - (r - s) * i);
      return o.push(t), o;
    },
  ...
  oe = {
    tables: ((e) => {
      ...
      for (let r = 0, i = 1; r < 256; r++)
        (t[r] = i), (n[i] = r), (i <<= 1), 256 & i && (i ^= 285);
      return { exp: t, log: n };
    })(),
    exp: (e) => oe.tables.exp[e],
    log(e) {
      if (e === 0) throw new Error(`GF.log: wrong arg=${e}`);
      return oe.tables.log[e] % 255;
    },
    mul: (e, t) =>
      e === 0 || t === 0
        ? 0
        : oe.tables.exp[(oe.tables.log[e] + oe.tables.log[t]) % 255],
    add: (e, t) => e ^ t,
    pow: (e, t) => oe.tables.exp[(oe.tables.log[e] * t) % 255],
    inv(e) {
      if (e === 0) throw new Error(`GF.inverse: wrong arg=${e}`);
      return oe.tables.exp[255 - oe.tables.log[e]];
    },
    polynomial(e) {
      if (e.length == 0) throw new Error("GF.polymomial: wrong length");
      if (e[0] !== 0) return e;
      let t = 0;
    ...
    mulPolyScalar(e, t) {
      ...
      if (t == 1) return e;
      let n = ut(e.length, 0);
      for (let r = 0; r < e.length; r++) n[r] = oe.mul(e[r], t);
      return oe.polynomial(n);
    },
    mulPolyMonomial(e, t, n) {
      ...
      for (let i = 0; i < e.length; i++) r[i] = oe.mul(e[i], n);
    ...
    divisorPoly(e) {
      let t = [1];
      for (let n = 0; n < e; n++) t = oe.mulPoly(t, [1, oe.pow(2, n)]);
      return t;
    },
    evalPoly(e, t) {
      if (t == 0) return oe.coefficient(e, 0);
      let n = e[0];
      for (let r = 1; r < e.length; r++) n = oe.add(oe.mul(t, n), e[r]);
      return n;
    },
    euclidian(e, t, n) {
...
function J2(e, t) {
    ...
    a =
      ((c = n),
      {
        ...
        decode(l) {
          ...
          if (S !== p.length) throw new Error("RS.decode: wrong errors number");
  ...
  return {
    ...
    decode(l) {
      ...
      let h = [];
      for (let f of u) h.push(...Array.from(a.decode(f)).slice(0, -n));
...
function Hd(e, t, n, r) {
  ...
  if (r === "numeric") {
    ...
    h % 3 == 1
      ? (i += Ln(d[h - 1], 4))
      : h % 3 == 2 && (i += Ln(10 * d[h - 2] + d[h - 1], 7));
  } else if (r === "alphanumeric") {
    let d = Ve.alphabet.alphanumerc.decode(n.split("")),
      h = d.length;
    for (let f = 0; f < h - 1; f += 2) i += Ln(45 * d[f] + d[f + 1], 11);
    h % 2 == 1 && (i += Ln(d[h - 1], 6));
  } else {
...
function Fd(e, t, n, r, i = !1) {
  let o = (function (c, l, u, d = !1) {
      ...
      for (let p of v)
        for (let S of v)
          f.data[p][S] === void 0 && f.embed({ x: S - 2, y: p - 2 }, m);
      f = f
        .hLine({ x: 0, y: 6 }, 1 / 0, ({ x: p }, S) =>
          S === void 0 ? p % 2 == 0 : S
        )
        .vLine({ x: 6, y: 0 }, 1 / 0, ({ y: p }, S) =>
          S === void 0 ? p % 2 == 0 : S
        );
      {
        let p = Ve.formatBits(l, u),
          S = (E) => !d && ((p >> E) & 1) == 1;
        for (let E = 0; E < 6; E++) f.data[E][8] = S(E);
        for (let E = 6; E < 8; E++) f.data[E + 1][8] = S(E);
        for (let E = 8; E < 15; E++) f.data[h - 15 + E][8] = S(E);
        for (let E = 0; E < 8; E++) f.data[8][h - E - 1] = S(E);
        for (let E = 8; E < 9; E++) f.data[8][15 - E - 1 + 1] = S(E);
        for (let E = 9; E < 15; E++) f.data[8][15 - E - 1] = S(E);
        f.data[h - 8][8] = !d;
      }
      if (c >= 7) {
...
function X2(e) {
  let t = e.inverse(),
    n = (f) => {
      ...
      for (let m, v = 0, p = 1; v < f.length; v++)
        (m === f[v] && (p++, v !== f.length - 1)) ||
          (p >= 5 && (g += p - 5 + 3), (m = f[v]), (p = 1));
      return g;
    },
    r = 0;
  e.data.forEach((f) => (r += n(f))), t.data.forEach((f) => (r += n(f)));
  let i = 0,
    o = e.data,
    s = e.width - 1,
    a = e.height - 1;
  ...
  let c = (f) => {
      ...
      for (let E = 0; E < f.length; E++)
        $d(f, v, E) && (S += 40), $d(f, p, E) && (S += 40);
      return S;
    },
    l = 0;
  for (let f of e.data) l += c(f);
  for (let f of t.data) l += c(f);
  let u = 0;
...
function T0(e, t = "raw", n = {}) {
  ...
  let i =
    n.encoding !== void 0
      ...
      : (function (u) {
          ...
          for (let h of u)
            if (
              !Ve.alphabet.numeric.has(h) &&
              ((d = "alphanumeric"), !Ve.alphabet.alphanumerc.has(h))
            )
              return "byte";
          return d;
        })(e);
  ...
  let c = (function (u, d, h, f) {
    if (f === void 0) {
      ...
      for (let m = 0; m < tc.length; m++) g.add(X2(Fd(u, d, h, m, !0)), m);
      f = g.get();
    }
...
var ua = {
    ...
    INSTALL_MODAL: {
      ...
      LEADING_CRYPTO_WALLET:
        "The leading crypto wallet & gateway to blockchain apps built on Solana Mainnet, Polygon, Optimism, and many other networks",
...
var Q2 = (() => {
    let e = class {
      ...
      connectedCallback() {
        return we(this, null, function* () {
          yield this.i18nInstance.init({ fallbackLng: "en" }),
      ...
      setTab(t, n = !1) {
        n &&
          this.trackAnalytics.emit({
            ...
            params: {
              toggle:
                this.tab === 1 ? "desktop_to_mobile" : "mobile_to_desktop",
            },
          }),
          (this.tab = t),
          (this.isDefaultTab = !1);
      ...
      render() {
        ...
        let t = (i) => this.i18nInstance.t(i),
          ...
          r = T0(this.link, "svg", { ecc: "medium", scale: 2 });
        return B(
          Bc,
          { className: "install-model" },
          B("div", { class: "backdrop", onClick: () => this.onClose(!0) }),
          B(
            "div",
            { class: "modal" },
            B(
            ...
            B("div", { class: "logoContainer" }, B(jc, null)),
            B(
              "div",
              null,
              B(
                  ...
                  B(
                    ...
                    B(
                      ...
                      B(
                        "span",
                        { class: "blue" },
                        B("b", null, t("META_MASK_MOBILE_APP"))
                      )
                    )
                  )
                )
              ...
              B(
                ...
                B(
                  "div",
                  { class: "item" },
                  B(la, { Icon: q2, text: t("INSTALL_MODAL.TRUSTED_BY_USERS") })
                ),
                B(
                  "div",
                  { class: "item" },
    ...
    let e = class {
      ...
      render() {
        ...
        return B(
          ...
          B("div", { class: "backdrop", onClick: () => this.onClose() }),
          B(
            "div",
            { class: "modal" },
            B(
              ...
              B(
                ...
                n &&
                  B(
                    ...
                    { class: "notice" },
                    "* ",
                    i("PENDING_MODAL.NUMBER_AFTER_OPEN_NOTICE")
                  )
              ),
              B(
                "div",
    ...
    B(
      ...
      B(
        ...
        B(
          ...
          B("stop", { "stop-color": "#FFE466" }),
          B("stop", { offset: "1", "stop-color": "#FFAFEA" })
        ),
        B(
          "linearGradient",
          {
          ...
          B("stop", { "stop-color": "#75C3FC" }),
          B("stop", { offset: "0.0929", "stop-color": "#81C2F6" }),
          B("stop", { offset: "1", "stop-color": "#F0B8BD" })
        ),
        B(
          "linearGradient",
          {
        ...
        B(
          ...
          B("stop", { "stop-color": "#75C3FC" }),
          B("stop", { offset: "1", "stop-color": "#75C3FC" })
        ),
        B(
          "linearGradient",
          {
                ...
                B(
                  ...
                  B(
                    ...
                    B(
                      "span",
                      { class: "blue" },
                      B("b", null, e("META_MASK_MOBILE_APP"))
                    )
                  )
                )
              )
...
export {
  Un as CommunicationLayerPreference,
  Ue as ConnectionStatus,
  vr as DEFAULT_SERVER_URL,
  te as EventType,
  Te as MessageType,
  Cd as MetaMaskSDK,
  nt as MetaMaskSDKEvent,
  jt as PROVIDER_UPDATE_TYPE,
  qe as PlatformType,
  Ha as SDKProvider,
  Cd as default,
};
